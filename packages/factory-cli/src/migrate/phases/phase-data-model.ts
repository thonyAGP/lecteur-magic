...
import { extractSchema, inferRelations, enrichTableNames, generatePrismaSchema } from '@magic-migration/data-model';
...
export const runDataModelPhase = async (
  ...
  try {
    ...
    console.log(`[phase-data-model] Generated schema: ${tables.length} tables, ${relations.length} relations`);
