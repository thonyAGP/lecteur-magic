# REF IDE 121 - Browse - fichier_statistiques
...
| Projet | REF |
| IDE Position | 121 |
| Nom Programme | Browse - fichier_statistiques |
...
**Browse - fichier_statistiques** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>121 - Browse - fichier_statistiques

**Role** : Traitement : Browse - fichier_statistiques.
...
|----------|-------|------|------------|------|
| **121.1** | [**Browse - fichier_statistiques** (121)](#t1) | - | - | Traitement |
