# PBG IDE 156 - Alimentation Combos CHOIX
...
| Projet | PBG |
| IDE Position | 156 |
| Nom Programme | Alimentation Combos CHOIX |
...
**Alimentation Combos CHOIX** assure la gestion complete de ce processus, accessible depuis [Execution des màj combo (IDE 141)](PBG-IDE-141.md).
...
#### <a id="t1"></a>156 - Êcran [[ECRAN]](#ecran-t1)

**Role** : Traitement : Êcran.
**Ecran** : 573 x 84 DLU (MDI) | [Voir mockup](#ecran-t1)
...
|----------|-------|------|------------|------|
| **156.1** | [**Êcran** (156)](#t1) [mockup](#ecran-t1) | MDI | 573x84 | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 5 | `Trim (v.Combo [B])&','&Left ([E],1)&' '&Trim ([F])` | - |
| CONCATENATION | 4 | `Left ([E],1)&' '&Trim ([F])` | - |
...
Main -> ... -> [Execution des màj combo (IDE 141)](PBG-IDE-141.md) -> **Alimentation Combos CHOIX (IDE 156)**

```mermaid
graph LR
    T156[156 Alimentation Combo...]
