# REF IDE 59 - Browse - comptes_recette__cre
...
| Projet | REF |
| IDE Position | 59 |
| Nom Programme | Browse - comptes_recette__cre |
...
**Browse - comptes_recette__cre** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>59 - Browse - comptes_recette__cre

**Role** : Traitement : Browse - comptes_recette__cre.
...
|----------|-------|------|------------|------|
| **59.1** | [**Browse - comptes_recette__cre** (59)](#t1) | - | - | Calcul |
