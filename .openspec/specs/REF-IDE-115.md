# REF IDE 115 - Browse - unilateral_bilateral
...
| Projet | REF |
| IDE Position | 115 |
| Nom Programme | Browse - unilateral_bilateral |
...
**Browse - unilateral_bilateral** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>115 - Browse - unilateral_bilateral

**Role** : Traitement : Browse - unilateral_bilateral.
...
|----------|-------|------|------------|------|
| **115.1** | [**Browse - unilateral_bilateral** (115)](#t1) | - | - | Transfert |
