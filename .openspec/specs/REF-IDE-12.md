# REF IDE 12 - Browse - backup_histo_sessions
...
| Projet | REF |
| IDE Position | 12 |
| Nom Programme | Browse - backup_histo_sessions |
...
**Browse - backup_histo_sessions** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>12 - Browse - backup_histo_sessions

**Role** : Traitement : Browse - backup_histo_sessions.
...
|----------|-------|------|------------|------|
| **12.1** | [**Browse - backup_histo_sessions** (12)](#t1) | - | - | Traitement |
