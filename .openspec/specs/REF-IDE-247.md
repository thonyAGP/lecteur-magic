...
| Projet | REF |
| IDE Position | 247 |
| Nom Programme | Browse - suivi_pdc |
...
**Browse - suivi_pdc** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>247 - Browse - suivi_pdc

**Role** : Traitement : Browse - suivi_pdc.
...
|----------|-------|------|------------|------|
| **247.1** | [**Browse - suivi_pdc** (247)](#t1) | - | - | Traitement |
