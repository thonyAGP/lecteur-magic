# PBG IDE 107 - Impression annul/Modif
...
| Projet | PBG |
| IDE Position | 107 |
| Nom Programme | Impression annul/Modif |
...
**Impression annul/Modif** assure la gestion complete de ce processus, accessible depuis [GM Modifies / NA (IDE 127)](PBG-IDE-127.md).
...
#### <a id="t1"></a>107 - (sans nom) [[ECRAN]](#ecran-t1)
...
#### <a id="t2"></a>107.1 - Scroll [[ECRAN]](#ecran-t2)
...
|----------|-------|------|------------|------|
| **107.1** | [**(sans nom)** (107)](#t1) [mockup](#ecran-t1) | MDI | 166x31 | Traitement |
| 107.1.1 | [Scroll (107.1)](#t2) [mockup](#ecran-t2) | MDI | 1091x283 | |
...
Main -> ... -> [GM Modifies / NA (IDE 127)](PBG-IDE-127.md) -> **Impression annul/Modif (IDE 107)**

```mermaid
graph LR
    T107[107 Impression annulModif]
