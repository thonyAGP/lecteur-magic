# PBG IDE 179 - Marquage Caisse logique

> **Analyse**: Phases 1-4 2026-02-03 09:59 -> 09:59 (18s) | Assemblage 09:59
...
|----------|-------|------|------------|------|
| **179.1** | [**Marquage Caisse** (179)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Module Sejours CallTask (IDE 0)](PBG-IDE-0.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Module Sejours CallTask (IDE 94)](PBG-IDE-94.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Module Sejours SubForm (IDE 391)](PBG-IDE-391.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Logement Client (IDE 0)](PBG-IDE-0.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Logement Exterieur (IDE 0)](PBG-IDE-0.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Logement Personnel (IDE 0)](PBG-IDE-0.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Logement Exterieur (IDE 171)](PBG-IDE-171.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Logement Personnel (IDE 172)](PBG-IDE-172.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Logement Client (IDE 173)](PBG-IDE-173.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Logement Client pms-626 (IDE 174)](PBG-IDE-174.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Logement Client (IDE 385)](PBG-IDE-385.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [    Validation Auto filiations (IDE 121)](PBG-IDE-121.md) -> **Marquage Caisse logique (IDE 179)**

Main -> ... -> [Validation Arrivants (IDE 124)](PBG-IDE-124.md) -> **Marquage Caisse logique (IDE 179)**

```mermaid
graph LR
    T179[179 Marquage Caisse lo...]
