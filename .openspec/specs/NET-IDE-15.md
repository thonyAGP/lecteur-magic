...
**Vidage table SQL** assure la gestion complete de ce processus, accessible depuis [Pilotage (IDE 12)](NET-IDE-12.md).
...
|----------|-------|------|------------|------|
| **15.1** | [**Vidage table SQL** (15)](#t1) | - | - | Traitement |
...
Main -> ... -> [Pilotage (IDE 12)](NET-IDE-12.md) -> **Vidage table SQL (IDE 15)**

```mermaid
graph LR
    T15[15 Vidage table SQL]
