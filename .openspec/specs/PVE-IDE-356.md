# PVE IDE 356 - Select Product==V4

> **Analyse**: Phases 1-4 2026-02-03 19:44 -> 19:45 (11s) | Assemblage 19:45
...
- **356** - Select Product **[[ECRAN]](#ecran-t1)**

#### Phase 2 : Traitement (2 taches)

- **356.1** - Sub Category **[[ECRAN]](#ecran-t2)**
- **356.1.1** - Product **[[ECRAN]](#ecran-t3)**

Delegue a : [Delete Product (IDE 194)](PVE-IDE-194.md), [  Package Rental date (IDE 195)](PVE-IDE-195.md), [      Package=> account (IDE 196)](PVE-IDE-196.md), [Choice today tomorrow (IDE 202)](PVE-IDE-202.md)

#### Phase 3 : Impression (3 taches)

- **356.1.1.1** - Ticket **[[ECRAN]](#ecran-t4)**
- **356.1.1.1.1** - Vidage Ticket
- **356.2** - Vidage Ticket
...
#### <a id="t1"></a>356 - Select Product [[ECRAN]](#ecran-t1)
...
#### <a id="t2"></a>356.1 - Sub Category [[ECRAN]](#ecran-t2)
...
#### <a id="t3"></a>356.1.1 - Product [[ECRAN]](#ecran-t3)
...
#### <a id="t4"></a>356.1.1.1 - Ticket [[ECRAN]](#ecran-t4)
...
#### <a id="t5"></a>356.1.1.1.1 - Vidage Ticket
...
- **Appele par**: (aucun)
- **Appelle**: 4 programmes | **Tables**: 6 (W:3 R:1 L:3) | **Taches**: 6 | **Expressions**: 41
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 356 | 356 | Select Product | Type6 | 1414 | 308 | Consultation |
| 2 | 356.1 | 356.1 | Sub Category | Type0 | 444 | 218 | Traitement |
| 3 | 356.1.1 | 356.1.1 | Product | Type0 | 611 | 216 | Traitement |
| 4 | 356.1.1.1 | 356.1.1.1 | Ticket | Type0 | 170 | 294 | Impression |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>356 - Select Product
**Tache** : [356](#t1) | **Type** : Type6 | **Dimensions** : 1414 x 308 DLU
...
#### <a id="ecran-t2"></a>356.1 - Sub Category
**Tache** : [356.1](#t2) | **Type** : Type0 | **Dimensions** : 444 x 218 DLU
...
#### <a id="ecran-t3"></a>356.1.1 - Product
**Tache** : [356.1.1](#t3) | **Type** : Type0 | **Dimensions** : 611 x 216 DLU
...
#### <a id="ecran-t4"></a>356.1.1.1 - Ticket
**Tache** : [356.1.1.1](#t4) | **Type** : Type0 | **Dimensions** : 170 x 294 DLU
...
flowchart TD
    ...
    VF1[356 Select Product]
    style VF1 fill:#58a6ff
    VF2[356.1 Sub Category]
    style VF2 fill:#58a6ff
    VF3[356.1.1 Product]
    style VF3 fill:#58a6ff
    VF4[356.1.1.1 Ticket]
...
|----------|-------|------|------------|------|
| **356.1** | [**Select Product** (356)](#t1) [mockup](#ecran-t1) | Type6 | 1414x308 | Consultation |
| **356.2** | [**Sub Category** (356.1)](#t2) [mockup](#ecran-t2) | - | 444x218 | Traitement |
| 356.2.1 | [Product (356.1.1)](#t3) [mockup](#ecran-t3) | - | 611x216 | |
| **356.3** | [**Ticket** (356.1.1.1)](#t4) [mockup](#ecran-t4) | - | 170x294 | Impression |
| 356.3.1 | [Vidage Ticket (356.1.1.1.1)](#t5) | - | - | |
| 356.3.2 | [Vidage Ticket (356.2)](#t6) | - | - | |
...
| CONDITION | 40 | `RetourQuestion [J]=6` | - |
| CONDITION | 2 | `Trim(v.Qté [F])='01'` | - |
| CONDITION | 9 | `v.TotalTicket [K]>0` | - |
...
| OTHER | 6 | `v.PrixZero [M]` | - |
| OTHER | 7 | `T S/Catégorie [Q]` | - |

#### STRING (3 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| STRING | 39 | `Del (v.Qté [F],Len (Trim(v.PrixSaisie [L])),1)` | - |
| STRING | 38 | `Del (v.Qté [F],Len (Trim(v.Qté [F])),1)` | - |
| STRING | 13 | `Trim(p.Masque_Sans_Z [B])` | - |

#### CONCATENATION (22 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 29 | `Trim(v.Qté [F])&'7'` | - |
| CONCATENATION | 30 | `Trim(v.PrixSaisie [L])&'7'` | - |
| CONCATENATION | 28 | `Trim(v.PrixSaisie [L])&'6'` | - |
| CONCATENATION | 26 | `Trim(v.PrixSaisie [L])&'5'` | - |
| CONCATENATION | 27 | `Trim(v.Qté [F])&'6'` | - |
| ... | | *+17 autres* | |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 13 | `Trim(p.Masque_Sans_Z [B])` |
| 38 | `Del (v.Qté [F],Len (Trim(v.Qté [F])),1)` |
| 39 | `Del (v.Qté [F],Len (Trim(v.PrixSaisie [L])),1)` |
...
|-----|-------------------|
| 15 | `Trim(v.Qté [F])&'0'` |
| 16 | `Trim(v.PrixSaisie [L])&'0'` |
| 17 | `Trim(v.Qté [F])&'1'` |
| 18 | `Trim(v.PrixSaisie [L])&'1'` |
| 19 | `Trim(v.Qté [F])&'2'` |
| 20 | `Trim(v.PrixSaisie [L])&'2'` |
| 21 | `Trim(v.Qté [F])&'3'` |
| 22 | `Trim(v.PrixSaisie [L])&'3'` |
| 23 | `Trim(v.Qté [F])&'4'` |
| 24 | `Trim(v.PrixSaisie [L])&'4'` |
| 25 | `Trim(v.Qté [F])&'5'` |
| 26 | `Trim(v.PrixSaisie [L])&'5'` |
| 27 | `Trim(v.Qté [F])&'6'` |
| 28 | `Trim(v.PrixSaisie [L])&'6'` |
| 29 | `Trim(v.Qté [F])&'7'` |
| 30 | `Trim(v.PrixSaisie [L])&'7'` |
| 31 | `Trim(v.Qté [F])&'8'` |
| 32 | `Trim(v.PrixSaisie [L])&'8'` |
| 33 | `Trim(v.Qté [F])&'9'` |
| 34 | `Trim(v.PrixSaisie [L])&'9'` |
| 35 | `Trim(v.Qté [F])&'.'` |
| 36 | `Trim(v.PrixSaisie [L])&'.'` |
...
| Code desactive | 0.9% (2 / 235) | Code sain |
