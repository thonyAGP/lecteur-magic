# REF IDE 57 - Browse - parametres_______par
...
| Projet | REF |
| IDE Position | 57 |
| Nom Programme | Browse - parametres_______par |
...
**Browse - parametres_______par** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>57 - Browse - parametres_______par

**Role** : Traitement : Browse - parametres_______par.
...
|----------|-------|------|------------|------|
| **57.1** | [**Browse - parametres_______par** (57)](#t1) | - | - | Traitement |
