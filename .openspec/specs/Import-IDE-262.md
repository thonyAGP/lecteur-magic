...
**Import - email** assure la gestion complete de ce processus, accessible depuis [Lanceur (IDE 2)](Import-IDE-2.md).
...
#### <a id="t1"></a>262 - Import - email

**Role** : Traitement : Import - email.
**Variables liees** : A (Buffer email)
...
|----------|-------|------|------------|------|
| **262.1** | [**Import - email** (262)](#t1) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 2 | `Trim(INIGet('[MAGIC_LOGICAL_NAMES]import'))&'email.TXT'` | - |
...
Main -> ... -> [Lanceur (IDE 2)](Import-IDE-2.md) -> **Import - email (IDE 262)**

```mermaid
graph LR
    T262[262 Import - email]
