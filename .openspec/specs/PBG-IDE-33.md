# PBG IDE 33 - Browse - IMPORT Avertiss. AN/V

> **Analyse**: Phases 1-4 2026-02-03 01:20 -> 01:20 (36s) | Assemblage 01:20
...
| Projet | PBG |
| IDE Position | 33 |
| Nom Programme | Browse - IMPORT Avertiss. AN/V |
...
**Browse - IMPORT Avertiss. AN/V** assure la gestion complete de ce processus, accessible depuis [Dispatch (IDE 96)](PBG-IDE-96.md).
...
#### <a id="t1"></a>33 - Browse - IMPORT Avertiss. AN/V [[ECRAN]](#ecran-t1)

**Role** : Traitement : Browse - IMPORT Avertiss. AN/V.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 33 | 33 | Browse - IMPORT Avertiss. AN/V | MDI | 780 | 208 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>33 - Browse - IMPORT Avertiss. AN/V
**Tache** : [33](#t1) | **Type** : MDI | **Dimensions** : 780 x 208 DLU
**Bloc** : Traitement | **Titre IDE** : Browse - IMPORT Avertiss. AN/V
    ...
    "controls":  [
                     {
                         ...
                         "cols":  [
                                      {
                                          "title":  "IVA Code Societe",
                                          "layer":  1,
                                          "w":  77
                                      },
                                      {
                                          "title":  "IVA Code Lieu Sejour",
                                          "layer":  2,
                                          "w":  91
                                      },
                                      {
...
| 3,20 | (sans nom) | - | edit |
| 80,20 | (sans nom) | - | edit |
| 171,20 | (sans nom) | - | edit |
| 232,20 | (sans nom) | - | edit |
| 420,16 | (sans nom) | - | edit |
| 420,32 | (sans nom) | - | edit |
| 420,48 | (sans nom) | - | edit |
| 420,62 | (sans nom) | - | edit |
| 420,80 | (sans nom) | - | edit |
| 420,96 | (sans nom) | - | edit |
| 420,112 | (sans nom) | - | edit |
| 420,128 | (sans nom) | - | edit |
| 421,144 | iva_type_de_client | - | edit |
...
Ecran unique: **Browse - IMPORT Avertiss. AN/V**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **33.1** | [**Browse - IMPORT Avertiss. AN/V** (33)](#t1) [mockup](#ecran-t1) | MDI | 780x208 | Traitement |
...
|----|-----|-------------|------|---|---|---|--------|
| 549 | gm_supprimes_en_modif |  | TMP |   | **W** |   | 1 |

### Colonnes par table (1 / 1 tables avec colonnes identifiees)

<details>
<summary>Table 549 - gm_supprimes_en_modif (**W**) - 1 usages</summary>
...
Main -> ... -> [Dispatch (IDE 96)](PBG-IDE-96.md) -> **Browse - IMPORT Avertiss. AN/V (IDE 33)**

```mermaid
graph LR
    T33[33 Browse - IMPORT Ave...]
