...
> **Analyse**: 2026-02-03 16:19
> **Pipeline**: V7.2 Enrichi

## RESUME EXECUTIF

- **Fonction**: ...recherche date minimum
- **Tables modifiees**: 0
- **Complexite**: **BASSE** (0/100)
- **Statut**: NON_ORPHELIN
- **Raison**: Appele par 11 programme(s): Service GO (IDE 133), Liste Mecanographique (IDE 127), Planning GO (IDE 130),   Liste CLients arrivant (IDE 156),   Liste Clients present (IDE 162),   Liste CLients depart (IDE 168), Liste CLients AVPBDR (IDE 174), Liste depart circuit (IDE 191),   Liste present personnel plan (IDE 227),   Liste personnels AVPBDR (IDE 234),   Liste logement PASDL (IDE 258)
