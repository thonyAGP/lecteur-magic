...
**Envoi Check Out** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>74 - Envoi Check Out

**Role** : Traitement : Envoi Check Out.
...
|----------|-------|------|------------|------|
| **74.1** | [**Envoi Check Out** (74)](#t1) | MDI | - | Traitement |
