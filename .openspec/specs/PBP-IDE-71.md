# PBP IDE 71 - Deficit IGP CDV Sej V3

> **Analyse**: Phases 1-4 2026-02-03 09:07 -> 09:08 (20s) | Assemblage 09:08
...
| Projet | PBP |
| IDE Position | 71 |
| Nom Programme | Deficit IGP CDV Sej V3 |
...
**Deficit IGP CDV Sej V3** assure la gestion complete de ce processus, accessible depuis [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md).
...
#### <a id="t1"></a>71 - Deficit IGP CDV Sej V3

**Role** : Traitement : Deficit IGP CDV Sej V3.
...
|----------|-------|------|------------|------|
| **71.1** | [**Deficit IGP CDV Sej V3** (71)](#t1) | - | - | Traitement |
...
| CONSTANTE | 2 | `'Invités  gratuits pensions Chef de village'` | - |
| ... | | *+1 autres* | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| FORMAT | 5 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim([BU])&IF([CT]<>'','_'&Trim([CT])&'_','_')&'EFF_Deficit_IGP2_'&IF([DF],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` | - |
...
|-----|-------------------|
| 1 | `'Invitant'` |
| 2 | `'Invités  gratuits pensions Chef de village'` |
| 3 | `'800170385'` |
| 4 | `'CDV'` |
| 21 | `0` |
| 32 | `''` |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 5 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim([BU])&IF([CT]<>'','_'&Trim([CT])&'_','_')&'EFF_Deficit_IGP2_'&IF([DF],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` |
...
Main -> ... -> [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md) -> **Deficit IGP CDV Sej V3 (IDE 71)**

```mermaid
graph LR
    T71[71 Deficit IGP CDV Sej V3]
