# REF IDE 144 - Browse - parametres_pour_pabx
...
| Projet | REF |
| IDE Position | 144 |
| Nom Programme | Browse - parametres_pour_pabx |
...
**Browse - parametres_pour_pabx** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>144 - Browse - parametres_pour_pabx

**Role** : Traitement : Browse - parametres_pour_pabx.
...
|----------|-------|------|------------|------|
| **144.1** | [**Browse - parametres_pour_pabx** (144)](#t1) | - | - | Traitement |
