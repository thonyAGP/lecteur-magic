# REF IDE 428 - Browse - req_requests

> **Analyse**: Phases 1-4 2026-02-03 11:51 -> 11:51 (17s) | Assemblage 11:51
...
| Projet | REF |
| IDE Position | 428 |
| Nom Programme | Browse - req_requests |
...
**Browse - req_requests** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>428 - Browse - req_requests

**Role** : Traitement : Browse - req_requests.
...
|----------|-------|------|------------|------|
| **428.1** | [**Browse - req_requests** (428)](#t1) | - | - | Traitement |
