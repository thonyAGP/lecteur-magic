# MAI IDE 44 - Suppression demande verif pool
...
**Suppression demande verif pool** assure la gestion complete de ce processus, accessible depuis [Verification pooling (IDE 42)](MAI-IDE-42.md).
...
#### <a id="t1"></a>44 - Suppression demande verif pool

**Role** : Verification : Suppression demande verif pool.

---

#### <a id="t4"></a>44.1 - Suppression demande verif pool

**Role** : Verification : Suppression demande verif pool.

---

#### <a id="t7"></a>44.2 - Suppression demande verif pool
...
|----------|-------|------|------------|------|
| **44.1** | [**Suppression demande verif pool** (44)](#t1) | MDI | - | Validation |
| 44.1.1 | [Suppression demande verif pool (44.1)](#t4) | MDI | - | |
| 44.1.2 | [Suppression demande verif pool (44.2)](#t7) | MDI | - | |
...
Main -> ... -> [Verification pooling (IDE 42)](MAI-IDE-42.md) -> **Suppression demande verif pool (IDE 44)**

```mermaid
graph LR
    T44[44 Suppression demande...]
...
|-----|---------------|-----------|
| [42](MAI-IDE-42.md) | Verification pooling | 2 |
