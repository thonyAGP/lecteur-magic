# PBP IDE 79 - Deficit VSHIP repasV3
...
| Projet | PBP |
| IDE Position | 79 |
| Nom Programme | Deficit VSHIP repasV3 |
...
**Deficit VSHIP repasV3** assure la gestion complete de ce processus, accessible depuis [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md).
...
| **Expression source** | Expression 28 : `IF([AQ]<P.Gestion crise ? [F],P.Gestion crise ? [F],[AQ])` |
...
| **Expression source** | Expression 29 : `IF([AS]>V.Nb JH du mois [G],V.Nb JH du mois [G],[AS])` |
...
- **Appelle**: 0 programmes | **Tables**: 3 (W:0 R:1 L:2) | **Taches**: 1 | **Expressions**: 43
...
|----------|-------|------|------------|------|
| **79.1** | [**Deficit VSHIP V3** (79)](#t1) | - | - | Traitement |
...
|------|-----|------------|-------|
| CALCULATION | 42 | `[AO]+([EI]+[EM])/2` | - |
| CALCULATION | 43 | `[ES]+([EI]+[EM])` | - |
| CALCULATION | 25 | `[AN]+[AO]` | - |
| CALCULATION | 22 | `Fill('-',30)` | - |
| CALCULATION | 23 | `Fill('-',20)` | - |

#### CONDITION (11 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONDITION | 28 | `IF([AQ]<P.Gestion crise ? [F],P.Gestion crise ? [F],[AQ])` | [RM-001](#rm-RM-001) |
| CONDITION | 29 | `IF([AS]>V.Nb JH du mois [G],V.Nb JH du mois [G],[AS])` | [RM-002](#rm-RM-002) |
| CONDITION | 35 | `[AQ]<[DH] OR [DH]=0` | - |
| CONDITION | 31 | `[BW]>[DE] OR [DE]=0` | - |
| CONDITION | 39 | `[AO]<>0` | - |
| ... | | *+6 autres* | |
...
| CONSTANTE | 24 | `0` | - |
| CONSTANTE | 38 | `''` | - |
| CONSTANTE | 1 | `'IGR V-Ship'` | - |
| CONSTANTE | 2 | `'Fournisseurs V-SHIP repas'` | - |
| ... | | *+1 autres* | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| FORMAT | 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim([BU])&IF([CT]<>'','_'&Trim([CT])&'_','_')&'EFF_Deficit_VSHIP_'&IF([DG],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` | - |
...
|------|-----|------------|-------|
| OTHER | 27 | `[BW]` | - |
| OTHER | 32 | `V.Nb JH du mois [G]` | - |
| OTHER | 19 | `[EE]` | - |
| OTHER | 26 | `[BV]` | - |
| OTHER | 33 | `P.Gestion crise ? [F]` | - |
| ... | | *+14 autres* | |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 21 | `CASE([EA],'IGPV','IGP VSHIP','OFFI','Officiers','MARI','Marins','VSP','IGR V-Ship','')` |
| 28 | `IF([AQ]<P.Gestion crise ? [F],P.Gestion crise ? [F],[AQ])` |
| 29 | `IF([AS]>V.Nb JH du mois [G],V.Nb JH du mois [G],[AS])` |
| 6 | `IN([EA],'IGPV','OFFI','MARI','VSP') AND [EB]<>''` |
| 15 | `CndRange([CT]<>'',[CT])` |
| 20 | `[CT]<>''` |
| 30 | `[BV]<[DD] OR [DD]=0` |
| 31 | `[BW]>[DE] OR [DE]=0` |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim([BU])&IF([CT]<>'','_'&Trim([CT])&'_','_')&'EFF_Deficit_VSHIP_'&IF([DG],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` |
...
| 26 | `[BV]` |
| 27 | `[BW]` |
| 32 | `V.Nb JH du mois [G]` |
| 33 | `P.Gestion crise ? [F]` |
| 34 | `[AQ]` |
| 36 | `[AS]` |
| 40 | `[DL]` |
| 41 | `[DM]` |
...
Main -> ... -> [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md) -> **Deficit VSHIP repasV3 (IDE 79)**

```mermaid
graph LR
    T79[79 Deficit VSHIP repasV3]
