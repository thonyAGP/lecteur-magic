# TST IDE 4 - Mail Envoi

> **Analyse**: Phases 1-4 2026-02-03 20:47 -> 20:47 (18s) | Assemblage 20:47
...
#### <a id="t1"></a>4 - Mail Envoi [[ECRAN]](#ecran-t1)
...
| **Expression source** | Expression 21 : `IF(p.o Code Retour Envoi OK [C], 'OK', 'ERR')` |
| **Exemple** | Si p.o Code Retour Envoi OK [C] â†’ 'OK'. Sinon â†’ 'ERR') |

## 6. CONTEXTE

- **Appele par**: (aucun)
- **Appelle**: 0 programmes | **Tables**: 4 (W:0 R:1 L:3) | **Taches**: 1 | **Expressions**: 29
...
|----------|-------|------|------------|------|
| **4.1** | [**Mail Envoi** (4)](#t1) [mockup](#ecran-t1) | - | 1499x470 | Traitement |
...
|--------|-----|------|-----------|
| A | p.i à: (To) | Alpha | 4x parametre entrant |
| B | p.i Fichier Joint | Alpha | 2x parametre entrant |
| C | p.o Code Retour Envoi OK | Logical | [4](#t1) |
...
|------|-----|------------|-------|
| CONDITION | 21 | `IF(p.o Code Retour Envoi OK [C], 'OK', 'ERR')` | [RM-001](#rm-RM-001) |
| CONDITION | 14 | `p.i à: (To) [A]<>'' AND ([AD] OR [AF])` | - |
| CONDITION | 23 | `Translate('%club_tracemail%')='O'` | - |
| CONDITION | 6 | `v.Retour Envoi Mail [O]=0 OR v.Code erreur mail [U]=0` | - |
| CONDITION | 12 | `NOT(p.o Code Retour Envoi OK [C]) OR Translate('%club_tracemail%')='O'` | - |

#### CONSTANTE (5 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONSTANTE | 24 | `'Send mail'` | - |
| CONSTANTE | 26 | `'txt'` | - |
| CONSTANTE | 20 | `'ERR'` | - |
| CONSTANTE | 16 | `'EMAIL'` | - |
| CONSTANTE | 17 | `'Error sending email'` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 22 | `v.Message erreur mail [V]` | - |
| OTHER | 19 | `StrBuild('Origin @1@', p.i viens de : [D])` | - |
| OTHER | 25 | `v.Corps [S]` | - |
| OTHER | 28 | `File2Blb (v.Fichier Joint [Q])` | - |
| OTHER | 27 | `v.Sujet [R]` | - |
| ... | | *+6 autres* | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CAST_LOGIQUE | 11 | `NOT('TRUE'LOG)` | - |

#### STRING (4 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| STRING | 10 | `StrToken(Trim(p.i Fichier Joint [B]),2,'_')` | - |
| STRING | 29 | `Flip(StrToken(Flip(Trim(v.Fichier Joint [Q])), 1, '.'))` | - |
...
|-----|-------------------|
| 21 | `IF(p.o Code Retour Envoi OK [C], 'OK', 'ERR')` |
| 6 | `v.Retour Envoi Mail [O]=0 OR v.Code erreur mail [U]=0` |
| 12 | `NOT(p.o Code Retour Envoi OK [C]) OR Translate('%club_tracemail%')='O'` |
| 14 | `p.i à: (To) [A]<>'' AND ([AD] OR [AF])` |
| 23 | `Translate('%club_tracemail%')='O'` |
...
| 2 | `Time()` |
| 7 | `MailLastRC()` |
| 13 | `StrBuild('[@1@ @2@] @3@', p.i Prenom [H], p.i Nom [I], v.Sujet [R])` |
| 15 | `[AG]` |
| 18 | `StrBuild('Email to @1@ for @2@', p.i à: (To) [A], p.i TypeTraitement [G])` |
| 19 | `StrBuild('Origin @1@', p.i viens de : [D])` |
| 22 | `v.Message erreur mail [V]` |
| 25 | `v.Corps [S]` |
| 27 | `v.Sujet [R]` |
| 28 | `File2Blb (v.Fichier Joint [Q])` |
...
| 10 | `StrToken(Trim(p.i Fichier Joint [B]),2,'_')` |
| 29 | `Flip(StrToken(Flip(Trim(v.Fichier Joint [Q])), 1, '.'))` |
