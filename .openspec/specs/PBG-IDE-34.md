# PBG IDE 34 - Browse - IMPORT Commentai IMO

> **Analyse**: Phases 1-4 2026-02-03 01:20 -> 01:21 (38s) | Assemblage 01:21
...
| Projet | PBG |
| IDE Position | 34 |
| Nom Programme | Browse - IMPORT Commentai IMO |
...
**Browse - IMPORT Commentai IMO** assure la gestion complete de ce processus, accessible depuis [Dispatch (IDE 96)](PBG-IDE-96.md).

Le flux de traitement s'organise en **1 blocs fonctionnels** :

- **Traitement** (1 tache) : traitements metier divers

**Donnees modifiees** : 1 tables en ecriture (temp_recap_telecollecte).
...
#### <a id="t1"></a>34 - Browse - IMPORT Commentai IMO [[ECRAN]](#ecran-t1)

**Role** : Traitement : Browse - IMPORT Commentai IMO.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 34 | 34 | Browse - IMPORT Commentai IMO | MDI | 780 | 208 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>34 - Browse - IMPORT Commentai IMO
**Tache** : [34](#t1) | **Type** : MDI | **Dimensions** : 780 x 208 DLU
**Bloc** : Traitement | **Titre IDE** : Browse - IMPORT Commentai IMO
    ...
    "controls":  [
                     {
                         ...
                         "cols":  [
                                      ...
                                      {
                                          "title":  "IMO N° Ressource",
                                          "layer":  2,
                                          "w":  81
                                      },
                                      {
                                          "title":  "IMO Type Commentaire",
                                          "layer":  3,
                                          "w":  99
                                      },
                                      {
                                      ...
                                      {
                                          "title":  "IMO LB Type Produit",
                                          "layer":  5,
                                          "w":  89
                                      },
                                      {
                                          "title":  "IMO LB Code Produit",
                                          "layer":  6,
                                          "w":  90
                                      },
                                      {
...
| 7,18 | (sans nom) | - | edit |
| 74,18 | (sans nom) | - | edit |
| 155,18 | (sans nom) | - | edit |
| 79,162 | (sans nom) | - | edit |
| 254,18 | (sans nom) | - | edit |
| 315,18 | (sans nom) | - | edit |
| 404,18 | (sans nom) | - | edit |
| 494,18 | (sans nom) | - | edit |
...
Ecran unique: **Browse - IMPORT Commentai IMO**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **34.1** | [**Browse - IMPORT Commentai IMO** (34)](#t1) [mockup](#ecran-t1) | MDI | 780x208 | Traitement |
...
Main -> ... -> [Dispatch (IDE 96)](PBG-IDE-96.md) -> **Browse - IMPORT Commentai IMO (IDE 34)**

```mermaid
graph LR
    T34[34 Browse - IMPORT Com...]
