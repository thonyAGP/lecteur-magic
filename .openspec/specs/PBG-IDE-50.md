# PBG IDE 50 - Browse - Code Vol         VOT
...
| Projet | PBG |
| IDE Position | 50 |
| Nom Programme | Browse - Code Vol         VOT |
...
#### <a id="t1"></a>50 - Browse - Code Vol         VOT [[ECRAN]](#ecran-t1)

**Role** : Selection par l'operateur : Browse - Code Vol         VOT.
**Ecran** : 648 x 160 DLU (MDI) | [Voir mockup](#ecran-t1)
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 50 | 50 | Browse - Code Vol         VOT | MDI | 648 | 160 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>50 - Browse - Code Vol         VOT
**Tache** : [50](#t1) | **Type** : MDI | **Dimensions** : 648 x 160 DLU
**Bloc** : Traitement | **Titre IDE** : Browse - Code Vol         VOT
...
| 8,22 | (sans nom) | - | edit |
| 69,22 | (sans nom) | - | edit |
| 163,22 | (sans nom) | - | edit |
| 233,22 | (sans nom) | - | edit |
| 288,22 | (sans nom) | - | edit |
| 355,22 | (sans nom) | - | edit |
| 421,22 | (sans nom) | - | edit |
| 471,22 | (sans nom) | - | edit |
| 542,22 | vot_compagnie | - | edit |

</details>

## 9. NAVIGATION

Ecran unique: **Browse - Code Vol         VOT**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **50.1** | [**Browse - Code Vol         VOT** (50)](#t1) [mockup](#ecran-t1) | MDI | 648x160 | Traitement |
...
Main -> ... -> [Browse - IMPORT Historique Cha (IDE 27)](PBG-IDE-27.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Mod (IDE 28)](PBG-IDE-28.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Recup N°Chambr (IDE 29)](PBG-IDE-29.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Historique Cha (IDE 30)](PBG-IDE-30.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT MOD GM (IDE 31)](PBG-IDE-31.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Avertiss. MOD (IDE 32)](PBG-IDE-32.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Avertiss. AN/V (IDE 33)](PBG-IDE-33.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Commentai IMO (IDE 34)](PBG-IDE-34.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Troncon   IMT (IDE 35)](PBG-IDE-35.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Reprise   IMR (IDE 36)](PBG-IDE-36.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Avertiss. IMA (IDE 37)](PBG-IDE-37.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT PrestationIMP (IDE 38)](PBG-IDE-38.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Circuit   IMC (IDE 39)](PBG-IDE-39.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Logement  IML (IDE 40)](PBG-IDE-40.md) -> **Browse - Code Vol         VOT (IDE 50)**

Main -> ... -> [Browse - IMPORT Identite  IMI (IDE 41)](PBG-IDE-41.md) -> **Browse - Code Vol         VOT (IDE 50)**

```mermaid
graph LR
    T50[50 Browse - Code Vol VOT]
