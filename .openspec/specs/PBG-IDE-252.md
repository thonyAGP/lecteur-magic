# PBG IDE 252 - Import - FRA LISTE BLANCHE
...
| Projet | PBG |
| IDE Position | 252 |
| Nom Programme | Import - FRA LISTE BLANCHE |
...
**Import - FRA LISTE BLANCHE** assure la gestion complete de ce processus, accessible depuis [Chargement des donnees NA (IDE 249)](PBG-IDE-249.md).
...
**Donnees modifiees** : 1 tables en ecriture (fra_liste_blanche).
...
#### <a id="t1"></a>252 - Import - FRA LISTE BLANCHE

**Role** : Traitement : Import - FRA LISTE BLANCHE.
...
|----------|-------|------|------------|------|
| **252.1** | [**Import - FRA LISTE BLANCHE** (252)](#t1) | MDI | - | Traitement |
| **252.2** | [**CREATION** (252.1)](#t2) | MDI | - | Creation |
...
| D | code | Alpha | - |
| E | commentaire | Alpha | - |
| F | type produit | Alpha | - |
| G | code produit | Alpha | - |
| H | date | Alpha | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONDITION | 4 | `type ressource [C]='0'` | - |
...
Main -> ... -> [Chargement des donnees NA (IDE 249)](PBG-IDE-249.md) -> **Import - FRA LISTE BLANCHE (IDE 252)**

```mermaid
graph LR
    T252[252 Import - FRA LISTE...]
