...
| Projet | REF |
| IDE Position | 350 |
| Nom Programme | Browse - import_mod |
...
**Browse - import_mod** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>350 - Browse - import_mod

**Role** : Traitement : Browse - import_mod.
...
|----------|-------|------|------------|------|
| **350.1** | [**Browse - import_mod** (350)](#t1) | - | - | Traitement |
