# REF IDE 195 - Browse - classe_monetaire_cent
...
| Projet | REF |
| IDE Position | 195 |
| Nom Programme | Browse - classe_monetaire_cent |
...
**Browse - classe_monetaire_cent** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>195 - Browse - classe_monetaire_cent

**Role** : Traitement : Browse - classe_monetaire_cent.
...
|----------|-------|------|------------|------|
| **195.1** | [**Browse - classe_monetaire_cent** (195)](#t1) | - | - | Traitement |
