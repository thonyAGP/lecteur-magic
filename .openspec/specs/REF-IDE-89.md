# REF IDE 89 - Browse - tables_gratuites_tgr
...
| Projet | REF |
| IDE Position | 89 |
| Nom Programme | Browse - tables_gratuites_tgr |
...
**Browse - tables_gratuites_tgr** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>89 - Browse - tables_gratuites_tgr

**Role** : Traitement : Browse - tables_gratuites_tgr.
...
|----------|-------|------|------------|------|
| **89.1** | [**Browse - tables_gratuites_tgr** (89)](#t1) | - | - | Traitement |
