# PBP IDE 254 - Liste des arrivees
...
#### <a id="t1"></a>254 - Liste des arrivees
...
|----------|-------|------|------------|------|
| **254.1** | [**Liste des arrivees** (254)](#t1) | MDI | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 8 | `MlsTrans ('Liste des arrivees par')&' '&IF (CodeZoneSecteur [E]='Z','Zone',MlsTrans ('Secteur'))` | - |
