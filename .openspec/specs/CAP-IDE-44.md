# CAP IDE 44 - Recuperation langue

> **Analyse**: Phases 1-4 2026-02-03 10:25 -> 10:25 (15s) | Assemblage 10:25
...
**Recuperation langue** assure la gestion complete de ce processus, accessible depuis [Start (IDE 31)](CAP-IDE-31.md).
...
#### <a id="t1"></a>44 - Recuperation langue
...
|----------|-------|------|------------|------|
| **44.1** | [**Recuperation langue** (44)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Start (IDE 31)](CAP-IDE-31.md) -> **Recuperation langue (IDE 44)**

```mermaid
graph LR
    T44[44 Recuperation langue]
