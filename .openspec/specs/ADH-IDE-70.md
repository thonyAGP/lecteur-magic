...
| `{0,-73}` | W0 D.Sejour Debut | DATE | - |
| `{0,-72}` | W0 D.Sejour Fin | DATE | - |
| `{0,-71}` | W0 code inscription | UNICODE | - |
| `{0,-70}` | v. Libelle edition | ALPHA | - |
| `{0,-69}` | v. Libelle Categ | ALPHA | - |
| `{0,-83}` | W0 masque extrait | ALPHA | - |
| `{0,-82}` | W0 devise locale | ALPHA | - |
| `{0,-63}` | W0.Nombre de copies | NUMERIC | - |
