# REF IDE 362 - Browse - pv_accounting_date
...
| Projet | REF |
| IDE Position | 362 |
| Nom Programme | Browse - pv_accounting_date |
...
**Browse - pv_accounting_date** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>362 - Browse - pv_accounting_date

**Role** : Traitement : Browse - pv_accounting_date.
...
|----------|-------|------|------------|------|
| **362.1** | [**Browse - pv_accounting_date** (362)](#t1) | - | - | Traitement |
