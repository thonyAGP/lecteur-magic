# REF IDE 340 - Browse - log_cloture_auto
...
| Projet | REF |
| IDE Position | 340 |
| Nom Programme | Browse - log_cloture_auto |
...
**Browse - log_cloture_auto** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>340 - Browse - log_cloture_auto

**Role** : Traitement : Browse - log_cloture_auto.
...
|----------|-------|------|------------|------|
| **340.1** | [**Browse - log_cloture_auto** (340)](#t1) | - | - | Traitement |
