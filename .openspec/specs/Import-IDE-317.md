# Import IDE 317 - Import - pv_accounting_date
...
| Projet | Import |
| IDE Position | 317 |
| Nom Programme | Import - pv_accounting_date |
...
**Import - pv_accounting_date** assure la gestion complete de ce processus, accessible depuis [Lanceur (IDE 2)](Import-IDE-2.md).
...
#### <a id="t1"></a>317 - Import - pv_accounting_date

**Role** : Traitement : Import - pv_accounting_date.
...
|----------|-------|------|------------|------|
| **317.1** | [**Import - pv_accounting_date** (317)](#t1) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 2 | `Trim(INIGet('[MAGIC_LOGICAL_NAMES]import'))&'pv_accountdate.txt'` | - |
...
Main -> ... -> [Lanceur (IDE 2)](Import-IDE-2.md) -> **Import - pv_accounting_date (IDE 317)**

```mermaid
graph LR
    T317[317 Import - pv_accoun...]
