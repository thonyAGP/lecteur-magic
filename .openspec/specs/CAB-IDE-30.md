...
**Uni ou bi** assure la gestion complete de ce processus, accessible depuis [Visualisation Appel (IDE 33)](CAB-IDE-33.md).
...
#### <a id="t1"></a>30 - Lecture Parametre Change
...
|----------|-------|------|------------|------|
| **30.1** | [**Lecture Parametre Change** (30)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Visualisation Appel (IDE 33)](CAB-IDE-33.md) -> **Uni ou bi (IDE 30)**
