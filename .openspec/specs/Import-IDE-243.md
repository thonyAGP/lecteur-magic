...
**Import - vente** assure la gestion complete de ce processus, accessible depuis [Lanceur (IDE 2)](Import-IDE-2.md).
...
#### <a id="t1"></a>243 - Import - vente

**Role** : Saisie des donnees : Import - vente.
...
|----------|-------|------|------------|------|
| **243.1** | [**Import - vente** (243)](#t1) | - | - | Saisie |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 2 | `Trim(INIGet('[MAGIC_LOGICAL_NAMES]import'))&'caisse_vente.TXT'` | - |
...
Main -> ... -> [Lanceur (IDE 2)](Import-IDE-2.md) -> **Import - vente (IDE 243)**

```mermaid
graph LR
    T243[243 Import - vente]
