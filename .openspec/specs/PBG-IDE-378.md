# PBG IDE 378 - effectifs repas SAV from REF

> **Analyse**: Phases 1-4 2026-02-03 11:32 -> 11:32 (16s) | Assemblage 11:32
...
| Projet | PBG |
| IDE Position | 378 |
| Nom Programme | effectifs repas SAV from REF |
...
**effectifs repas SAV from REF** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>378 - effectifs repas SAV from ref [[ECRAN]](#ecran-t1)

**Role** : Traitement : effectifs repas SAV from ref.
**Ecran** : 538 x 460 DLU | [Voir mockup](#ecran-t1)
**Variables liees** : G (P.code_repas_nenc_vil), R (P.repas)

---

#### <a id="t2"></a>378.1 - Création/ modification, [[ECRAN]](#ecran-t2)
...
#### <a id="t3"></a>378.2 - Création enregs
...
- **Appele par**: (aucun)
- **Appelle**: 0 programmes | **Tables**: 0 (W:0 R:0 L:0) | **Taches**: 3 | **Expressions**: 15
...
|----------|-------|------|------------|------|
| **378.1** | [**effectifs repas SAV from ref** (378)](#t1) [mockup](#ecran-t1) | - | 538x460 | Traitement |
| 378.1.1 | [Création/ modification, (378.1)](#t2) [mockup](#ecran-t2) | - | 700x498 | |
| 378.1.2 | [Création enregs (378.2)](#t3) | - | - | |
