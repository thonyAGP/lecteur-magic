# PBG IDE 40 - Browse - IMPORT Logement  IML

> **Analyse**: Phases 1-4 2026-02-03 08:51 -> 08:51 (21s) | Assemblage 08:51
...
| Projet | PBG |
| IDE Position | 40 |
| Nom Programme | Browse - IMPORT Logement  IML |
...
**Browse - IMPORT Logement  IML** assure la gestion complete de ce processus, accessible depuis [Dispatch (IDE 96)](PBG-IDE-96.md).
...
#### <a id="t1"></a>40 - Browse - IMPORT Logement  IML [[ECRAN]](#ecran-t1)

**Role** : Traitement : Browse - IMPORT Logement  IML.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 40 | 40 | Browse - IMPORT Logement  IML | MDI | 780 | 208 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>40 - Browse - IMPORT Logement  IML
**Tache** : [40](#t1) | **Type** : MDI | **Dimensions** : 780 x 208 DLU
**Bloc** : Traitement | **Titre IDE** : Browse - IMPORT Logement  IML
    ...
    "controls":  [
                     {
                         ...
                         "cols":  [
                                      ...
                                      {
                                          "title":  "IML N° Ressource",
                                          "layer":  2,
                                          "w":  82
                                      },
                                      {
                                          "title":  "IML Date Debut",
                                          "layer":  3,
                                          "w":  73
                                      },
                                      {
                                      ...
                                      {
                                          "title":  "IML Base Occupation",
                                          "layer":  6,
                                          "w":  94
                                      },
                                      {
                                          "title":  "IML Code Logement",
                                          "layer":  7,
                                          "w":  89
                                      },
                                      {
...
| 226,15 | (sans nom) | - | edit |
| 296,15 | (sans nom) | - | edit |
| 341,15 | (sans nom) | - | edit |
| 435,15 | (sans nom) | - | edit |
| 524,15 | (sans nom) | - | edit |
| 586,15 | (sans nom) | - | edit |
...
Ecran unique: **Browse - IMPORT Logement  IML**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **40.1** | [**Browse - IMPORT Logement  IML** (40)](#t1) [mockup](#ecran-t1) | MDI | 780x208 | Traitement |
...
Main -> ... -> [Dispatch (IDE 96)](PBG-IDE-96.md) -> **Browse - IMPORT Logement  IML (IDE 40)**

```mermaid
graph LR
    T40[40 Browse - IMPORT Log...]
