...
> **Analyse**: Phases 1-4 2026-02-03 15:56 -> 15:57 (14s) | Assemblage 15:57
...
| Projet | PBP |
| IDE Position | 231 |
| Nom Programme | Liste des Absents personnel |
...
**Liste des Absents personnel** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>231 - Liste des Absents personnel

**Role** : Traitement : Liste des Absents personnel.
...
|----------|-------|------|------------|------|
| **231.1** | [**Liste des Absents personnel** (231)](#t1) | MDI | - | Traitement |
...
| CONSTANTE | 5 | `''` | - |
| CONSTANTE | 6 | `'TQUGO'` | - |
| CONSTANTE | 9 | `'LISTE_DES_ABSENTS_'` | - |
| CONSTANTE | 4 | `'P'` | - |
| CONSTANTE | 1 | `65` | - |
| ... | | *+2 autres* | |
