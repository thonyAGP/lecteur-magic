# PBG IDE 282 - Traitement Troncons new

> **Analyse**: Phases 1-4 2026-02-03 10:49 -> 10:50 (18s) | Assemblage 10:50
...
| Projet | PBG |
| IDE Position | 282 |
| Nom Programme | Traitement Troncons new |
...
**Traitement Troncons new** assure la gestion complete de ce processus, accessible depuis [Traitement des arrivants (IDE 206)](PBG-IDE-206.md).
...
#### <a id="t2"></a>282.1 - Creation Circuit
...
|----------|-------|------|------------|------|
| **282.1** | [**Veuillez patienter** (282)](#t1) [mockup](#ecran-t1) | MDI | 427x68 | Traitement |
| **282.2** | [**Creation Circuit** (282.1)](#t2) | MDI | - | Creation |
...
Main -> ... -> [Traitement des arrivants (IDE 206)](PBG-IDE-206.md) -> **Traitement Troncons new (IDE 282)**

```mermaid
graph LR
    T282[282 Traitement Troncon...]
