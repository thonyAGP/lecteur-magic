# REF IDE 96 - Browse - logement_go______lop
...
| Projet | REF |
| IDE Position | 96 |
| Nom Programme | Browse - logement_go______lop |
...
**Browse - logement_go______lop** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>96 - Browse - logement_go______lop

**Role** : Traitement : Browse - logement_go______lop.
...
|----------|-------|------|------------|------|
| **96.1** | [**Browse - logement_go______lop** (96)](#t1) | - | - | Traitement |
