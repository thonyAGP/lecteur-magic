# PBP IDE 68 - Deficit GE sejour et repas V3
...
| Projet | PBP |
| IDE Position | 68 |
| Nom Programme | Deficit GE sejour et repas V3 |
...
**Deficit GE sejour et repas V3** assure la gestion complete de ce processus, accessible depuis [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md).
...
#### <a id="t1"></a>68 - Deficit GE V3 [[ECRAN]](#ecran-t1)

**Role** : Traitement : Deficit GE V3.
**Ecran** : 831 x 623 DLU | [Voir mockup](#ecran-t1)
...
| **Expression source** | Expression 26 : `IF([AQ]<P.Gestion crise ? [F],P.Gestion crise ? [F],[AQ])` |
...
| **Expression source** | Expression 27 : `IF([AS]>V.Nb JH du mois [G],V.Nb JH du mois [G],[AS])` |
...
- **Appelle**: 0 programmes | **Tables**: 2 (W:0 R:1 L:1) | **Taches**: 1 | **Expressions**: 43
...
|----------|-------|------|------------|------|
| **68.1** | [**Deficit GE V3** (68)](#t1) [mockup](#ecran-t1) | - | 831x623 | Traitement |
...
| S | V.Nombre de personne | R | Numeric |
...
| S | V.Nombre de personne | Numeric | - |
...
| V. | **S** | V.Nombre de personne | Numeric |
...
|------|-----|------------|-------|
| CALCULATION | 42 | `[ES]+([EI]+[EM])` | - |
| CALCULATION | 43 | `[EZ]+(([EI]+[EM])/2)` | - |
| CALCULATION | 23 | `[AN]+[AO]` | - |
| CALCULATION | 41 | `[AO]+(([EI]+[EM])/2)` | - |

#### CONDITION (10 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONDITION | 27 | `IF([AS]>V.Nb JH du mois [G],V.Nb JH du mois [G],[AS])` | [RM-002](#rm-RM-002) |
| CONDITION | 26 | `IF([AQ]<P.Gestion crise ? [F],P.Gestion crise ? [F],[AQ])` | [RM-001](#rm-RM-001) |
| CONDITION | 35 | `[AS]>[DI] OR [DI]=0` | - |
| CONDITION | 33 | `[AQ]<[DH] OR [DH]=0` | - |
| CONDITION | 38 | `[ES]<>0 AND [EB]<>''` | - |
| ... | | *+5 autres* | |
...
| CONSTANTE | 36 | `''` | - |
| CONSTANTE | 22 | `0` | - |
| CONSTANTE | 2 | `'GE  séjour et repas'` | - |
| ... | | *+3 autres* | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| FORMAT | 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim([BU])&IF([CT]<>'','_'&Trim([CT])&'_','_')&'EFF_Deficit_GE_'&IF([DG],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` | - |
...
|------|-----|------------|-------|
| OTHER | 25 | `[BW]` | - |
| OTHER | 30 | `V.Nb JH du mois [G]` | - |
| OTHER | 21 | `[AO]` | - |
| OTHER | 24 | `[BV]` | - |
| OTHER | 31 | `P.Gestion crise ? [F]` | - |
| ... | | *+14 autres* | |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 26 | `IF([AQ]<P.Gestion crise ? [F],P.Gestion crise ? [F],[AQ])` |
| 27 | `IF([AS]>V.Nb JH du mois [G],V.Nb JH du mois [G],[AS])` |
| 12 | `CndRange([CT]<>'',[CT])` |
| 17 | `[CT]<>''` |
| 28 | `[BV]<[DD] OR [DD]=0` |
| 29 | `[BW]>[DE] OR [DE]=0` |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim([BU])&IF([CT]<>'','_'&Trim([CT])&'_','_')&'EFF_Deficit_GE_'&IF([DG],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` |
...
| 24 | `[BV]` |
| 25 | `[BW]` |
| 30 | `V.Nb JH du mois [G]` |
| 31 | `P.Gestion crise ? [F]` |
| 32 | `[AQ]` |
| 34 | `[AS]` |
| 39 | `[DL]` |
| 40 | `[DM]` |
...
Main -> ... -> [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md) -> **Deficit GE sejour et repas V3 (IDE 68)**

```mermaid
graph LR
    T68[68 Deficit GE sejour e...]
