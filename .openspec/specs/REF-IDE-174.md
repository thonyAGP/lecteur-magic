# REF IDE 174 - Browse - parametres_pme___pap
...
| Projet | REF |
| IDE Position | 174 |
| Nom Programme | Browse - parametres_pme___pap |
...
**Browse - parametres_pme___pap** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>174 - Browse - parametres_pme___pap

**Role** : Traitement : Browse - parametres_pme___pap.
...
|----------|-------|------|------------|------|
| **174.1** | [**Browse - parametres_pme___pap** (174)](#t1) | - | - | Traitement |
