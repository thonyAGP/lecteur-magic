# REF IDE 392 - Browse - pv_cust_rentals
...
| Projet | REF |
| IDE Position | 392 |
| Nom Programme | Browse - pv_cust_rentals |
...
**Browse - pv_cust_rentals** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>392 - Browse - pv_cust_rentals

**Role** : Traitement : Browse - pv_cust_rentals.
...
|----------|-------|------|------------|------|
| **392.1** | [**Browse - pv_cust_rentals** (392)](#t1) | - | - | Traitement |
