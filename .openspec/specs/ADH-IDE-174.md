...
| Ref | Nom | Type | Role |
|-----|-----|------|------|
| `{0,-78}` | V0 choix action | ALPHA | - |
| `{0,-77}` | W0 vers. ou retrait | ALPHA | - |
| `{0,-76}` | W0 scroll vide | ALPHA | - |
| `{0,-75}` | W0 date comptable | DATE | - |
| `{0,-74}` | W0 date operation | DATE | - |
| `{0,-73}` | W0 heure operation | TIME | - |
| `{0,-72}` | W0 message | ALPHA | - |
| `{0,-71}` | W0 reseau | ALPHA | - |
| `{0,-70}` | W0 cloture en cours | NUMERIC | - |
| `{0,-69}` | W0 qualite | ALPHA | - |
| `{0,-63}` | W0 Session caisse ouverte? | LOGICAL | - |
| `{0,-68}` | v.titre | ALPHA | - |
| `{0,-65}` | V.N°Ticket (VER/RET) | NUMERIC | - |
| `{0,-64}` | v.Email VAD | ALPHA | - |
