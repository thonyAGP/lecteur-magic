...
| Projet | EXM |
| IDE Position | 12 |
| Nom Programme | Saisie Vendeur |
| Fichier source | `Prg_12.xml` |
| Dossier IDE | Chargement |
...
**Saisie Vendeur** assure la gestion complete de ce processus, accessible depuis [Menu general (IDE 18)](EXM-IDE-18.md).
...
**Donnees modifiees** : 1 tables en ecriture (vendeur).
...
- **12** - lieux de vente **[[ECRAN]](#ecran-t1)**

#### Phase 2 : Traitement (1 tache)

- **12.1** - Vendeur **[[ECRAN]](#ecran-t2)**
...
#### <a id="t1"></a>12 - lieux de vente [[ECRAN]](#ecran-t1)
...
#### <a id="t2"></a>12.1 - Vendeur [[ECRAN]](#ecran-t2)

**Role** : Traitement : Vendeur.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 12.1 | 12.1 | Vendeur | MDI | 811 | 183 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t2"></a>12.1 - Vendeur
**Tache** : [12.1](#t2) | **Type** : MDI | **Dimensions** : 811 x 183 DLU
**Bloc** : Traitement | **Titre IDE** : Vendeur
...
Ecran unique: **Vendeur**

### 9.3 Structure hierarchique (2 taches)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **12.1** | [**lieux de vente** (12)](#t1) [mockup](#ecran-t1) | MDI | 166x10 | Saisie |
| **12.2** | [**Vendeur** (12.1)](#t2) [mockup](#ecran-t2) | MDI | 811x183 | Traitement |
...
<details>
<summary>Table 277 - vendeur (**W**) - 1 usages</summary>
...
Main -> ... -> [Menu general (IDE 18)](EXM-IDE-18.md) -> **Saisie Vendeur (IDE 12)**

```mermaid
graph LR
    T12[12 Saisie Vendeur]
...
|------------|------|--------|--------|
| vendeur | Table WRITE (Database) | 1x | Schema + repository |
