# VIL IDE 17 - Reinit Concurrence Session

> **Analyse**: Phases 1-4 2026-02-03 01:03 -> 01:04 (40s) | Assemblage 01:04
...
| Projet | VIL |
| IDE Position | 17 |
| Nom Programme | Reinit Concurrence Session |
...
**Reinit Concurrence Session** assure la gestion complete de ce processus, accessible depuis [Pilotage après sessions (IDE 10)](VIL-IDE-10.md).
...
#### <a id="t1"></a>17 - Reinit Concurrence Session

**Role** : Reinitialisation : Reinit Concurrence Session.
...
|----------|-------|------|------------|------|
| **17.1** | [**Reinit Concurrence Session** (17)](#t1) | MDI | - | Initialisation |
...
Main -> ... -> [Pilotage après sessions (IDE 10)](VIL-IDE-10.md) -> **Reinit Concurrence Session (IDE 17)**

```mermaid
graph LR
    T17[17 Reinit Concurrence ...]
