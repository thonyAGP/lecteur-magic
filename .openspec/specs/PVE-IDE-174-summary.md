...
> **Analyse**: 2026-02-03 18:40
> **Pipeline**: V7.2 Enrichi

## RESUME EXECUTIF

- **Fonction**: GetLocationPaymentSettings
- **Tables modifiees**: 0
- **Complexite**: **BASSE** (5/100)
- **Statut**: NON_ORPHELIN
- **Raison**: Appele par 5 programme(s): Print Invoice or Ticket (IDE 208), Print Invoice or Ticket-664 (IDE 209), Print Invoice or Ticket (IDE 358), Print Invoice or Ticket==NEW (IDE 429), AddPaymentToOrder (IDE 169)
