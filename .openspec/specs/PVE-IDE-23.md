# PVE IDE 23 - Report - Cost by Product

> **Analyse**: Phases 1-4 2026-02-03 01:10 -> 01:11 (39s) | Assemblage 01:11
...
| Projet | PVE |
| IDE Position | 23 |
| Nom Programme | Report - Cost by Product |
...
**Report - Cost by Product** assure la gestion complete de ce processus, accessible depuis [Menu Reports (IDE 182)](PVE-IDE-182.md).
...
- **23** - Report - Cost by Product **[[ECRAN]](#ecran-t1)**
- **23.1.1.1** - Lines
- **23.1.1.1.1** - Total
- **23.1.1.1.2.1** - Refund
...
#### <a id="t1"></a>23 - Report - Cost by Product [[ECRAN]](#ecran-t1)

**Role** : Traitement : Report - Cost by Product.
...
| Tache | Nom | Bloc |
|-------|-----|------|
| [23.1.1.1](#t4) | Lines | Traitement |
| [23.1.1.1.1](#t5) | Total | Traitement |
| [23.1.1.1.2.1](#t7) | Refund | Traitement |
...
#### <a id="t2"></a>23.1 - Print

**Role** : Generation du document : Print.

---

#### <a id="t3"></a>23.1.1 - EDITION

**Role** : Generation du document : EDITION.

---

#### <a id="t6"></a>23.1.1.1.2 - Print Totaux
...
- **Appelle**: 4 programmes | **Tables**: 4 (W:0 R:2 L:3) | **Taches**: 7 | **Expressions**: 6
...
|----------|-------|------|------------|------|
| **23.1** | [**Report - Cost by Product** (23)](#t1) [mockup](#ecran-t1) | MDI | 312x57 | Traitement |
| 23.1.1 | [Lines (23.1.1.1)](#t4) | MDI | - | |
| 23.1.2 | [Total (23.1.1.1.1)](#t5) | MDI | - | |
| 23.1.3 | [Refund (23.1.1.1.2.1)](#t7) | MDI | - | |
| **23.2** | [**Print** (23.1)](#t2) | MDI | - | Impression |
| 23.2.1 | [EDITION (23.1.1)](#t3) | MDI | - | |
| 23.2.2 | [Print Totaux (23.1.1.1.2)](#t6) | MDI | - | |
...
| Lettre | Nom | Type | Usage dans |
|--------|-----|------|-----------|
| L | v.NomFichier | Alpha | 1x session |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 4 | `Translate ('%club_exportdata%')&Trim (GetParam ('VILLAGECODE'))&Trim (GetParam ('SERVICE'))&'_GOODS_CONSUMED_COST_BY_PRODUCT_'&DStr (Date(),'YYYYMMDD')&'_'&TStr (Time(),'HHMMSS')&'.Pdf'` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| STRING | 5 | `FileDelete (Trim(v.NomFichier [L]))` | - |
...
Main -> ... -> [Menu Reports (IDE 182)](PVE-IDE-182.md) -> **Report - Cost by Product (IDE 23)**

```mermaid
graph LR
    T23[23 Report - Cost by Pr...]
