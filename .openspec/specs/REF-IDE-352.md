# REF IDE 352 - Browse - types_erreurs_od
...
| Projet | REF |
| IDE Position | 352 |
| Nom Programme | Browse - types_erreurs_od |
...
**Browse - types_erreurs_od** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>352 - Browse - types_erreurs_od

**Role** : Traitement : Browse - types_erreurs_od.
...
|----------|-------|------|------------|------|
| **352.1** | [**Browse - types_erreurs_od** (352)](#t1) | - | - | Traitement |
