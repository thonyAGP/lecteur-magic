...
#### <a id="t1"></a>167 - Liste des departs

**Role** : Traitement : Liste des departs.
**Variables liees** : B (CodeListe), C (TypeListe)
**Delegue a** : [  Liste CLients depart (IDE 168)](PBP-IDE-168.md), [Qua -> Tempo userlist (IDE 306)](PBP-IDE-306.md)
...
- **Appele par**: (aucun)
- **Appelle**: 7 programmes | **Tables**: 0 (W:0 R:0 L:0) | **Taches**: 1 | **Expressions**: 8
...
|----------|-------|------|------------|------|
| **167.1** | [**Liste des departs** (167)](#t1) | MDI | - | Traitement |
...
|-----|---------------|--------|----------|
| [168](PBP-IDE-168.md) |   Liste CLients depart | 1 | Configuration impression |
...
| [  Liste CLients depart (IDE 168)](PBP-IDE-168.md) | Sous-programme | 1x | Normale - Configuration impression |
