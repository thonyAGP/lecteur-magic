# PBP IDE 417 - Livre de porte SAV

> **Analyse**: Phases 1-4 2026-02-03 16:57 -> 16:57 (18s) | Assemblage 16:57
...
| Projet | PBP |
| IDE Position | 417 |
| Nom Programme | Livre de porte SAV |
...
**Livre de porte SAV** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>417 - Livre de Porte [[ECRAN]](#ecran-t1)
...
- **Appele par**: (aucun)
- **Appelle**: 4 programmes | **Tables**: 0 (W:0 R:0 L:0) | **Taches**: 1 | **Expressions**: 13
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 417 | 417 | Livre de Porte | MDI | 730 | 164 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>417 - Livre de Porte
**Tache** : [417](#t1) | **Type** : MDI | **Dimensions** : 730 x 164 DLU
...
|----------|-------|------|------------|------|
| **417.1** | [**Livre de Porte** (417)](#t1) [mockup](#ecran-t1) | MDI | 730x164 | Traitement |
...
| CAST_LOGIQUE | 8 | `INIPut ('[PREVIEW]'&Trim (Str (VG85,'4'))&'pview='&IF (v. preview [E],'O','N'),'FALSE'LOG)` | - |
