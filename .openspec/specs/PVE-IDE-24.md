# PVE IDE 24 - Report - Cost by Seller

> **Analyse**: Phases 1-4 2026-02-03 01:11 -> 01:12 (41s) | Assemblage 01:12
...
| Projet | PVE |
| IDE Position | 24 |
| Nom Programme | Report - Cost by Seller |
...
**Report - Cost by Seller** assure la gestion complete de ce processus, accessible depuis [Menu Reports (IDE 182)](PVE-IDE-182.md).
...
- **24** - Report - Cost by Seller **[[ECRAN]](#ecran-t1)**
- **24.1.1.1** - Lines
- **24.1.1.1.1** - Total
- **24.1.1.1.2.1** - Refund
...
#### <a id="t1"></a>24 - Report - Cost by Seller [[ECRAN]](#ecran-t1)

**Role** : Traitement : Report - Cost by Seller.
...
| Tache | Nom | Bloc |
|-------|-----|------|
| [24.1.1.1](#t4) | Lines | Traitement |
| [24.1.1.1.1](#t5) | Total | Traitement |
| [24.1.1.1.2.1](#t7) | Refund | Traitement |
...
#### <a id="t2"></a>24.1 - Print

**Role** : Generation du document : Print.

---

#### <a id="t3"></a>24.1.1 - EDITION

**Role** : Generation du document : EDITION.

---

#### <a id="t6"></a>24.1.1.1.2 - Print Totaux
...
- **Appelle**: 4 programmes | **Tables**: 2 (W:0 R:2 L:1) | **Taches**: 7 | **Expressions**: 5
...
|----------|-------|------|------------|------|
| **24.1** | [**Report - Cost by Seller** (24)](#t1) [mockup](#ecran-t1) | MDI | 312x57 | Traitement |
| 24.1.1 | [Lines (24.1.1.1)](#t4) | MDI | - | |
| 24.1.2 | [Total (24.1.1.1.1)](#t5) | MDI | - | |
| 24.1.3 | [Refund (24.1.1.1.2.1)](#t7) | MDI | - | |
| **24.2** | [**Print** (24.1)](#t2) | MDI | - | Impression |
| 24.2.1 | [EDITION (24.1.1)](#t3) | MDI | - | |
| 24.2.2 | [Print Totaux (24.1.1.1.2)](#t6) | MDI | - | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 3 | `Translate ('%club_exportdata%')&Trim (GetParam ('VILLAGECODE'))&Trim (GetParam ('SERVICE'))&'_GOODS_CONSUMED_COST_BY_SELLER_'&DStr (Date(),'YYYYMMDD')&'_'&TStr (Time(),'HHMMSS')&'.Pdf'` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| NEGATION | 5 | `NOT (GetParam ('Output')='Printer')` | - |

#### STRING (1 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| STRING | 4 | `FileDelete (Trim(v.NomFichierPdf [L]))` | - |
...
Main -> ... -> [Menu Reports (IDE 182)](PVE-IDE-182.md) -> **Report - Cost by Seller (IDE 24)**

```mermaid
graph LR
    T24[24 Report - Cost by Se...]
