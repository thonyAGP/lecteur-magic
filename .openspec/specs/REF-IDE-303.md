# REF IDE 303 - Browse - table_des_tva
...
| Projet | REF |
| IDE Position | 303 |
| Nom Programme | Browse - table_des_tva |
...
**Browse - table_des_tva** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>303 - Browse - table_des_tva

**Role** : Traitement : Browse - table_des_tva.
...
|----------|-------|------|------------|------|
| **303.1** | [**Browse - table_des_tva** (303)](#t1) | - | - | Traitement |
