# PBG IDE 382 - Creation clients Identite P185

> **Analyse**: Phases 1-4 2026-02-03 11:33 -> 11:34 (17s) | Assemblage 11:34
...
| Projet | PBG |
| IDE Position | 382 |
| Nom Programme | Creation clients Identite P185 |
...
**Creation clients Identite P185** assure la gestion complete de ce processus.
...
- **382** - Module des Clients
- **382.1** - Determination Age Bebe
- **382.2.1** - Modification Hebergement
- **382.2.3** - Demarquage Caisse
- **382.2.6** - personne existante **[[ECRAN]](#ecran-t10)**
- **382.2.7** - determination periode
- **382.2.8** - Reiteration **[[ECRAN]](#ecran-t12)**
- **382.2.8.1** - Clients **[[ECRAN]](#ecran-t13)**
- **382.2.8.1.1** - Modification Hebergement
- **382.2.8.1.3** - recup filiation club
- **382.2.8.1.4** - recup filiation
- **382.2.9** - MAJ immigration **[[ECRAN]](#ecran-t21)**
- **382.2.10** - Clients **[[ECRAN]](#ecran-t22)**
- **382.4** - Création client à vide
...
- **382.2** - Creation client **[[ECRAN]](#ecran-t4)**
- **382.2.2** - Creation Historique
- **382.2.4** - creation V/V
- **382.2.8.1.2** - Creation Historique

Delegue a : [   Creation Fidelisation (IDE 72)](PBG-IDE-72.md), [Create TAI GM (IDE 97)](PBG-IDE-97.md)

#### Phase 3 : Validation (2 taches)

- **382.2.5** - Verification Algorythme
- **382.2.13** - verif logements
...
- **382.2.8.1.5** - Calcul flag
- **382.2.8.1.6** - Calcul Millesia
- **382.2.12** - Mise a jour compteur
- **382.2.14** - Calcul Millesia

#### Phase 5 : Consultation (1 tache)

- **382.2.11** - Modif recherche
...
- **382.3** - Initialisation paramètres

#### Tables impactees

| Table | Operations | Role metier |
|-------|-----------|-------------|
| client_gm | R/**W**/L (5 usages) |  |
| gm-recherche_____gmr | R/**W**/L (4 usages) | Index de recherche |
| gm-complet_______gmc | **W** (3 usages) |  |
| compteurs________cpt | **W**/L (3 usages) | Comptes GM (generaux) |
...
#### <a id="t1"></a>382 - Module des Clients
...
| Tache | Nom | Bloc |
|-------|-----|------|
| [382.1](#t2) | Determination Age Bebe | Traitement |
| [382.2.1](#t5) | Modification Hebergement | Traitement |
| [382.2.3](#t7) | Demarquage Caisse | Traitement |
| [382.2.6](#t10) | personne existante **[[ECRAN]](#ecran-t10)** | Traitement |
| [382.2.7](#t11) | determination periode | Traitement |
| [382.2.8](#t12) | Reiteration **[[ECRAN]](#ecran-t12)** | Traitement |
| [382.2.8.1](#t13) | Clients **[[ECRAN]](#ecran-t13)** | Traitement |
| [382.2.8.1.1](#t14) | Modification Hebergement | Traitement |
| [382.2.8.1.3](#t17) | recup filiation club | Traitement |
| [382.2.8.1.4](#t18) | recup filiation | Traitement |
| [382.2.9](#t21) | MAJ immigration **[[ECRAN]](#ecran-t21)** | Traitement |
| [382.2.10](#t22) | Clients **[[ECRAN]](#ecran-t22)** | Traitement |
| [382.4](#t28) | Création client à vide | Traitement |

</details>

---

#### <a id="t2"></a>382.1 - Determination Age Bebe
...
#### <a id="t5"></a>382.2.1 - Modification Hebergement
...
#### <a id="t7"></a>382.2.3 - Demarquage Caisse

**Role** : Traitement : Demarquage Caisse.

---

#### <a id="t10"></a>382.2.6 - personne existante [[ECRAN]](#ecran-t10)
...
#### <a id="t11"></a>382.2.7 - determination periode

**Role** : Traitement : determination periode.

---

#### <a id="t12"></a>382.2.8 - Reiteration [[ECRAN]](#ecran-t12)
...
#### <a id="t13"></a>382.2.8.1 - Clients [[ECRAN]](#ecran-t13)
...
#### <a id="t14"></a>382.2.8.1.1 - Modification Hebergement
...
#### <a id="t17"></a>382.2.8.1.3 - recup filiation club
...
#### <a id="t18"></a>382.2.8.1.4 - recup filiation
...
#### <a id="t21"></a>382.2.9 - MAJ immigration [[ECRAN]](#ecran-t21)
...
#### <a id="t22"></a>382.2.10 - Clients [[ECRAN]](#ecran-t22)
...
#### <a id="t28"></a>382.4 - Création client à vide
...
#### <a id="t4"></a>382.2 - Creation client [[ECRAN]](#ecran-t4)
...
#### <a id="t6"></a>382.2.2 - Creation Historique
...
#### <a id="t8"></a>382.2.4 - creation V/V
...
#### <a id="t15"></a>382.2.8.1.2 - Creation Historique
...
#### <a id="t9"></a>382.2.5 - Verification Algorythme
...
#### <a id="t25"></a>382.2.13 - verif logements
...
#### <a id="t19"></a>382.2.8.1.5 - Calcul flag

**Role** : Calcul : Calcul flag.

---

#### <a id="t20"></a>382.2.8.1.6 - Calcul Millesia

**Role** : Calcul : Calcul Millesia.

---

#### <a id="t24"></a>382.2.12 - Mise a jour compteur
...
#### <a id="t26"></a>382.2.14 - Calcul Millesia
...
#### <a id="t23"></a>382.2.11 - Modif recherche
...
#### <a id="t27"></a>382.3 - Initialisation paramètres
...
- **Appele par**: (aucun)
- **Appelle**: 18 programmes | **Tables**: 22 (W:9 R:6 L:17) | **Taches**: 26 | **Expressions**: 18
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 382.2 | 382.2 | Creation client | MDI | 870 | 344 | Creation |
| 2 | 382.2.6 | 382.2.6 | personne existante | MDI | 776 | 145 | Traitement |
| 3 | 382.2.8.1 | 382.2.8.1 | Clients | MDI | 710 | 150 | Traitement |
| 4 | 382.2.9 | 382.2.9 | MAJ immigration | MDI | 638 | 168 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t4"></a>382.2 - Creation client
**Tache** : [382.2](#t4) | **Type** : MDI | **Dimensions** : 870 x 344 DLU
...
|-----------|-----|----------|------|
| 139,32 | CLI Nom | - | edit |
| 486,32 | CLI Prenom | - | edit |
| 668,31 | W1-select titre | - | combobox |
| 139,47 | W1-select qualite | - | edit |
| 136,67 | W1-select honey moon | - | combobox |
| 486,67 | W1-select fleurs | - | combobox |
| 696,68 | W1-Numero de dossier | - | edit |
| 136,84 | W1-select millesia | - | combobox |
| 486,84 | W1-type de milesia | - | combobox |
| 139,107 | CLI Date Debut | - | edit |
| 486,107 | W1-select vol aller | - | edit |
| 139,124 | CLI Date Fin | - | edit |
| 486,124 | W1-select vol dep | - | edit |
| 139,146 | CLI N° Adherent | - | edit |
| 424,146 | (sans nom) | - | edit |
| 598,146 | CLI Date Naissance | - | edit |
| 139,163 | W1-select inscription | - | edit |
| 224,165 | (sans nom) | - | edit |
| 139,185 | W1-select fumeur | - | combobox |
| 139,202 | W1-select lieu sejour | - | combobox |
| 539,202 | W1-select logement | - | edit |
| 139,219 | W1-select TUP | - | combobox |
| 539,218 | W1-select Base OCC | - | combobox |
| 779,146 | CLI Age | - | edit |
| 139,244 | GMR Langue Parlee | - | edit |
...
|--------|-----------|--------|
| ... | 325,47 | Bouton fonctionnel |
| ... | 275,107 | Bouton fonctionnel |
| ... | 581,107 | Bouton fonctionnel |
| ... | 275,124 | Bouton fonctionnel |
| ... | 581,124 | Bouton fonctionnel |
| ... | 189,163 | Bouton fonctionnel |
| ... | 661,202 | Bouton fonctionnel |
| ... | 178,244 | Bouton fonctionnel |
...
#### <a id="ecran-t10"></a>382.2.6 - personne existante
**Tache** : [382.2.6](#t10) | **Type** : MDI | **Dimensions** : 776 x 145 DLU
...
#### <a id="ecran-t13"></a>382.2.8.1 - Clients
**Tache** : [382.2.8.1](#t13) | **Type** : MDI | **Dimensions** : 710 x 150 DLU
...
#### <a id="ecran-t21"></a>382.2.9 - MAJ immigration
**Tache** : [382.2.9](#t21) | **Type** : MDI | **Dimensions** : 638 x 168 DLU
...
flowchart TD
    ...
    VF4[382.2 Creation client]
    style VF4 fill:#58a6ff
    VF10[382.2.6 personne existante]
    style VF10 fill:#58a6ff
    VF13[382.2.8.1 Clients]
    style VF13 fill:#58a6ff
    VF21[382.2.9 MAJ immigration]
...
|----------|-------|------|------------|------|
| **382.1** | [**Module des Clients** (382)](#t1) | MDI | - | Traitement |
| 382.1.1 | [Determination Age Bebe (382.1)](#t2) | MDI | - | |
| 382.1.2 | [Modification Hebergement (382.2.1)](#t5) | MDI | - | |
| 382.1.3 | [Demarquage Caisse (382.2.3)](#t7) | MDI | - | |
| 382.1.4 | [personne existante (382.2.6)](#t10) [mockup](#ecran-t10) | MDI | 776x145 | |
| 382.1.5 | [determination periode (382.2.7)](#t11) | MDI | - | |
| 382.1.6 | [Reiteration (382.2.8)](#t12) [mockup](#ecran-t12) | MDI | 706x147 | |
| 382.1.7 | [Clients (382.2.8.1)](#t13) [mockup](#ecran-t13) | MDI | 710x150 | |
| 382.1.8 | [Modification Hebergement (382.2.8.1.1)](#t14) | MDI | - | |
| 382.1.9 | [recup filiation club (382.2.8.1.3)](#t17) | MDI | - | |
| 382.1.10 | [recup filiation (382.2.8.1.4)](#t18) | MDI | - | |
| 382.1.11 | [MAJ immigration (382.2.9)](#t21) [mockup](#ecran-t21) | MDI | 638x168 | |
| 382.1.12 | [Clients (382.2.10)](#t22) [mockup](#ecran-t22) | MDI | 216x52 | |
| 382.1.13 | [Création client à vide (382.4)](#t28) | - | - | |
| **382.2** | [**Creation client** (382.2)](#t4) [mockup](#ecran-t4) | MDI | 870x344 | Creation |
| 382.2.1 | [Creation Historique (382.2.2)](#t6) | MDI | - | |
| 382.2.2 | [creation V/V (382.2.4)](#t8) | MDI | - | |
| 382.2.3 | [Creation Historique (382.2.8.1.2)](#t15) | MDI | - | |
| **382.3** | [**Verification Algorythme** (382.2.5)](#t9) | MDI | - | Validation |
| 382.3.1 | [verif logements (382.2.13)](#t25) | MDI | - | |
| **382.4** | [**Calcul flag** (382.2.8.1.5)](#t19) | MDI | - | Calcul |
| 382.4.1 | [Calcul Millesia (382.2.8.1.6)](#t20) | MDI | - | |
| 382.4.2 | [Mise a jour compteur (382.2.12)](#t24) | MDI | - | |
| 382.4.3 | [Calcul Millesia (382.2.14)](#t26) | MDI | - | |
| **382.5** | [**Modif recherche** (382.2.11)](#t23) | MDI | - | Consultation |
| **382.6** | [**Initialisation paramètres** (382.3)](#t27) | MDI | - | Initialisation |
...
<details>
<summary>Table 36 - client_gm (R/**W**/L) - 5 usages</summary>
...
<details>
<summary>Table 68 - compteurs________cpt (**W**/L) - 3 usages</summary>
...
| K | W0-Fin de Tache | Logical | - |
| L | W0-Age Bebe | Numeric | - |
| M | W0-Base Vide | Alpha | - |
| O | W0-autorisation creation | Alpha | [382.2](#t4), [382.2.2](#t6), [382.2.4](#t8) |
