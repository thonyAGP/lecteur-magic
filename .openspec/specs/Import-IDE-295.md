# Import IDE 295 - Import - histo_fusionseparatio
...
#### <a id="t1"></a>295 - Import - histo_fusionseparatio
...
|----------|-------|------|------------|------|
| **295.1** | [**Import - histo_fusionseparatio** (295)](#t1) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 2 | `Trim(INIGet('[MAGIC_LOGICAL_NAMES]import'))&'histo_fus_sep_saisie.TXT'` | - |
...
Main -> ... -> [Lanceur (IDE 2)](Import-IDE-2.md) -> **Import - histo_fusionseparatio (IDE 295)**

```mermaid
graph LR
    T295[295 Import - histo_fus...]
