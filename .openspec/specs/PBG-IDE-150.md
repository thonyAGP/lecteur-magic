# PBG IDE 150 - Alimentation Combos U/P

> **Analyse**: Phases 1-4 2026-02-03 09:44 -> 09:45 (18s) | Assemblage 09:45
...
| Projet | PBG |
| IDE Position | 150 |
| Nom Programme | Alimentation Combos U/P |
...
**Alimentation Combos U/P** assure la gestion complete de ce processus, accessible depuis [Execution des màj combo (IDE 141)](PBG-IDE-141.md).
...
#### <a id="t1"></a>150 - Êcran [[ECRAN]](#ecran-t1)
...
|----------|-------|------|------------|------|
| **150.1** | [**Êcran** (150)](#t1) [mockup](#ecran-t1) | MDI | 573x85 | Traitement |
...
Main -> ... -> [Execution des màj combo (IDE 141)](PBG-IDE-141.md) -> **Alimentation Combos U/P (IDE 150)**

```mermaid
graph LR
    T150[150 Alimentation Combo...]
