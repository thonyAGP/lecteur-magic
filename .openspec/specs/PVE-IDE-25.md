# PVE IDE 25 - Report - Cost by Place

> **Analyse**: Phases 1-4 2026-02-03 01:12 -> 01:13 (40s) | Assemblage 01:13
...
**Report - Cost by Place** assure la gestion complete de ce processus, accessible depuis [Menu Reports (IDE 182)](PVE-IDE-182.md).
...
- **25** - Report - Cost by Place **[[ECRAN]](#ecran-t1)**
- **25.1.1.1** - Lines
- **25.1.1.1.1** - Total
- **25.1.1.1.2.1** - Refund
...
#### <a id="t1"></a>25 - Report - Cost by Place [[ECRAN]](#ecran-t1)
...
| Tache | Nom | Bloc |
|-------|-----|------|
| [25.1.1.1](#t4) | Lines | Traitement |
| [25.1.1.1.1](#t5) | Total | Traitement |
| [25.1.1.1.2.1](#t7) | Refund | Traitement |
...
#### <a id="t2"></a>25.1 - Print

**Role** : Generation du document : Print.

---

#### <a id="t3"></a>25.1.1 - EDITION

**Role** : Generation du document : EDITION.

---

#### <a id="t6"></a>25.1.1.1.2 - Print Totaux
...
|----------|-------|------|------------|------|
| **25.1** | [**Report - Cost by Place** (25)](#t1) [mockup](#ecran-t1) | MDI | 312x57 | Traitement |
| 25.1.1 | [Lines (25.1.1.1)](#t4) | MDI | - | |
| 25.1.2 | [Total (25.1.1.1.1)](#t5) | MDI | - | |
| 25.1.3 | [Refund (25.1.1.1.2.1)](#t7) | MDI | - | |
| **25.2** | [**Print** (25.1)](#t2) | MDI | - | Impression |
| 25.2.1 | [EDITION (25.1.1)](#t3) | MDI | - | |
| 25.2.2 | [Print Totaux (25.1.1.1.2)](#t6) | MDI | - | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 4 | `Translate ('%club_exportdata%')&Trim (GetParam ('VILLAGECODE'))&Trim (GetParam ('SERVICE'))&'_GOODS_CONSUMED_COST_BY_SALE_PLACE_'&DStr (Date(),'YYYYMMDD')&'_'&TStr (Time(),'HHMMSS')&'.Pdf'` | - |
...
Main -> ... -> [Menu Reports (IDE 182)](PVE-IDE-182.md) -> **Report - Cost by Place (IDE 25)**

```mermaid
graph LR
    T25[25 Report - Cost by Place]
