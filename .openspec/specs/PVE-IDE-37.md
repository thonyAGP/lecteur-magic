# PVE IDE 37 - Report - Margin by Product

> **Analyse**: Phases 1-4 2026-02-03 01:23 -> 01:24 (36s) | Assemblage 01:24
...
**Report - Margin by Product** assure la gestion complete de ce processus, accessible depuis [Menu Reports (IDE 182)](PVE-IDE-182.md).
...
- **37** - Report - Margin by Product **[[ECRAN]](#ecran-t1)**
- **37.1.1.1** - Lines
- **37.1.1.1.1** - Total
- **37.1.1.1.2.1** - Refund
...
#### <a id="t1"></a>37 - Report - Margin by Product [[ECRAN]](#ecran-t1)
...
| Tache | Nom | Bloc |
|-------|-----|------|
| [37.1.1.1](#t4) | Lines | Traitement |
| [37.1.1.1.1](#t5) | Total | Traitement |
| [37.1.1.1.2.1](#t7) | Refund | Traitement |
...
#### <a id="t2"></a>37.1 - Print

**Role** : Generation du document : Print.

---

#### <a id="t3"></a>37.1.1 - EDITION
...
#### <a id="t6"></a>37.1.1.1.2 - Print Totaux
...
- **Appelle**: 4 programmes | **Tables**: 4 (W:0 R:2 L:3) | **Taches**: 7 | **Expressions**: 8
...
|----------|-------|------|------------|------|
| **37.1** | [**Report - Margin by Product** (37)](#t1) [mockup](#ecran-t1) | MDI | 312x57 | Traitement |
| 37.1.1 | [Lines (37.1.1.1)](#t4) | MDI | - | |
| 37.1.2 | [Total (37.1.1.1.1)](#t5) | MDI | - | |
| 37.1.3 | [Refund (37.1.1.1.2.1)](#t7) | MDI | - | |
| **37.2** | [**Print** (37.1)](#t2) | MDI | - | Impression |
| 37.2.1 | [EDITION (37.1.1)](#t3) | MDI | - | |
| 37.2.2 | [Print Totaux (37.1.1.1.2)](#t6) | MDI | - | |
...
| Lettre | Nom | Type | Usage dans |
|--------|-----|------|-----------|
| L | V Annule Edition | Logical | [37.1.1](#t3) |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 6 | `Translate ('%club_exportdata%')&Trim (GetParam ('VILLAGECODE'))&Trim (GetParam ('SERVICE'))&'_GROSS_MARGIN_BY_PRODUCT_'&DStr (Date(),'YYYYMMDD')&'_'&TStr (Time(),'HHMMSS')&'.Pdf'` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| STRING | 7 | `FileDelete (Trim(v.NomFichierPdf [M]))` | - |
...
Main -> ... -> [Menu Reports (IDE 182)](PVE-IDE-182.md) -> **Report - Margin by Product (IDE 37)**

```mermaid
graph LR
    T37[37 Report - Margin by ...]
