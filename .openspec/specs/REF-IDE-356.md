# REF IDE 356 - Browse - pms_footer_comment
...
| Projet | REF |
| IDE Position | 356 |
| Nom Programme | Browse - pms_footer_comment |
...
**Browse - pms_footer_comment** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>356 - Browse - pms_footer_comment

**Role** : Traitement : Browse - pms_footer_comment.
...
|----------|-------|------|------------|------|
| **356.1** | [**Browse - pms_footer_comment** (356)](#t1) | - | - | Traitement |
