# PBS IDE 15 - Table des Bâtiments

> **Analyse**: Phases 1-4 2026-02-03 17:04 -> 17:04 (18s) | Assemblage 17:04
...
#### <a id="t1"></a>15 - Êcran [[ECRAN]](#ecran-t1)

**Role** : Traitement : Êcran.
**Ecran** : 936 x 248 DLU (MDI) | [Voir mockup](#ecran-t1)
...
#### <a id="t2"></a>15.1 - Mise à Jour Combo
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 15 | 15 | Êcran | MDI | 936 | 248 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>15 - Êcran
**Tache** : [15](#t1) | **Type** : MDI | **Dimensions** : 936 x 248 DLU
...
| 443,45 | v.NbrChambresGM | - | edit |
| 6,7 | 30 | - | edit |
| 711,7 | WWW DD MMM YYYYT | - | edit |
| 571,45 | v.NbrChambresGO | - | edit |
...
|--------|-----------|--------|
| Visualisation | 760,103 | Bouton fonctionnel |
| Modification | 760,124 | Modifie l'element |
| Creation | 760,145 | Appel [Creation Historique (IDE 79)](PBS-IDE-79.md) |
| Annulation | 760,166 | Annule et retour au menu |
| Suppression | 760,187 | Supprime l'element selectionne |
...
|----------|-------|------|------------|------|
| **15.1** | [**Êcran** (15)](#t1) [mockup](#ecran-t1) | MDI | 936x248 | Traitement |
| 15.1.1 | [Mise à Jour Combo (15.1)](#t2) | MDI | - | |
...
|------|-----|------------|-------|
| CALCULATION | 23 | `CallProg('{207,-1}'PROG,v.NbrChambresGO [G],'lop_batiment',Trim([J]))` | - |
| CALCULATION | 22 | `CallProg('{206,-1}'PROG,v.NbrChambresGO [G],'loc_batiment',Trim([J]))` | - |
...
|-----|-------------------|
| 22 | `CallProg('{206,-1}'PROG,v.NbrChambresGO [G],'loc_batiment',Trim([J]))` |
| 23 | `CallProg('{207,-1}'PROG,v.NbrChambresGO [G],'lop_batiment',Trim([J]))` |
