# WEL IDE 44 - Lancement reaffectation

> **Analyse**: Phases 1-4 2026-02-03 21:26 -> 21:27 (17s) | Assemblage 21:27
...
| Projet | WEL |
| IDE Position | 44 |
| Nom Programme | Lancement reaffectation |
...
**Lancement reaffectation** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>44 - Lancement reaffectation

**Role** : Traitement : Lancement reaffectation.
...
|----------|-------|------|------------|------|
| **44.1** | [**Lancement reaffectation** (44)](#t1) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| NEGATION | 5 | `NOT P.Refresh view [A]` | - |

#### OTHER (1 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 7 | `MlsTrans ('Call Re_Assign Room')` | - |
