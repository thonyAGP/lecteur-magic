...
| Projet | PBP |
| IDE Position | 83 |
| Nom Programme | Deficit Medecin V3 |
...
**Deficit Medecin V3** assure la gestion complete de ce processus, accessible depuis [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md).
...
#### <a id="t2"></a>83 - GO DOCT

**Role** : Traitement : GO DOCT.

---

#### <a id="t6"></a>83.1 - Deficit GO DOCT V3

**Role** : Traitement : Deficit GO DOCT V3.
...
|----------|-------|------|------------|------|
| **83.1** | [**GO DOCT** (83)](#t2) | - | - | Traitement |
| 83.1.1 | [Deficit GO DOCT V3 (83.1)](#t6) | - | - | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| FORMAT | 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim(P.Lieu sejour [D])&IF(P.Nom lieu [E]<>'','_'&Trim(P.Nom lieu [E])&'_','_')&'EFF_Deficit_DOCT_'&IF(V.Heure fin derniere p... [K],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` | - |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim(P.Lieu sejour [D])&IF(P.Nom lieu [E]<>'','_'&Trim(P.Nom lieu [E])&'_','_')&'EFF_Deficit_DOCT_'&IF(V.Heure fin derniere p... [K],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` |
...
Main -> ... -> [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md) -> **Deficit Medecin V3 (IDE 83)**

```mermaid
graph LR
    T83[83 Deficit Medecin V3]
