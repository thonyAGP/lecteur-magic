# PBP IDE 294 - RaZ 620 Tempo service

> **Analyse**: Phases 1-4 2026-02-03 16:14 -> 16:14 (16s) | Assemblage 16:14
...
| Projet | PBP |
| IDE Position | 294 |
| Nom Programme | RaZ 620 Tempo service |
...
**RaZ 620 Tempo service** assure la gestion complete de ce processus, accessible depuis [Service GO (IDE 133)](PBP-IDE-133.md).
...
#### <a id="t1"></a>294 - RaZ Tempo service [[ECRAN]](#ecran-t1)

**Role** : Reinitialisation : RaZ Tempo service.
...
|----------|-------|------|------------|------|
| **294.1** | [**RaZ Tempo service** (294)](#t1) [mockup](#ecran-t1) | MDI | 424x56 | Initialisation |
...
Main -> ... -> [Service GO (IDE 133)](PBP-IDE-133.md) -> **RaZ 620 Tempo service (IDE 294)**

```mermaid
graph LR
    T294[294 RaZ 620 Tempo service]
