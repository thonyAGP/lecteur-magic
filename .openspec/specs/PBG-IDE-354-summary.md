...
> **Analyse**: 2026-02-03 11:22
> **Pipeline**: V7.2 Enrichi

## RESUME EXECUTIF

- **Fonction**: Zoom inscription
- **Tables modifiees**: 1
- **Complexite**: **BASSE** (7/100)
- **Statut**: NON_ORPHELIN
- **Raison**: Appele par 8 programme(s): Creation clients Identite (IDE 87), Creation clients Identite SAV (IDE 379), Creation clients Identite P185 (IDE 382), Creation clients Identite PROD (IDE 383), Creation clients Identite en c (IDE 384), Creation clients Identite SAV* (IDE 386), Creation clients Identite_sav (IDE 387), Modules clients Identite (IDE 91)
