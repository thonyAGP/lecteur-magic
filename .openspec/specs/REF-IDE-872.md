...
| Projet | REF |
| IDE Position | 872 |
| Nom Programme | Program_957 |
| Fichier source | `Prg_872.xml` |
| Dossier IDE | General |
...
**Program_957** assure la gestion complete de ce processus.
...
|----------|-------|------|------------|------|
| **872.1** | [**(sans nom)** (872)](#t1) | - | - | Traitement |
...
```mermaid
graph LR
    T872[872 Program_957]
    style T872 fill:#58a6ff
    NONE[Aucun caller]
    NONE -.-> T872
