# PBP IDE 82 - Deficit Educteur V3
...
| Projet | PBP |
| IDE Position | 82 |
| Nom Programme | Deficit Educteur V3 |
...
**Deficit Educteur V3** assure la gestion complete de ce processus, accessible depuis [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md).
...
#### <a id="t2"></a>82 - GO EDUC

**Role** : Traitement : GO EDUC.

---

#### <a id="t6"></a>82.1 - Deficit GO EDUC V3

**Role** : Traitement : Deficit GO EDUC V3.
...
|----------|-------|------|------------|------|
| **82.1** | [**GO EDUC** (82)](#t2) | - | - | Traitement |
| 82.1.1 | [Deficit GO EDUC V3 (82.1)](#t6) | - | - | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| FORMAT | 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim(P.Lieu sejour [D])&IF(P.Nom lieu [E]<>'','_'&Trim(P.Nom lieu [E])&'_','_')&'EFF_Deficit_EDUC_'&IF(V.Heure fin derniere p... [K],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` | - |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim(P.Lieu sejour [D])&IF(P.Nom lieu [E]<>'','_'&Trim(P.Nom lieu [E])&'_','_')&'EFF_Deficit_EDUC_'&IF(V.Heure fin derniere p... [K],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` |
...
Main -> ... -> [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md) -> **Deficit Educteur V3 (IDE 82)**

```mermaid
graph LR
    T82[82 Deficit Educteur V3]
