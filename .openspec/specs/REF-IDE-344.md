# REF IDE 344 - Browse - entete_log_tpe
...
| Projet | REF |
| IDE Position | 344 |
| Nom Programme | Browse - entete_log_tpe |
...
**Browse - entete_log_tpe** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>344 - Browse - entete_log_tpe

**Role** : Traitement : Browse - entete_log_tpe.
...
|----------|-------|------|------------|------|
| **344.1** | [**Browse - entete_log_tpe** (344)](#t1) | - | - | Traitement |
