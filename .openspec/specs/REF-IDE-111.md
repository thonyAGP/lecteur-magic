# REF IDE 111 - Browse - tables_imports
...
| Projet | REF |
| IDE Position | 111 |
| Nom Programme | Browse - tables_imports |
...
**Browse - tables_imports** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>111 - Browse - tables_imports

**Role** : Traitement : Browse - tables_imports.
...
|----------|-------|------|------------|------|
| **111.1** | [**Browse - tables_imports** (111)](#t1) | - | - | Traitement |
