# PBP IDE 34 - Edit securite equ. Fonct. N C6

> **Analyse**: Phases 1-4 2026-02-03 01:20 -> 01:21 (37s) | Assemblage 01:21
...
| Projet | PBP |
| IDE Position | 34 |
| Nom Programme | Edit securite equ. Fonct. N C6 |
...
**Edit securite equ. Fonct. N C6** assure la gestion complete de ce processus, accessible depuis [Centralisation nbre edition (IDE 30)](PBP-IDE-30.md).
...
#### <a id="t1"></a>34 - Veuillez patienter... [[ECRAN]](#ecran-t1)
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 34 | 34 | Veuillez patienter... | MDI | 427 | 57 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>34 - Veuillez patienter...
**Tache** : [34](#t1) | **Type** : MDI | **Dimensions** : 427 x 57 DLU
...
|----------|-------|------|------------|------|
| **34.1** | [**Veuillez patienter...** (34)](#t1) [mockup](#ecran-t1) | MDI | 427x57 | Traitement |
...
Main -> ... -> [Centralisation nbre edition (IDE 30)](PBP-IDE-30.md) -> **Edit securite equ. Fonct. N C6 (IDE 34)**

```mermaid
graph LR
    T34[34 Edit securite equ. ...]
