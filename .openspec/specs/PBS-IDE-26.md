# PBS IDE 26 - Log Nom (Cli/Per/Ext) Libre ?

> **Analyse**: Phases 1-4 2026-02-03 17:08 -> 17:09 (16s) | Assemblage 17:09
...
| Projet | PBS |
| IDE Position | 26 |
| Nom Programme | Log Nom (Cli/Per/Ext) Libre ? |
...
#### <a id="t1"></a>26 - Verification Existant Nom
...
|----------|-------|------|------------|------|
| **26.1** | [**Verification Existant Nom** (26)](#t1) | MDI | - | Validation |
...
|--------|----------|-------|------|
| A | >Nom Logement | R | Alpha |
| B | < Validation | R | Logical |
| C | v.Lien Log Client | R | Logical |
| D | v.Lien Log Personnel | R | Logical |
| E | v.Lien Log Exterieur | R | Logical |
...
|--------|-----|------|-----------|
| C | v.Lien Log Client | Logical | 1x session |
| D | v.Lien Log Personnel | Logical | 1x session |
| E | v.Lien Log Exterieur | Logical | 1x session |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 5 | `v.Lien Log Client [C] OR v.Lien Log Personnel [D] OR v.Lien Log Exterieur [E]` | - |
...
Main -> ... -> [Logement client (IDE 22)](PBS-IDE-22.md) -> **Log Nom (Cli/Per/Ext) Libre ? (IDE 26)**

Main -> ... -> [Logement client pms-626 evo (IDE 23)](PBS-IDE-23.md) -> **Log Nom (Cli/Per/Ext) Libre ? (IDE 26)**

Main -> ... -> [ Duplication Logement Client (IDE 29)](PBS-IDE-29.md) -> **Log Nom (Cli/Per/Ext) Libre ? (IDE 26)**

Main -> ... -> [Logement personnel (IDE 34)](PBS-IDE-34.md) -> **Log Nom (Cli/Per/Ext) Libre ? (IDE 26)**

Main -> ... -> [ Duplication Logement Perso (IDE 35)](PBS-IDE-35.md) -> **Log Nom (Cli/Per/Ext) Libre ? (IDE 26)**

Main -> ... -> [Logement exterieur (IDE 38)](PBS-IDE-38.md) -> **Log Nom (Cli/Per/Ext) Libre ? (IDE 26)**

Main -> ... -> [Duplication Logement Exterieur (IDE 39)](PBS-IDE-39.md) -> **Log Nom (Cli/Per/Ext) Libre ? (IDE 26)**

Main -> ... -> [Logement client pms-626 (IDE 99)](PBS-IDE-99.md) -> **Log Nom (Cli/Per/Ext) Libre ? (IDE 26)**

```mermaid
graph LR
    T26[26 Log Nom CliPerExt L...]
