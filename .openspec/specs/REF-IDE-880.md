...
#### <a id="t1"></a>880 - Test Envoi Mail

**Role** : Verification : Test Envoi Mail.
**Delegue a** : [Search From&Sujet&Corps Mail (IDE 788)](REF-IDE-788.md)
...
|----------|-------|------|------------|------|
| **880.1** | [**Test Envoi Mail** (880)](#t1) | - | - | Traitement |
...
|--------|-----|------|-----------|
| A | v.sujet | Unicode | 1x session |
| B | v.corps | Unicode | 1x session |
...
|------|-----|------------|-------|
| CALCULATION | 4 | `'12/04/2022'DATE` | - |

#### CONSTANTE (3 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONSTANTE | 3 | `'12/04/2022'` | - |
| CONSTANTE | 2 | `'ARCS PANORAMA'` | - |
| CONSTANTE | 1 | `'TESTECO'` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| STRING | 6 | `'Message : '&Trim(v.corps [B])` | - |
| STRING | 5 | `'Sujet : '&Trim(v.sujet [A])` | - |
...
```mermaid
graph LR
    T880[880 Test Envoi Mail]
    style T880 fill:#58a6ff
    NONE[Aucun caller]
    NONE -.-> T880
