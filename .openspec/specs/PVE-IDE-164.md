...
**CloseOrder-392** assure la gestion complete de ce processus, accessible depuis [Ligne Non Validées & Edit Book (IDE 129)](PVE-IDE-129.md), [FindAppointmentsToClose (IDE 172)](PVE-IDE-172.md).
...
#### <a id="t1"></a>164 - CloseOrder-392

**Role** : Traitement : CloseOrder-392.
...
|----------|-------|------|------------|------|
| **164.1** | [**CloseOrder-392** (164)](#t1) | - | - | Traitement |
...
| FORMAT | 4 | `Trim(VG66) & '/v4.1/merchant/order/' & Trim(Str(p.i.OrderID [A],'18')) & '/close?access_token='&Trim(Token [C])` | - |
| FORMAT | 3 | `Trim(VG66) & '/order/' & Trim(Str(p.i.OrderID [A],'18')) & '/close?access_token='&Trim(Token [C])` | - |
...
Main -> ... -> [Ligne Non Validées & Edit Book (IDE 129)](PVE-IDE-129.md) -> **CloseOrder-392 (IDE 164)**

Main -> ... -> [FindAppointmentsToClose (IDE 172)](PVE-IDE-172.md) -> **CloseOrder-392 (IDE 164)**

```mermaid
graph LR
    T164[164 CloseOrder-392]
