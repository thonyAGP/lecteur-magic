# REF IDE 393 - Browse - pv_cust_rentals_histo
...
| Projet | REF |
| IDE Position | 393 |
| Nom Programme | Browse - pv_cust_rentals_histo |
...
**Browse - pv_cust_rentals_histo** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>393 - Browse - pv_cust_rentals_histo

**Role** : Traitement : Browse - pv_cust_rentals_histo.
...
|----------|-------|------|------------|------|
| **393.1** | [**Browse - pv_cust_rentals_histo** (393)](#t1) | - | - | Traitement |
