# PBP IDE 74 - Deficit Excursions RepasV3?

> **Analyse**: Phases 1-4 2026-02-03 09:09 -> 09:10 (30s) | Assemblage 09:10
...
| Projet | PBP |
| IDE Position | 74 |
| Nom Programme | Deficit Excursions RepasV3? |
...
**Deficit Excursions RepasV3?** assure la gestion complete de ce processus, accessible depuis [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md).
...
#### <a id="t1"></a>74.1 - Deficit IGR EXC

**Role** : Traitement : Deficit IGR EXC.

---

#### <a id="t2"></a>74 - IGR EXC

**Role** : Traitement : IGR EXC.
...
#### <a id="rm-RM-001"></a>[RM-001] Si [DV]='EXCALA' alors 'Excursion allant à : '&[DW] sinon 'Excursion venant de : '&[DW])

| Element | Detail |
|---------|--------|
| **Condition** | `[DV]='EXCALA'` |
| **Si vrai** | 'Excursion allant à : '&[DW] |
| **Si faux** | 'Excursion venant de : '&[DW]) |
| **Expression source** | Expression 8 : `IF([DV]='EXCALA','Excursion allant à : '&[DW],'Excursion ven` |
| **Exemple** | Si [DV]='EXCALA' â†’ 'Excursion allant à : '&[DW]. Sinon â†’ 'Excursion venant de : '&[DW]) |
...
|----------|-------|------|------------|------|
| **74.1** | [**Deficit IGR EXC** (74.1)](#t1) | - | - | Traitement |
| 74.1.1 | [IGR EXC (74)](#t2) | - | - | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONDITION | 8 | `IF([DV]='EXCALA','Excursion allant à : '&[DW],'Excursion venant de : '&[DW])` | [RM-001](#rm-RM-001) |
...
| CONSTANTE | 15 | `0` | - |
| CONSTANTE | 12 | `'IGR'` | - |
| CONSTANTE | 1 | `'Excursions (Repas)'` | - |
| CONSTANTE | 2 | `'800160350'` | - |

#### FORMAT (1 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| FORMAT | 3 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim(V.Nb jh soir [D])&IF(P.Nom lieu [E]<>'','_'&Trim(P.Nom lieu [E])&'_','_')&'EFF_Deficit_EXC_'&IF([K],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` | - |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 8 | `IF([DV]='EXCALA','Excursion allant à : '&[DW],'Excursion venant de : '&[DW])` |
| 7 | `P.Nom lieu [E]<>''` |
| 9 | `[DV]<>''` |
| 14 | `[EA]='DEJ' OR [EA]='DDE'` |
| 16 | `[EA]='DIN' OR [EA]='DDE'` |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 3 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim(V.Nb jh soir [D])&IF(P.Nom lieu [E]<>'','_'&Trim(P.Nom lieu [E])&'_','_')&'EFF_Deficit_EXC_'&IF([K],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` |
...
Main -> ... -> [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md) -> **Deficit Excursions RepasV3? (IDE 74)**

```mermaid
graph LR
    T74[74 Deficit Excursions ...]
