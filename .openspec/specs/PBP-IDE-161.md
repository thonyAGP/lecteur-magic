# PBP IDE 161 - Liste des presents

> **Analyse**: Phases 1-4 2026-02-03 15:33 -> 15:33 (10s) | Assemblage 15:33
...
| Projet | PBP |
| IDE Position | 161 |
| Nom Programme | Liste des presents |
...
**Liste des presents** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>161 - Liste des presents

**Role** : Traitement : Liste des presents.
**Variables liees** : B (CodeListe), C (TypeListe)
**Delegue a** : [  Liste Clients present (IDE 162)](PBP-IDE-162.md), [Qua -> Tempo userlist (IDE 306)](PBP-IDE-306.md)
...
- **Appele par**: (aucun)
- **Appelle**: 8 programmes | **Tables**: 0 (W:0 R:0 L:0) | **Taches**: 1 | **Expressions**: 8
...
|----------|-------|------|------------|------|
| **161.1** | [**Liste des presents** (161)](#t1) | MDI | - | Traitement |
...
graph LR
    T161[161 Liste des presents]
    style T161 fill:#58a6ff
    C162[162 Liste Clients present]
    T161 --> C162
...
|-----|---------------|--------|----------|
| [162](PBP-IDE-162.md) |   Liste Clients present | 1 | Configuration impression |
...
| [  Liste Clients present (IDE 162)](PBP-IDE-162.md) | Sous-programme | 1x | Normale - Configuration impression |
