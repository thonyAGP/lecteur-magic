# REF IDE 275 - Browse - derniere_sauvegarde
...
| Projet | REF |
| IDE Position | 275 |
| Nom Programme | Browse - derniere_sauvegarde |
...
**Browse - derniere_sauvegarde** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>275 - Browse - derniere_sauvegarde

**Role** : Traitement : Browse - derniere_sauvegarde.
...
|----------|-------|------|------------|------|
| **275.1** | [**Browse - derniere_sauvegarde** (275)](#t1) | - | - | Traitement |
