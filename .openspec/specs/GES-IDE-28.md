# GES IDE 28 - Determination Age Debut Sejou
...
**Determination Age Debut Sejou** assure la gestion complete de ce processus, accessible depuis [Comptes speciaux (IDE 48)](GES-IDE-48.md).
...
#### <a id="t1"></a>28 - Determination Age
...
|----------|-------|------|------------|------|
| **28.1** | [**Determination Age** (28)](#t1) | MDI | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 19 | `W0 Date debut sejour [F]` | - |
...
Main -> ... -> [Comptes speciaux (IDE 48)](GES-IDE-48.md) -> **Determination Age Debut Sejou (IDE 28)**

```mermaid
graph LR
    T28[28 Determination Age D...]
