...
**Delete GMR adh=0** assure la gestion complete de ce processus, accessible depuis [Purge Batch (IDE 18)](PUG-IDE-18.md), [Purge - NU - (IDE 24)](PUG-IDE-24.md), [Purge Batch Save (IDE 25)](PUG-IDE-25.md).
...
#### <a id="t1"></a>12 - Delete GMR adh=0 [[ECRAN]](#ecran-t1)
...
|----------|-------|------|------------|------|
| **12.1** | [**Delete GMR adh=0** (12)](#t1) [mockup](#ecran-t1) | MDI | 505x254 | Traitement |
| 12.1.1 | [GM 14 (12.1)](#t2) | MDI | - | |
| 12.1.2 | [GM 9 (12.2)](#t3) | MDI | - | |
...
Main -> ... -> [Purge Batch (IDE 18)](PUG-IDE-18.md) -> **Delete GMR adh=0 (IDE 12)**

Main -> ... -> [Purge - NU - (IDE 24)](PUG-IDE-24.md) -> **Delete GMR adh=0 (IDE 12)**

Main -> ... -> [Purge Batch Save (IDE 25)](PUG-IDE-25.md) -> **Delete GMR adh=0 (IDE 12)**

```mermaid
graph LR
    T12[12 Delete GMR adh=0]
