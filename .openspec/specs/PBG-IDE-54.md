# PBG IDE 54 - Browse - LOGEMENT Codes
...
| Projet | PBG |
| IDE Position | 54 |
| Nom Programme | Browse - LOGEMENT Codes |
...
#### <a id="t1"></a>54 - Browse - LOGEMENT Codes [[ECRAN]](#ecran-t1)

**Role** : Traitement : Browse - LOGEMENT Codes.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 54 | 54 | Browse - LOGEMENT Codes | MDI | 780 | 160 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>54 - Browse - LOGEMENT Codes
**Tache** : [54](#t1) | **Type** : MDI | **Dimensions** : 780 x 160 DLU
**Bloc** : Traitement | **Titre IDE** : Browse - LOGEMENT Codes
    ...
    "controls":  [
                     {
                         ...
                         "cols":  [
                                      ...
                                      {
                                          "title":  "CLO Lieu Sejour",
                                          "layer":  2,
                                          "w":  74
                                      },
                                      {
                                          "title":  "CLO Code Logement",
                                          "layer":  3,
                                          "w":  91
                                      },
                                      {
                                          "title":  "CLO Libelle Logement",
                                          "layer":  4,
                                          "w":  128
                                      }
                                  ],
...
| 233,21 | (sans nom) | - | edit |

</details>

## 9. NAVIGATION

Ecran unique: **Browse - LOGEMENT Codes**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **54.1** | [**Browse - LOGEMENT Codes** (54)](#t1) [mockup](#ecran-t1) | MDI | 780x160 | Traitement |
...
Main -> ... -> [Browse - IMPORT Historique Cha (IDE 27)](PBG-IDE-27.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Mod (IDE 28)](PBG-IDE-28.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Recup N°Chambr (IDE 29)](PBG-IDE-29.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Historique Cha (IDE 30)](PBG-IDE-30.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT MOD GM (IDE 31)](PBG-IDE-31.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Avertiss. MOD (IDE 32)](PBG-IDE-32.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Avertiss. AN/V (IDE 33)](PBG-IDE-33.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Commentai IMO (IDE 34)](PBG-IDE-34.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Troncon   IMT (IDE 35)](PBG-IDE-35.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Reprise   IMR (IDE 36)](PBG-IDE-36.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Avertiss. IMA (IDE 37)](PBG-IDE-37.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT PrestationIMP (IDE 38)](PBG-IDE-38.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Circuit   IMC (IDE 39)](PBG-IDE-39.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Logement  IML (IDE 40)](PBG-IDE-40.md) -> **Browse - LOGEMENT Codes (IDE 54)**

Main -> ... -> [Browse - IMPORT Identite  IMI (IDE 41)](PBG-IDE-41.md) -> **Browse - LOGEMENT Codes (IDE 54)**

```mermaid
graph LR
    T54[54 Browse - LOGEMENT C...]
