# PVE IDE 15 - Change Gift Pass

> **Analyse**: Phases 1-4 2026-02-03 01:02 -> 01:03 (40s) | Assemblage 01:03
...
| Projet | PVE |
| IDE Position | 15 |
| Nom Programme | Change Gift Pass |
...
**Change Gift Pass** assure la gestion complete de ce processus, accessible depuis [Global Items (IDE 6)](PVE-IDE-6.md).
...
#### <a id="t1"></a>15 - Change Gift Pass [[ECRAN]](#ecran-t1)

**Role** : Calcul fidelite/avantage : Change Gift Pass.
**Ecran** : 786 x 130 DLU (MDI) | [Voir mockup](#ecran-t1)
**Variables liees** : C (Gift Pass)

---

#### <a id="t2"></a>15.1 - Update Products
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 15 | 15 | Change Gift Pass | MDI | 786 | 130 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>15 - Change Gift Pass
**Tache** : [15](#t1) | **Type** : MDI | **Dimensions** : 786 x 130 DLU
**Bloc** : Traitement | **Titre IDE** : Change Gift Pass
...
Ecran unique: **Change Gift Pass**

### 9.3 Structure hierarchique (2 taches)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **15.1** | [**Change Gift Pass** (15)](#t1) [mockup](#ecran-t1) | MDI | 786x130 | Traitement |
| 15.1.1 | [Update Products (15.1)](#t2) | - | - | |
...
Main -> ... -> [Global Items (IDE 6)](PVE-IDE-6.md) -> **Change Gift Pass (IDE 15)**

```mermaid
graph LR
    T15[15 Change Gift Pass]
