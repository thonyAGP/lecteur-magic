# FIN IDE 11 - Recuperation du titre

> **Analyse**: Phases 1-4 2026-02-03 11:20 -> 11:21 (14s) | Assemblage 11:21
...
**Recuperation du titre** assure la gestion complete de ce processus, accessible depuis [CF Fin de saison (IDE 6)](FIN-IDE-6.md).
...
#### <a id="t1"></a>11 - Recuperation du titre
...
|----------|-------|------|------------|------|
| **11.1** | [**Recuperation du titre** (11)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [CF Fin de saison (IDE 6)](FIN-IDE-6.md) -> **Recuperation du titre (IDE 11)**

```mermaid
graph LR
    T11[11 Recuperation du titre]
