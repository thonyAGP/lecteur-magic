# REF IDE 365 - Browse - pv_comptable
...
| Projet | REF |
| IDE Position | 365 |
| Nom Programme | Browse - pv_comptable |
...
**Browse - pv_comptable** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>365 - Browse - pv_comptable

**Role** : Traitement : Browse - pv_comptable.
...
|----------|-------|------|------------|------|
| **365.1** | [**Browse - pv_comptable** (365)](#t1) | - | - | Calcul |
