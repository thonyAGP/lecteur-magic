# PBG IDE 160 - Alimentation Combos BASE OCC

> **Analyse**: Phases 1-4 2026-02-03 09:49 -> 09:50 (22s) | Assemblage 09:50
...
| Projet | PBG |
| IDE Position | 160 |
| Nom Programme | Alimentation Combos BASE OCC |
...
**Alimentation Combos BASE OCC** assure la gestion complete de ce processus, accessible depuis [Execution des màj combo (IDE 141)](PBG-IDE-141.md).
...
#### <a id="t1"></a>160 - Êcran [[ECRAN]](#ecran-t1)

**Role** : Traitement : Êcran.
**Ecran** : 573 x 95 DLU (MDI) | [Voir mockup](#ecran-t1)
...
|----------|-------|------|------------|------|
| **160.1** | [**Êcran** (160)](#t1) [mockup](#ecran-t1) | MDI | 573x95 | Traitement |
...
Main -> ... -> [Execution des màj combo (IDE 141)](PBG-IDE-141.md) -> **Alimentation Combos BASE OCC (IDE 160)**

```mermaid
graph LR
    T160[160 Alimentation Combo...]
