# PBS IDE 51 - Alimentation Combos PARIS 1

> **Analyse**: Phases 1-4 2026-02-03 17:18 -> 17:18 (18s) | Assemblage 17:18
...
**Alimentation Combos PARIS 1** assure la gestion complete de ce processus, accessible depuis [Initialisation (IDE 48)](PBS-IDE-48.md).
...
#### <a id="t1"></a>51 - Êcran [[ECRAN]](#ecran-t1)
...
|----------|-------|------|------------|------|
| **51.1** | [**Êcran** (51)](#t1) [mockup](#ecran-t1) | MDI | 573x251 | Traitement |
...
Main -> ... -> [Initialisation (IDE 48)](PBS-IDE-48.md) -> **Alimentation Combos PARIS 1 (IDE 51)**

```mermaid
graph LR
    T51[51 Alimentation Combos...]
...
|-----|---------------|-----------|
| [48](PBS-IDE-48.md) | Initialisation | 7 |
