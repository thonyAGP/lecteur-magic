# REF IDE 20 - Browse - comptes_cash_spc_
...
| Projet | REF |
| IDE Position | 20 |
| Nom Programme | Browse - comptes_cash_spc_ |
...
**Browse - comptes_cash_spc_** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>20 - Browse - comptes_speciaux_spc_

**Role** : Traitement : Browse - comptes_speciaux_spc_.
...
|----------|-------|------|------------|------|
| **20.1** | [**Browse - comptes_speciaux_spc_** (20)](#t1) | - | - | Calcul |
