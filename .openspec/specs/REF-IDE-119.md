# REF IDE 119 - Browse - code_circuit
...
| Projet | REF |
| IDE Position | 119 |
| Nom Programme | Browse - code_circuit |
...
**Browse - code_circuit** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>119 - Browse - code_circuit

**Role** : Traitement : Browse - code_circuit.
...
|----------|-------|------|------------|------|
| **119.1** | [**Browse - code_circuit** (119)](#t1) | - | - | Traitement |
