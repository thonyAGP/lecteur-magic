# REF IDE 107 - Browse - tables_village
...
| Projet | REF |
| IDE Position | 107 |
| Nom Programme | Browse - tables_village |
...
**Browse - tables_village** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>107 - Browse - tables_village

**Role** : Traitement : Browse - tables_village.
...
|----------|-------|------|------------|------|
| **107.1** | [**Browse - tables_village** (107)](#t1) | - | - | Traitement |
