# WEL IDE 47 - Valider reservation
...
| Projet | WEL |
| IDE Position | 47 |
| Nom Programme | Valider reservation |
...
**Valider reservation** assure la gestion complete de ce processus.
...
- **47** - Valider reservation
- **47.1** - Verification logement
- **47.2** - Verification logement

#### Phase 2 : Traitement (1 tache)

- **47.3** - Attribution N° blocage

#### Phase 3 : Consultation (1 tache)

- **47.3.1** - Recherche n° blocage

#### Phase 4 : Creation (1 tache)

- **47.4** - Creation blocage
...
#### <a id="t1"></a>47 - Valider reservation

**Role** : Verification : Valider reservation.

---

#### <a id="t2"></a>47.1 - Verification logement

**Role** : Verification : Verification logement.

---

#### <a id="t3"></a>47.2 - Verification logement
...
#### <a id="t4"></a>47.3 - Attribution N° blocage
...
#### <a id="t5"></a>47.3.1 - Recherche n° blocage
...
#### <a id="t6"></a>47.4 - Creation blocage
...
|----------|-------|------|------------|------|
| **47.1** | [**Valider reservation** (47)](#t1) | - | - | Validation |
| 47.1.1 | [Verification logement (47.1)](#t2) | - | - | |
| 47.1.2 | [Verification logement (47.2)](#t3) | - | - | |
| **47.2** | [**Attribution N° blocage** (47.3)](#t4) | - | - | Traitement |
| **47.3** | [**Recherche n° blocage** (47.3.1)](#t5) | - | - | Consultation |
| **47.4** | [**Creation blocage** (47.4)](#t6) | - | - | Creation |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 6 | `MlsTrans('Booking Room')&' '&Trim(VG11)&' '&':'&' '&Trim(V0.Commentaire [D])` | - |
