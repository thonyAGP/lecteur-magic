# Import IDE 13 - Import - address_data_catching
...
| Projet | Import |
| IDE Position | 13 |
| Nom Programme | Import - address_data_catching |
...
**Import - address_data_catching** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>13 - Import - address_data_catching

**Role** : Traitement : Import - address_data_catching.
...
|----------|-------|------|------------|------|
| **13.1** | [**Import - address_data_catching** (13)](#t1) | - | - | Traitement |
