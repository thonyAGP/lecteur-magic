# PBG IDE 48 - Browse - Groupe Arr/Dep.  VOL
...
| Projet | PBG |
| IDE Position | 48 |
| Nom Programme | Browse - Groupe Arr/Dep.  VOL |
...
#### <a id="t1"></a>48 - Browse - Groupe Arr/Dep.  VOL [[ECRAN]](#ecran-t1)

**Role** : Selection par l'operateur : Browse - Groupe Arr/Dep.  VOL.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 48 | 48 | Browse - Groupe Arr/Dep.  VOL | MDI | 780 | 160 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>48 - Browse - Groupe Arr/Dep.  VOL
**Tache** : [48](#t1) | **Type** : MDI | **Dimensions** : 780 x 160 DLU
**Bloc** : Traitement | **Titre IDE** : Browse - Groupe Arr/Dep.  VOL
...
| 8,21 | (sans nom) | - | edit |
| 68,21 | (sans nom) | - | edit |
| 145,21 | (sans nom) | - | edit |
| 215,21 | (sans nom) | - | edit |
| 269,21 | (sans nom) | - | edit |
| 335,21 | (sans nom) | - | edit |
| 401,21 | (sans nom) | - | edit |
| 451,21 | (sans nom) | - | edit |

</details>

## 9. NAVIGATION

Ecran unique: **Browse - Groupe Arr/Dep.  VOL**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **48.1** | [**Browse - Groupe Arr/Dep.  VOL** (48)](#t1) [mockup](#ecran-t1) | MDI | 780x160 | Traitement |
...
Main -> ... -> [Browse - IMPORT Historique Cha (IDE 27)](PBG-IDE-27.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Mod (IDE 28)](PBG-IDE-28.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Recup N°Chambr (IDE 29)](PBG-IDE-29.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Historique Cha (IDE 30)](PBG-IDE-30.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT MOD GM (IDE 31)](PBG-IDE-31.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Avertiss. MOD (IDE 32)](PBG-IDE-32.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Avertiss. AN/V (IDE 33)](PBG-IDE-33.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Commentai IMO (IDE 34)](PBG-IDE-34.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Troncon   IMT (IDE 35)](PBG-IDE-35.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Reprise   IMR (IDE 36)](PBG-IDE-36.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Avertiss. IMA (IDE 37)](PBG-IDE-37.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT PrestationIMP (IDE 38)](PBG-IDE-38.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Circuit   IMC (IDE 39)](PBG-IDE-39.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Logement  IML (IDE 40)](PBG-IDE-40.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

Main -> ... -> [Browse - IMPORT Identite  IMI (IDE 41)](PBG-IDE-41.md) -> **Browse - Groupe Arr/Dep.  VOL (IDE 48)**

```mermaid
graph LR
    T48[48 Browse - Groupe Arr...]
