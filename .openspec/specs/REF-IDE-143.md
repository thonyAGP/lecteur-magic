# REF IDE 143 - Browse - nb_code__poste
...
| Projet | REF |
| IDE Position | 143 |
| Nom Programme | Browse - nb_code__poste |
...
**Browse - nb_code__poste** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>143 - Browse - nb_code__poste

**Role** : Traitement : Browse - nb_code__poste.
...
|----------|-------|------|------------|------|
| **143.1** | [**Browse - nb_code__poste** (143)](#t1) | - | - | Traitement |
