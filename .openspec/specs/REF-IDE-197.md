# REF IDE 197 - Browse - comptes_charge_centra
...
| Projet | REF |
| IDE Position | 197 |
| Nom Programme | Browse - comptes_charge_centra |
...
**Browse - comptes_charge_centra** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>197 - Browse - comptes_charge_centra

**Role** : Traitement : Browse - comptes_charge_centra.
...
|----------|-------|------|------------|------|
| **197.1** | [**Browse - comptes_charge_centra** (197)](#t1) | - | - | Calcul |
