# REF IDE 358 - Browse - pms_print_param
...
| Projet | REF |
| IDE Position | 358 |
| Nom Programme | Browse - pms_print_param |
...
**Browse - pms_print_param** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>358 - Browse - pms_print_param

**Role** : Generation du document : Browse - pms_print_param.
...
|----------|-------|------|------------|------|
| **358.1** | [**Browse - pms_print_param** (358)](#t1) | - | - | Impression |
