# PVE IDE 405 - Select Product==V4

> **Analyse**: Phases 1-4 2026-02-03 19:58 -> 19:58 (10s) | Assemblage 19:58
...
**Donnees modifiees** : 4 tables en ecriture (pv_customer_temp, pv_cust_rentals, pv_sellers, Table_1539).
...
- **405** - Select Product **[[ECRAN]](#ecran-t1)**

#### Phase 2 : Traitement (3 taches)

- **405.1** - Sub Category **[[ECRAN]](#ecran-t2)**
- **405.1.1** - Product **[[ECRAN]](#ecran-t3)**
- **405.3** - SetBookingID
...
- **405.1.1.1** - Ticket **[[ECRAN]](#ecran-t4)**
- **405.1.1.1.1** - Vidage Ticket
- **405.2** - Vidage Ticket
...
#### <a id="t1"></a>405 - Select Product [[ECRAN]](#ecran-t1)

**Role** : Traitement : Select Product.
**Ecran** : 1414 x 308 DLU (Type6) | [Voir mockup](#ecran-t1)
**Variables liees** : X (v.ProductIdBooker)
...
#### <a id="t2"></a>405.1 - Sub Category [[ECRAN]](#ecran-t2)
...
#### <a id="t3"></a>405.1.1 - Product [[ECRAN]](#ecran-t3)
...
#### <a id="t4"></a>405.1.1.1 - Ticket [[ECRAN]](#ecran-t4)

**Role** : Generation du document : Ticket.
**Ecran** : 170 x 294 DLU | [Voir mockup](#ecran-t4)
**Variables liees** : L (v.TotalTicket)

---

#### <a id="t5"></a>405.1.1.1.1 - Vidage Ticket
...
#### <a id="rm-RM-001"></a>[RM-001] Valeur par defaut si Trim(v.Qté [G]) est vide

| Element | Detail |
|---------|--------|
| **Condition** | `Trim(v.Qté [G])=''` |
| **Si vrai** | '01' |
| **Si faux** | v.Qté [G]) |
| **Variables** | G (v.Qté) |
| **Expression source** | Expression 1 : `IF(Trim(v.Qté [G])='','01',v.Qté [G])` |
| **Exemple** | Si Trim(v.Qté [G])='' â†’ '01'. Sinon â†’ v.Qté [G]) |

## 6. CONTEXTE

- **Appele par**: (aucun)
- **Appelle**: 5 programmes | **Tables**: 7 (W:4 R:1 L:3) | **Taches**: 7 | **Expressions**: 43
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 405 | 405 | Select Product | Type6 | 1414 | 308 | Consultation |
| 2 | 405.1 | 405.1 | Sub Category | Type0 | 444 | 218 | Traitement |
| 3 | 405.1.1 | 405.1.1 | Product | Type0 | 611 | 216 | Traitement |
| 4 | 405.1.1.1 | 405.1.1.1 | Ticket | Type0 | 170 | 294 | Impression |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>405 - Select Product
**Tache** : [405](#t1) | **Type** : Type6 | **Dimensions** : 1414 x 308 DLU
...
#### <a id="ecran-t2"></a>405.1 - Sub Category
**Tache** : [405.1](#t2) | **Type** : Type0 | **Dimensions** : 444 x 218 DLU
...
#### <a id="ecran-t3"></a>405.1.1 - Product
**Tache** : [405.1.1](#t3) | **Type** : Type0 | **Dimensions** : 611 x 216 DLU
...
#### <a id="ecran-t4"></a>405.1.1.1 - Ticket
**Tache** : [405.1.1.1](#t4) | **Type** : Type0 | **Dimensions** : 170 x 294 DLU
...
flowchart TD
    ...
    VF1[405 Select Product]
    style VF1 fill:#58a6ff
    VF2[405.1 Sub Category]
    style VF2 fill:#58a6ff
    VF3[405.1.1 Product]
    style VF3 fill:#58a6ff
    VF4[405.1.1.1 Ticket]
...
|----------|-------|------|------------|------|
| **405.1** | [**Select Product** (405)](#t1) [mockup](#ecran-t1) | Type6 | 1414x308 | Consultation |
| **405.2** | [**Sub Category** (405.1)](#t2) [mockup](#ecran-t2) | - | 444x218 | Traitement |
| 405.2.1 | [Product (405.1.1)](#t3) [mockup](#ecran-t3) | - | 611x216 | |
| 405.2.2 | [SetBookingID (405.3)](#t7) | - | - | |
| **405.3** | [**Ticket** (405.1.1.1)](#t4) [mockup](#ecran-t4) | - | 170x294 | Impression |
| 405.3.1 | [Vidage Ticket (405.1.1.1.1)](#t5) | - | - | |
| 405.3.2 | [Vidage Ticket (405.2)](#t6) | - | - | |
...
| F | v.Stock | W | Numeric |
| G | v.Qté | W | Alpha |
| H | V.Désigantion | W | Alpha |
| I | v.Fin | W | Logical |
| J | v.StopDelete | W | Logical |
| K | RetourQuestion | W | Numeric |
| L | v.TotalTicket | W | Numeric |
| M | v.PrixSaisie | W | Alpha |
| N | v.PrixZero | W | Logical |
| O | v.Cat | W | Numeric |
| P | v.Sub_Cat | W | Numeric |
| Q | v.Prod_ID | W | Numeric |
| R | T S/Catégorie | W | Logical |
| S | v.TotalAValider | W | Numeric |
| T | v.NbrProdWithoutBooking | W | Numeric |
| U | v.BookingID | W | Unicode |
| V | v.OrderID | W | Numeric |
| W | v.PackageID | W | Numeric |
| X | v.ProductIdBooker | W | Numeric |
| Y | v.BtnQuitSearchClicked | W | Logical |
...
|--------|-----|------|-----------|
| F | v.Stock | Numeric | - |
| G | v.Qté | Alpha | 14x session |
| H | V.Désigantion | Alpha | - |
| I | v.Fin | Logical | 1x session |
| J | v.StopDelete | Logical | - |
| L | v.TotalTicket | Numeric | 2x session |
| M | v.PrixSaisie | Alpha | 12x session |
| N | v.PrixZero | Logical | 2x session |
| O | v.Cat | Numeric | - |
| P | v.Sub_Cat | Numeric | - |
| Q | v.Prod_ID | Numeric | - |
| S | v.TotalAValider | Numeric | - |
| T | v.NbrProdWithoutBooking | Numeric | - |
| U | v.BookingID | Unicode | - |
| V | v.OrderID | Numeric | 1x session |
| W | v.PackageID | Numeric | - |
| X | v.ProductIdBooker | Numeric | - |
| Y | v.BtnQuitSearchClicked | Logical | - |
...
| Lettre | Nom | Type | Usage dans |
|--------|-----|------|-----------|
| K | RetourQuestion | Numeric | 1x refs |
| R | T S/Catégorie | Logical | 1x refs |
...
| V. | **F** | v.Stock | Numeric |
| V. | **G** | v.Qté | Alpha |
| V. | **H** | V.Désigantion | Alpha |
| V. | **I** | v.Fin | Logical |
| V. | **J** | v.StopDelete | Logical |
| V. | **L** | v.TotalTicket | Numeric |
| V. | **M** | v.PrixSaisie | Alpha |
| V. | **N** | v.PrixZero | Logical |
| V. | **O** | v.Cat | Numeric |
| V. | **P** | v.Sub_Cat | Numeric |
| V. | **Q** | v.Prod_ID | Numeric |
| V. | **S** | v.TotalAValider | Numeric |
| V. | **T** | v.NbrProdWithoutBooking | Numeric |
| V. | **U** | v.BookingID | Unicode |
| V. | **V** | v.OrderID | Numeric |
| V. | **W** | v.PackageID | Numeric |
| V. | **X** | v.ProductIdBooker | Numeric |
| V. | **Y** | v.BtnQuitSearchClicked | Logical |
| Autre | **K** | RetourQuestion | Numeric |
| Autre | **R** | T S/Catégorie | Logical |
...
|------|-----|------------|-------|
| CONDITION | 1 | `IF(Trim(v.Qté [G])='','01',v.Qté [G])` | [RM-001](#rm-RM-001) |
| CONDITION | 41 | `RetourQuestion [K]=6` | - |
| CONDITION | 2 | `Trim(v.Qté [G])='01'` | - |
| CONDITION | 9 | `v.TotalTicket [L]>0` | - |
| CONDITION | 10 | `v.TotalTicket [L]=0` | - |
...
| CAST_LOGIQUE | 3 | `v.Fin [I]='TRUE'LOG` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| NEGATION | 5 | `NOT v.PrixZero [N]` | - |

#### OTHER (4 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 11 | `v.OrderID [V]` | - |
| OTHER | 12 | `GetParam ('SERVICE')` | - |
| OTHER | 6 | `v.PrixZero [N]` | - |
| OTHER | 7 | `T S/Catégorie [R]` | - |

#### FORMAT (1 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| FORMAT | 43 | `'p.V.valid_all [C]'FORM` | - |

#### STRING (3 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| STRING | 40 | `Del (v.PrixSaisie [M],Len (Trim(v.PrixSaisie [M])),1)` | - |
| STRING | 39 | `Del (v.Qté [G],Len (Trim(v.Qté [G])),1)` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 30 | `Trim(v.Qté [G])&'7'` | - |
| CONCATENATION | 31 | `Trim(v.PrixSaisie [M])&'7'` | - |
| CONCATENATION | 29 | `Trim(v.PrixSaisie [M])&'6'` | - |
| CONCATENATION | 27 | `Trim(v.PrixSaisie [M])&'5'` | - |
| CONCATENATION | 28 | `Trim(v.Qté [G])&'6'` | - |
| ... | | *+17 autres* | |
...
|-----|-------------------|
| 1 | `IF(Trim(v.Qté [G])='','01',v.Qté [G])` |
| 9 | `v.TotalTicket [L]>0` |
| 10 | `v.TotalTicket [L]=0` |
| 41 | `RetourQuestion [K]=6` |
| 2 | `Trim(v.Qté [G])='01'` |
...
| 39 | `Del (v.Qté [G],Len (Trim(v.Qté [G])),1)` |
| 40 | `Del (v.PrixSaisie [M],Len (Trim(v.PrixSaisie [M])),1)` |
...
|-----|-------------------|
| 16 | `Trim(v.Qté [G])&'0'` |
| 17 | `Trim(v.PrixSaisie [M])&'0'` |
| 18 | `Trim(v.Qté [G])&'1'` |
| 19 | `Trim(v.PrixSaisie [M])&'1'` |
| 20 | `Trim(v.Qté [G])&'2'` |
| 21 | `Trim(v.PrixSaisie [M])&'2'` |
| 22 | `Trim(v.Qté [G])&'3'` |
| 23 | `Trim(v.PrixSaisie [M])&'3'` |
| 24 | `Trim(v.Qté [G])&'4'` |
| 25 | `Trim(v.PrixSaisie [M])&'4'` |
| 26 | `Trim(v.Qté [G])&'5'` |
| 27 | `Trim(v.PrixSaisie [M])&'5'` |
| 28 | `Trim(v.Qté [G])&'6'` |
| 29 | `Trim(v.PrixSaisie [M])&'6'` |
| 30 | `Trim(v.Qté [G])&'7'` |
| 31 | `Trim(v.PrixSaisie [M])&'7'` |
| 32 | `Trim(v.Qté [G])&'8'` |
| 33 | `Trim(v.PrixSaisie [M])&'8'` |
| 34 | `Trim(v.Qté [G])&'9'` |
| 35 | `Trim(v.PrixSaisie [M])&'9'` |
| 36 | `Trim(v.Qté [G])&'.'` |
| 37 | `Trim(v.PrixSaisie [M])&'.'` |
...
| Code desactive | 1.1% (3 / 273) | Code sain |
