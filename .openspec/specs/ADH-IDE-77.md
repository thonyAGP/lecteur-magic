...
| Ref | Nom | Type | Role |
|-----|-----|------|------|
| `{0,-91}` | V.TAI Obligatoire | ALPHA | - |
| `{0,-90}` | V.Nom complet | ALPHA | - |
| `{0,-89}` | V.Prenom complet | ALPHA | - |
| `{0,-88}` | v.Club Med Pass ID | ALPHA | - |
| `{0,-74}` | V.ID Club Med Pass scannee | ALPHA | - |
| `{0,-77}` | V.Status card | ALPHA | - |
| `{0,-76}` | V.Other card valid | LOGICAL | - |
| `{0,-75}` | V.Date de naissance | DATE | - |
| `{0,-87}` | v.delete confirmation | NUMERIC | - |
| `{0,-86}` | v.ez detail empty | LOGICAL | - |
| `{0,-85}` | v.ok to create | LOGICAL | - |
| `{0,-84}` | V.Action | ALPHA | - |
| `{0,-114}` | V.Choix action | ALPHA | - |
| `{0,-82}` | V.Age mineur | NUMERIC | - |
| `{0,-81}` | v.Activation Bar Limit | ALPHA | - |
| `{0,-79}` | v.Age Bar Limit | NUMERIC | - |
| `{0,-78}` | v.ActionPActive | LOGICAL | - |
| `{0,-73}` | V.Compte scanne | NUMERIC | - |
| `{0,-80}` | V.Compte special | LOGICAL | - |
