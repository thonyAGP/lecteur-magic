# PVE IDE 16 - Change AGEC

> **Analyse**: Phases 1-4 2026-02-03 01:03 -> 01:04 (39s) | Assemblage 01:04
...
**Change AGEC** assure la gestion complete de ce processus, accessible depuis [Global Items (IDE 6)](PVE-IDE-6.md).
...
#### <a id="t1"></a>16 - Change AGEC [[ECRAN]](#ecran-t1)

**Role** : Traitement : Change AGEC.
**Ecran** : 790 x 130 DLU (MDI) | [Voir mockup](#ecran-t1)

---

#### <a id="t2"></a>16.1 - Update Products
...
- **Appelle**: 2 programmes | **Tables**: 3 (W:1 R:1 L:1) | **Taches**: 2 | **Expressions**: 5
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 16 | 16 | Change AGEC | MDI | 790 | 130 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>16 - Change AGEC
**Tache** : [16](#t1) | **Type** : MDI | **Dimensions** : 790 x 130 DLU
**Bloc** : Traitement | **Titre IDE** : Change AGEC
...
| Change | 624,102 | Modifie l'element |
| Raz | 218,102 | Bouton fonctionnel |

</details>

## 9. NAVIGATION

Ecran unique: **Change AGEC**

### 9.3 Structure hierarchique (2 taches)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **16.1** | [**Change AGEC** (16)](#t1) [mockup](#ecran-t1) | MDI | 790x130 | Traitement |
| 16.1.1 | [Update Products (16.1)](#t2) | - | - | |
...
| C | V.Force Edition Reçu | R | Logical |
| D | V.Nature | R | Unicode |
| E | B Raz | R | Alpha |
...
| Lettre | Nom | Type | Usage dans |
|--------|-----|------|-----------|
| C | V.Force Edition Reçu | Logical | - |
| D | V.Nature | Unicode | - |
...
Main -> ... -> [Global Items (IDE 6)](PVE-IDE-6.md) -> **Change AGEC (IDE 16)**
