...
| `{0,-100}` | W0 existe objet | LOGICAL | - |
| `{0,-99}` | W0 existe devise | LOGICAL | - |
| `{0,-98}` | W0 existe scelle | LOGICAL | - |
| `{0,-96}` | W0 Nom | ALPHA | - |
| `{0,-95}` | W0 Prénom | ALPHA | - |
| `{0,-94}` | W0 Titre | ALPHA | - |
| `{0,-93}` | W0 Num Adherent | NUMERIC | - |
| `{0,-92}` | W0 Lettre Controle | ALPHA | - |
| `{0,-91}` | W0 Filiation Club | NUMERIC | - |
| `{0,-90}` | W0 Langue Parlée | ALPHA | - |
| `{0,-89}` | W0 Chambre | ALPHA | - |
