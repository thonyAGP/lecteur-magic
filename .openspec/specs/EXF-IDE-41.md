# EXF IDE 41 - Zoom Adherents VSP

> **Analyse**: Phases 1-4 2026-02-03 11:08 -> 11:08 (15s) | Assemblage 11:08
...
**Zoom Adherents VSP** assure la gestion complete de ce processus, accessible depuis [Ventes Excursions (IDE 35)](EXF-IDE-35.md).
...
#### <a id="t1"></a>41 - Recherche Adherents [[ECRAN]](#ecran-t1)

**Role** : Traitement : Recherche Adherents.
**Ecran** : 717 x 158 DLU (MDI) | [Voir mockup](#ecran-t1)
...
#### <a id="rm-RM-001"></a>[RM-001] Si [H]='GO' alors 174 sinon IF ([Q],[Y],148))
...
| **Si vrai** | 174 |
| **Si faux** | IF ([Q],[Y],148)) |
| **Expression source** | Expression 11 : `IF ([H]='GO',174,IF ([Q],[Y],148))` |
| **Exemple** | Si [H]='GO' â†’ 174. Sinon â†’ IF ([Q],[Y],148)) |
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 41 | 41 | Recherche Adherents | MDI | 717 | 158 | Consultation |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>41 - Recherche Adherents
**Tache** : [41](#t1) | **Type** : MDI | **Dimensions** : 717 x 158 DLU
...
|-----------|-----|----------|------|
| 35,20 | (sans nom) | - | edit |
| 405,20 | (sans nom) | - | edit |
| 571,20 | (sans nom) | - | edit |
| 29,102 | (sans nom) | - | edit |
| 68,102 | (sans nom) | - | edit |
...
|----------|-------|------|------------|------|
| **41.1** | [**Recherche Adherents** (41)](#t1) [mockup](#ecran-t1) | MDI | 717x158 | Consultation |
...
|------|-----|------------|-------|
| CONDITION | 11 | `IF ([H]='GO',174,IF ([Q],[Y],148))` | [RM-001](#rm-RM-001) |
...
Main -> ... -> [Ventes Excursions (IDE 35)](EXF-IDE-35.md) -> **Zoom Adherents VSP (IDE 41)**

```mermaid
graph LR
    T41[41 Zoom Adherents VSP]
