...
> **Analyse**: 2026-02-03 19:36
> **Pipeline**: V7.2 Enrichi

## RESUME EXECUTIF

- **Fonction**: Seller - select
- **Tables modifiees**: 0
- **Complexite**: **BASSE** (0/100)
- **Statut**: NON_ORPHELIN
- **Raison**: Appele par 20 programme(s): Main Sale ===V4 (IDE 0), Main Sale (IDE 186), Main Sale-664 (IDE 187), Generate Preview Payments (IDE 189), Main Sale Sale Bar Code (IDE 214), Main Sale ===V4 bck (IDE 352), Main Sale ===V4 (IDE 354), Generate Preview OD==V4 (IDE 357), Main Sale ===V4 (IDE 359), Main Sale (IDE 363), Main Sale-664 (IDE 364), Menu Main (TPE) (IDE 403), Main Sale ===V4 (IDE 409), Main Sale ===V4 (IDE 415), Main Sale ===V4 Booking ACTUEL (IDE 417), Generate Preview OD==LEX Book (IDE 418), Generate Preview OD==V4 (IDE 423), Generate Preview OD==LEX (IDE 424), Generate Preview Payments 1212 (IDE 434), Generate Preview Payments 1112 (IDE 435)
