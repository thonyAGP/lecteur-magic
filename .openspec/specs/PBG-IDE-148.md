# PBG IDE 148 - Alimentation Combos VIP
...
| Projet | PBG |
| IDE Position | 148 |
| Nom Programme | Alimentation Combos VIP |
...
**Alimentation Combos VIP** assure la gestion complete de ce processus, accessible depuis [Execution des màj combo (IDE 141)](PBG-IDE-141.md).
...
#### <a id="t1"></a>148 - Êcran [[ECRAN]](#ecran-t1)
...
|----------|-------|------|------------|------|
| **148.1** | [**Êcran** (148)](#t1) [mockup](#ecran-t1) | MDI | 573x251 | Traitement |
...
| CONDITION | 9 | `SetParam (> Nom Combo [A],v.Combo [B])` | - |
| CONDITION | 2 | `> Nom Combo [A]=''` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 6 | `Trim (v.Combo [B])&','&Trim ([F])` | - |
...
Main -> ... -> [Execution des màj combo (IDE 141)](PBG-IDE-141.md) -> **Alimentation Combos VIP (IDE 148)**

```mermaid
graph LR
    T148[148 Alimentation Combo...]
