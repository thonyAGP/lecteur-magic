# PBP IDE 24 - Edit securite GM Cabin P6

> **Analyse**: Phases 1-4 2026-02-03 01:11 -> 01:12 (39s) | Assemblage 01:12
...
| Projet | PBP |
| IDE Position | 24 |
| Nom Programme | Edit securite GM Cabin P6 |
...
**Edit securite GM Cabin P6** assure la gestion complete de ce processus, accessible depuis [Centralisation nbre edition (IDE 20)](PBP-IDE-20.md).
...
#### <a id="rm-RM-001"></a>[RM-001] Si [P] alors 'H' sinon '')
...
| **Si vrai** | 'H' |
| **Si faux** | '') |
| **Expression source** | Expression 11 : `IF ([P],'H','')` |
| **Exemple** | Si [P] â†’ 'H'. Sinon â†’ '') |
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 24 | 24 | Veuillez patienter... | MDI | 426 | 58 | Traitement |
...
**Tache** : [24](#t1) | **Type** : MDI | **Dimensions** : 426 x 58 DLU
...
<!-- FORM-DATA:
{
    ...
    "controls":  [
                     ...
                     },
                     {
                         ...
                         "h":  8,
                         "color":  "",
                         "text":  "Edition Securite Passager (P6)",
                         "parent":  null
                     },
                     {
                         "x":  4,
...
|----------|-------|------|------------|------|
| **24.1** | [**Veuillez patienter...** (24)](#t1) [mockup](#ecran-t1) | MDI | 426x58 | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONDITION | 11 | `IF ([P],'H','')` | [RM-001](#rm-RM-001) |
| CONDITION | 10 | `Range (> date [A],[Q],[R]-1)` | - |
...
Main -> ... -> [Centralisation nbre edition (IDE 20)](PBP-IDE-20.md) -> **Edit securite GM Cabin P6 (IDE 24)**

```mermaid
graph LR
    T24[24 Edit securite GM Ca...]
