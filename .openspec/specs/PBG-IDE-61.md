...
| Projet | PBG |
| IDE Position | 61 |
| Nom Programme | Browse - VOYAGES          VOY |
...
#### <a id="t1"></a>61 - Browse - VOYAGES          VOY [[ECRAN]](#ecran-t1)

**Role** : Traitement : Browse - VOYAGES          VOY.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 61 | 61 | Browse - VOYAGES          VOY | MDI | 780 | 160 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>61 - Browse - VOYAGES          VOY
**Tache** : [61](#t1) | **Type** : MDI | **Dimensions** : 780 x 160 DLU
**Bloc** : Traitement | **Titre IDE** : Browse - VOYAGES          VOY
    ...
    "controls":  [
                     {
                         ...
                         "cols":  [
                                      ...
                                      {
                                          "title":  "VOY Date Aeroport",
                                          "layer":  9,
                                          "w":  85
                                      },
                                      {
                                          "title":  "VOY Heure Aeroport",
                                          "layer":  10,
                                          "w":  93
                                      }
                                  ],
...
| 190,21 | (sans nom) | - | edit |
| 248,21 | (sans nom) | - | edit |
| 329,21 | (sans nom) | - | edit |
| 395,21 | (sans nom) | - | edit |
| 478,21 | (sans nom) | - | edit |
| 546,21 | (sans nom) | - | edit |
| 631,21 | (sans nom) | - | edit |

</details>

## 9. NAVIGATION

Ecran unique: **Browse - VOYAGES          VOY**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **61.1** | [**Browse - VOYAGES          VOY** (61)](#t1) [mockup](#ecran-t1) | MDI | 780x160 | Traitement |
...
Main -> ... -> [Browse - IMPORT Historique Cha (IDE 27)](PBG-IDE-27.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Mod (IDE 28)](PBG-IDE-28.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Recup N°Chambr (IDE 29)](PBG-IDE-29.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Historique Cha (IDE 30)](PBG-IDE-30.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT MOD GM (IDE 31)](PBG-IDE-31.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Avertiss. MOD (IDE 32)](PBG-IDE-32.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Avertiss. AN/V (IDE 33)](PBG-IDE-33.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Commentai IMO (IDE 34)](PBG-IDE-34.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Troncon   IMT (IDE 35)](PBG-IDE-35.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Reprise   IMR (IDE 36)](PBG-IDE-36.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Avertiss. IMA (IDE 37)](PBG-IDE-37.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT PrestationIMP (IDE 38)](PBG-IDE-38.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Circuit   IMC (IDE 39)](PBG-IDE-39.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Logement  IML (IDE 40)](PBG-IDE-40.md) -> **Browse - VOYAGES          VOY (IDE 61)**

Main -> ... -> [Browse - IMPORT Identite  IMI (IDE 41)](PBG-IDE-41.md) -> **Browse - VOYAGES          VOY (IDE 61)**

```mermaid
graph LR
    T61[61 Browse - VOYAGES VOY]
