# GES IDE 29 - SP Caractères Interdits

> **Analyse**: Phases 1-4 2026-02-03 11:33 -> 11:33 (13s) | Assemblage 11:33
...
**SP Caractères Interdits** assure la gestion complete de ce processus, accessible depuis [Comptes speciaux (IDE 48)](GES-IDE-48.md).
...
- **29** - Caractères Interdits

#### Phase 2 : Validation (1 tache)

- **29.1** - Verification Chaine
...
#### <a id="t1"></a>29 - Caractères Interdits
...
#### <a id="t2"></a>29.1 - Verification Chaine
...
|----------|-------|------|------------|------|
| **29.1** | [**Caractères Interdits** (29)](#t1) | MDI | - | Traitement |
| **29.2** | [**Verification Chaine** (29.1)](#t2) | MDI | - | Validation |
...
Main -> ... -> [Comptes speciaux (IDE 48)](GES-IDE-48.md) -> **SP Caractères Interdits (IDE 29)**

```mermaid
graph LR
    T29[29 SP Caractères Inter...]
