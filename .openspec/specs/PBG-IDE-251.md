...
**Import - MOD** assure la gestion complete de ce processus, accessible depuis [Chargement des donnees NA (IDE 249)](PBG-IDE-249.md).
...
**Donnees modifiees** : 1 tables en ecriture (erreur_od).
...
#### <a id="t1"></a>251 - Import - MOD

**Role** : Traitement : Import - MOD.
...
|----------|-------|------|------------|------|
| **251.1** | [**Import - MOD** (251)](#t1) | MDI | - | Traitement |
| **251.2** | [**CREATION** (251.1)](#t2) | MDI | - | Creation |
...
|--------|-----|------|-----------|
| A | PARAM fichier MOD | Alpha | 1x refs |
| B | dossier | Alpha | - |
| C | code | Alpha | - |
| D | date | Date | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| STRING | 3 | `Trim (PARAM fichier MOD [A])` | - |
...
Main -> ... -> [Chargement des donnees NA (IDE 249)](PBG-IDE-249.md) -> **Import - MOD (IDE 251)**
