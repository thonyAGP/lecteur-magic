# REF IDE 359 - Browse - pms_print_param_defau
...
| Projet | REF |
| IDE Position | 359 |
| Nom Programme | Browse - pms_print_param_defau |
...
**Browse - pms_print_param_defau** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>359 - Browse - pms_print_param_defau

**Role** : Generation du document : Browse - pms_print_param_defau.
...
|----------|-------|------|------------|------|
| **359.1** | [**Browse - pms_print_param_defau** (359)](#t1) | - | - | Impression |
