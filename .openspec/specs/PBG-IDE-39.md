...
| Projet | PBG |
| IDE Position | 39 |
| Nom Programme | Browse - IMPORT Circuit   IMC |
...
**Browse - IMPORT Circuit   IMC** assure la gestion complete de ce processus, accessible depuis [Dispatch (IDE 96)](PBG-IDE-96.md).

Le flux de traitement s'organise en **1 blocs fonctionnels** :

- **Traitement** (1 tache) : traitements metier divers

**Donnees modifiees** : 1 tables en ecriture (nouvelles_prestations).
...
#### <a id="t1"></a>39 - Browse - IMPORT Circuit   IMC [[ECRAN]](#ecran-t1)

**Role** : Traitement : Browse - IMPORT Circuit   IMC.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 39 | 39 | Browse - IMPORT Circuit   IMC | MDI | 780 | 208 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>39 - Browse - IMPORT Circuit   IMC
**Tache** : [39](#t1) | **Type** : MDI | **Dimensions** : 780 x 208 DLU
**Bloc** : Traitement | **Titre IDE** : Browse - IMPORT Circuit   IMC
    ...
    "controls":  [
                     {
                         ...
                         "cols":  [
                                      ...
                                      {
                                          "title":  "IMC N° Ressource",
                                          "layer":  2,
                                          "w":  80
                                      },
                                      {
                                          "title":  "IMC Date debut",
                                          "layer":  3,
                                          "w":  72
                                      },
                                      {
...
|-----------|-----|----------|------|
| 206,18 | (sans nom) | - | edit |
| 271,18 | (sans nom) | - | edit |
| 351,18 | (sans nom) | - | edit |
| 423,18 | (sans nom) | - | edit |
| 493,18 | (sans nom) | - | edit |
...
Ecran unique: **Browse - IMPORT Circuit   IMC**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **39.1** | [**Browse - IMPORT Circuit   IMC** (39)](#t1) [mockup](#ecran-t1) | MDI | 780x208 | Traitement |
...
Main -> ... -> [Dispatch (IDE 96)](PBG-IDE-96.md) -> **Browse - IMPORT Circuit   IMC (IDE 39)**

```mermaid
graph LR
    T39[39 Browse - IMPORT Cir...]
