# REF IDE 342 - Browse - lit_matrimoniaux
...
| Projet | REF |
| IDE Position | 342 |
| Nom Programme | Browse - lit_matrimoniaux |
...
**Browse - lit_matrimoniaux** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>342 - Browse - lit_matrimoniaux

**Role** : Traitement : Browse - lit_matrimoniaux.
...
|----------|-------|------|------------|------|
| **342.1** | [**Browse - lit_matrimoniaux** (342)](#t1) | - | - | Traitement |
