# REF IDE 669 - Update Suivi PDC

> **Analyse**: Phases 1-4 2026-02-03 13:32 -> 13:33 (15s) | Assemblage 13:33
...
| Projet | REF |
| IDE Position | 669 |
| Nom Programme | Update Suivi PDC |
| Fichier source | `Prg_669.xml` |
| Dossier IDE | General |
...
**Update Suivi PDC** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>669 - Update Suivi PDC
...
|----------|-------|------|------------|------|
| **669.1** | [**Update Suivi PDC** (669)](#t1) | MDI | - | Traitement |
...
```mermaid
graph LR
    T669[669 Update Suivi PDC]
    style T669 fill:#58a6ff
    NONE[Aucun caller]
    NONE -.-> T669
