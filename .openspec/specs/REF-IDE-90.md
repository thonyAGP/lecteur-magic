# REF IDE 90 - Browse - table_prestation_pre
...
| Projet | REF |
| IDE Position | 90 |
| Nom Programme | Browse - table_prestation_pre |
...
**Browse - table_prestation_pre** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>90 - Browse - table_prestation_pre

**Role** : Traitement : Browse - table_prestation_pre.
...
|----------|-------|------|------------|------|
| **90.1** | [**Browse - table_prestation_pre** (90)](#t1) | - | - | Traitement |
