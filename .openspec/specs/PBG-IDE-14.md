# PBG IDE 14 - lancement affec auto test
...
| Projet | PBG |
| IDE Position | 14 |
| Nom Programme | lancement affec auto test |
...
**lancement affec auto test** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>14 - lancement affec auto test

**Role** : Verification : lancement affec auto test.
...
|----------|-------|------|------------|------|
| **14.1** | [**lancement affec auto test** (14)](#t1) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 3 | `SetParam('CODELANGUE','FRA')` | - |
...
| Code desactive | 40% (2 / 5) | Nettoyer avant migration |
