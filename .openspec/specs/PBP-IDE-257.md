...
| Projet | PBP |
| IDE Position | 257 |
| Nom Programme | Liste des menages |
...
**Liste des menages** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>257 - Liste des menages

**Role** : Traitement : Liste des menages.
...
- **Appele par**: (aucun)
- **Appelle**: 5 programmes | **Tables**: 0 (W:0 R:0 L:0) | **Taches**: 1 | **Expressions**: 8
...
|----------|-------|------|------------|------|
| **257.1** | [**Liste des menages** (257)](#t1) | MDI | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 8 | `MlsTrans ('Liste des menages par')&' '&IF (CodeZoneSecteur [E]='Z','Zone',MlsTrans ('Secteur'))` | - |
