# PVE IDE 89 - Report - Average basket
...
| Projet | PVE |
| IDE Position | 89 |
| Nom Programme | Report - Average basket |
...
**Report - Average basket** assure la gestion complete de ce processus, accessible depuis [Menu Reports (IDE 182)](PVE-IDE-182.md).
...
- **89** - Report - Revenue before tax **[[ECRAN]](#ecran-t1)**
- **89.1.1.1** - Lines
- **89.1.1.1.1** - Total
...
#### <a id="t1"></a>89 - Report - Revenue before tax [[ECRAN]](#ecran-t1)
...
#### <a id="t2"></a>89.1 - Print

**Role** : Generation du document : Print.

---

#### <a id="t3"></a>89.1.1 - EDITION
...
|----------|-------|------|------------|------|
| **89.1** | [**Report - Revenue before tax** (89)](#t1) [mockup](#ecran-t1) | MDI | 312x57 | Traitement |
| 89.1.1 | [Lines (89.1.1.1)](#t4) | MDI | - | |
| 89.1.2 | [Total (89.1.1.1.1)](#t5) | MDI | - | |
| **89.2** | [**Print** (89.1)](#t2) | MDI | - | Impression |
| 89.2.1 | [EDITION (89.1.1)](#t3) | MDI | - | |
...
|--------|----------|-------|------|
| A | v Retour Package | R | Logical |
| B | V.Total Date amount | R | Numeric |
| C | V.Total Date Ht | R | Numeric |
| D | V.Total Date Tva | R | Numeric |
| E | V.Nb checkout | R | Numeric |
| F | V.Total General amount | R | Numeric |
| G | V.Total General HT | R | Numeric |
| H | V.Total General TVA | R | Numeric |
| I | V.Total checkout | R | Numeric |
| J | V.Montant Ht | R | Numeric |
| K | V.Montant TVA | R | Numeric |
| L | V.Taux TVA | R | Numeric |
...
|------|-----|------------|-------|
| CONDITION | 1 | `V Date maxi [G]<>'00/00/0000'DATE` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 4 | `Translate ('%club_exportdata%')&Trim (GetParam ('VILLAGECODE'))&Trim (GetParam ('SERVICE'))&'_AVERAGE_BASKET_'&DStr (Date(),'YYYYMMDD')&'_'&TStr (Time(),'HHMMSS')&'.Pdf'` | - |
...
Main -> ... -> [Menu Reports (IDE 182)](PVE-IDE-182.md) -> **Report - Average basket (IDE 89)**

```mermaid
graph LR
    T89[89 Report - Average ba...]
