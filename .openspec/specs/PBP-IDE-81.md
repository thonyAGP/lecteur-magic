# PBP IDE 81 - Deficit Artiste V3

> **Analyse**: Phases 1-4 2026-02-03 09:13 -> 09:13 (20s) | Assemblage 09:13
...
| Projet | PBP |
| IDE Position | 81 |
| Nom Programme | Deficit Artiste V3 |
...
**Deficit Artiste V3** assure la gestion complete de ce processus, accessible depuis [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md).
...
#### <a id="t2"></a>81 - GO ARTI

**Role** : Traitement : GO ARTI.

---

#### <a id="t6"></a>81.1 - Deficit GO ARTI V3

**Role** : Traitement : Deficit GO ARTI V3.
...
|----------|-------|------|------------|------|
| **81.1** | [**GO ARTI** (81)](#t2) | - | - | Traitement |
| 81.1.1 | [Deficit GO ARTI V3 (81.1)](#t6) | - | - | |
...
| C | V.Date fin | R | Date |
| D | V.Date debut premiere periode | R | Date |
| E | V.Date fin derniere periode | R | Date |
| F | V.Date debut sej | R | Date |
| G | V.Date fin sej | R | Date |
| H | V.Heure debut premiere periode | R | Alpha |
| I | V.Heure fin derniere periode | R | Alpha |
...
| I | V.Heure fin derniere periode | Alpha | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| FORMAT | 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim(P.Lieu sejour [D])&IF(P.Nom lieu [E]<>'','_'&Trim(P.Nom lieu [E])&'_','_')&'EFF_Deficit_ARTI_'&IF([K],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` | - |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 4 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim(P.Lieu sejour [D])&IF(P.Nom lieu [E]<>'','_'&Trim(P.Nom lieu [E])&'_','_')&'EFF_Deficit_ARTI_'&IF([K],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` |
...
Main -> ... -> [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md) -> **Deficit Artiste V3 (IDE 81)**

```mermaid
graph LR
    T81[81 Deficit Artiste V3]
