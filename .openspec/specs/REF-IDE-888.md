# REF IDE 888 - Extrait de compte GP
...
#### <a id="t1"></a>888 - Extrait de compte GP >> ADH [[ECRAN]](#ecran-t1)
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 888 | 888 | Extrait de compte GP >> ADH | Type0 | 1448 | 242 | Calcul |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>888 - Extrait de compte GP >> ADH
**Tache** : [888](#t1) | **Type** : Type0 | **Dimensions** : 1448 x 242 DLU
...
|----------|-------|------|------------|------|
| **888.1** | [**Extrait de compte GP >> ADH** (888)](#t1) [mockup](#ecran-t1) | - | 1448x242 | Calcul |
...
```mermaid
graph LR
    T888[888 Extrait de compte GP]
    style T888 fill:#58a6ff
    NONE[Aucun caller]
    NONE -.-> T888
