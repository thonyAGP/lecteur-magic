# REF IDE 374 - Browse - pv_discount_reasons
...
| Projet | REF |
| IDE Position | 374 |
| Nom Programme | Browse - pv_discount_reasons |
...
**Browse - pv_discount_reasons** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>374 - Browse - pv_discount_reasons

**Role** : Traitement : Browse - pv_discount_reasons.
...
|----------|-------|------|------------|------|
| **374.1** | [**Browse - pv_discount_reasons** (374)](#t1) | - | - | Traitement |
