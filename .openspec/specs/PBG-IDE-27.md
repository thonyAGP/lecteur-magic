...
#### <a id="t1"></a>27 - Browse - IMPORT Historique Cha [[ECRAN]](#ecran-t1)
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 27 | 27 | Browse - IMPORT Historique Cha | MDI | 780 | 208 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>27 - Browse - IMPORT Historique Cha
**Tache** : [27](#t1) | **Type** : MDI | **Dimensions** : 780 x 208 DLU
...
| 3,30 | (sans nom) | - | edit |
| 72,30 | (sans nom) | - | edit |
| 148,30 | (sans nom) | - | edit |
| 215,30 | (sans nom) | - | edit |
| 284,30 | (sans nom) | - | edit |
| 345,30 | (sans nom) | - | edit |
| 442,30 | (sans nom) | - | edit |
| 492,30 | (sans nom) | - | edit |
| 538,2 | (sans nom) | - | edit |
...
|----------|-------|------|------------|------|
| **27.1** | [**Browse - IMPORT Historique Cha** (27)](#t1) [mockup](#ecran-t1) | MDI | 780x208 | Traitement |
...
Main -> ... -> [Dispatch (IDE 96)](PBG-IDE-96.md) -> **Browse - IMPORT Historique Cha (IDE 27)**

```mermaid
graph LR
    T27[27 Browse - IMPORT His...]
