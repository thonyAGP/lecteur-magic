# REF IDE 7 - Browse - automate_autorite
...
| Projet | REF |
| IDE Position | 7 |
| Nom Programme | Browse - automate_autorite |
...
**Browse - automate_autorite** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>7 - Browse - automate_autorite

**Role** : Traitement : Browse - automate_autorite.
...
|----------|-------|------|------------|------|
| **7.1** | [**Browse - automate_autorite** (7)](#t1) | - | - | Traitement |
