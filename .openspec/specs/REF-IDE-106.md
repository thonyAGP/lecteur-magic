# REF IDE 106 - Browse - tables_paris
...
| Projet | REF |
| IDE Position | 106 |
| Nom Programme | Browse - tables_paris |
...
**Browse - tables_paris** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>106 - Browse - tables_paris

**Role** : Traitement : Browse - tables_paris.
...
|----------|-------|------|------------|------|
| **106.1** | [**Browse - tables_paris** (106)](#t1) | - | - | Traitement |
