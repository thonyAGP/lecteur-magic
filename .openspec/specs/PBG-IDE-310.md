# PBG IDE 310 - Tache dans le vide
...
| Projet | PBG |
| IDE Position | 310 |
| Nom Programme | Tache dans le vide |
...
**Tache dans le vide** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>310 - Tache dans le vide

**Role** : Traitement : Tache dans le vide.
...
|----------|-------|------|------------|------|
| **310.1** | [**Tache dans le vide** (310)](#t1) | MDI | - | Traitement |
