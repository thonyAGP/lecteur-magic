# MAI IDE 46 - Recuperation langue
...
**Recuperation langue** assure la gestion complete de ce processus, accessible depuis [Main Program (IDE 1)](MAI-IDE-1.md), [Start (IDE 51)](MAI-IDE-51.md).
...
#### <a id="t1"></a>46 - Recuperation langue
...
- **Appele par**: [Main Program (IDE 1)](MAI-IDE-1.md), [Start (IDE 51)](MAI-IDE-51.md)
...
|----------|-------|------|------------|------|
| **46.1** | [**Recuperation langue** (46)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Main Program (IDE 1)](MAI-IDE-1.md) -> **Recuperation langue (IDE 46)**

Main -> ... -> [Start (IDE 51)](MAI-IDE-51.md) -> **Recuperation langue (IDE 46)**

```mermaid
graph LR
    T46[46 Recuperation langue]
