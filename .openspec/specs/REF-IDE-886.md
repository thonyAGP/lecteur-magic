# REF IDE 886 - Gestion Statut Location

> **Analyse**: Phases 1-4 2026-02-03 14:55 -> 14:55 (14s) | Assemblage 14:55
...
| Projet | REF |
| IDE Position | 886 |
| Nom Programme | Gestion Statut Location |
| Fichier source | `Prg_886.xml` |
| Dossier IDE | General |
...
**Gestion Statut Location** assure la gestion complete de ce processus.
...
- **886** - Rental Status Calculation **[[ECRAN]](#ecran-t1)**

#### Phase 2 : Traitement (6 taches)

- **886.1** - Rentals "Out" Date Due dépassé **[[ECRAN]](#ecran-t2)**
- **886.1.2** - Ligne en statut OUT
- **886.1.2.2** - Maj OUT > IN Sauf dernier/Equi
- **886.1.3** - Liste Gm purgés Status à Out **[[ECRAN]](#ecran-t7)**
- **886.1.3.1** - Mise à jour Status à IN Locat
- **886.1.3.2** - Mise à jour Statut à IN Equip

#### Phase 3 : Impression (2 taches)

- **886.1.1** - Print/Update Status Out **[[ECRAN]](#ecran-t3)**
- **886.1.2.1** - Edition des anc lignes Out>In **[[ECRAN]](#ecran-t5)**
...
#### <a id="t1"></a>886 - Rental Status Calculation [[ECRAN]](#ecran-t1)
...
#### <a id="t2"></a>886.1 - Rentals "Out" Date Due dépassé [[ECRAN]](#ecran-t2)
...
#### <a id="t4"></a>886.1.2 - Ligne en statut OUT
...
#### <a id="t6"></a>886.1.2.2 - Maj OUT > IN Sauf dernier/Equi

**Role** : Traitement : Maj OUT > IN Sauf dernier/Equi.

---

#### <a id="t7"></a>886.1.3 - Liste Gm purgés Status à Out [[ECRAN]](#ecran-t7)

**Role** : Traitement : Liste Gm purgés Status à Out.
**Ecran** : 743 x 331 DLU | [Voir mockup](#ecran-t7)
**Variables liees** : I (status_loc), J (status_equi)

---

#### <a id="t8"></a>886.1.3.1 - Mise à jour Status à IN Locat
...
#### <a id="t9"></a>886.1.3.2 - Mise à jour Statut à IN Equip
...
#### <a id="t3"></a>886.1.1 - Print/Update Status Out [[ECRAN]](#ecran-t3)

**Role** : Generation du document : Print/Update Status Out.
**Ecran** : 768 x 41 DLU | [Voir mockup](#ecran-t3)
**Variables liees** : I (status_loc), J (status_equi)

---

#### <a id="t5"></a>886.1.2.1 - Edition des anc lignes Out>In [[ECRAN]](#ecran-t5)

**Role** : Generation du document : Edition des anc lignes Out>In.
**Ecran** : 879 x 195 DLU | [Voir mockup](#ecran-t5)
...
- **Appele par**: (aucun)
- **Appelle**: 0 programmes | **Tables**: 9 (W:0 R:3 L:8) | **Taches**: 9 | **Expressions**: 7
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 886 | 886 | Rental Status Calculation | Type0 | 313 | 174 | Calcul |
| 2 | 886.1 | 886.1 | Rentals "Out" Date Due dépassé | Type0 | 997 | 429 | Traitement |
| 3 | 886.1.1 | 886.1.1 | Print/Update Status Out | Type0 | 768 | 41 | Impression |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>886 - Rental Status Calculation
**Tache** : [886](#t1) | **Type** : Type0 | **Dimensions** : 313 x 174 DLU
...
#### <a id="ecran-t2"></a>886.1 - Rentals "Out" Date Due dépassé
**Tache** : [886.1](#t2) | **Type** : Type0 | **Dimensions** : 997 x 429 DLU
...
#### <a id="ecran-t3"></a>886.1.1 - Print/Update Status Out
**Tache** : [886.1.1](#t3) | **Type** : Type0 | **Dimensions** : 768 x 41 DLU
**Bloc** : Impression | **Titre IDE** : Print/Update Status Out
...
flowchart TD
    ...
    VF1[886 Rental Status Calcu...]
    style VF1 fill:#58a6ff
    VF2[886.1 Rentals Out Date Du...]
    style VF2 fill:#58a6ff
    VF3[886.1.1 PrintUpdate Status Out]
...
|----------|-------|------|------------|------|
| **886.1** | [**Rental Status Calculation** (886)](#t1) [mockup](#ecran-t1) | - | 313x174 | Calcul |
| **886.2** | [**Rentals "Out" Date Due dépassé** (886.1)](#t2) [mockup](#ecran-t2) | - | 997x429 | Traitement |
| 886.2.1 | [Ligne en statut OUT (886.1.2)](#t4) | - | - | |
| 886.2.2 | [Maj OUT > IN Sauf dernier/Equi (886.1.2.2)](#t6) | - | - | |
| 886.2.3 | [Liste Gm purgés Status à Out (886.1.3)](#t7) [mockup](#ecran-t7) | - | 743x331 | |
| 886.2.4 | [Mise à jour Status à IN Locat (886.1.3.1)](#t8) | - | - | |
| 886.2.5 | [Mise à jour Statut à IN Equip (886.1.3.2)](#t9) | - | - | |
| **886.3** | [**Print/Update Status Out** (886.1.1)](#t3) [mockup](#ecran-t3) | - | 768x41 | Impression |
| 886.3.1 | [Edition des anc lignes Out>In (886.1.2.1)](#t5) [mockup](#ecran-t5) | - | 879x195 | |
...
| 376 | pv_classification |  | DB |   |   | L | 2 |
| 378 | pv_customer |  | DB | R |   | L | 3 |
| 384 | pv_equipment_models |  | DB |   |   | L | 2 |
| 385 | pv_equipment |  | DB |   |   | L | 2 |
| 394 | pv_manufacturers |  | DB |   |   | L | 2 |
| 400 | pv_cust_rentals |  | DB |   |   | L | 2 |
| 888 | Prestation_Multi | Prestations/services vendus | DB |   |   | L | 2 |
...
| B | V_Ancien Statut loc ECRAN | R | Unicode |
| C | V_Ancien Statut Equip ECRAN | R | Unicode |
| D | V_Ligne CSV ECRAN | R | Unicode |
| E | V.En cours de traitement | R | Numeric |

</details>

<details>
<summary>Table 378 - pv_customer (R/L) - 3 usages</summary>
...
```mermaid
graph LR
    T886[886 Gestion Statut Loc...]
    style T886 fill:#58a6ff
    NONE[Aucun caller]
    NONE -.-> T886
...
|----------|--------|-----------------|
| Lignes de logique | 337 | Taille moyenne |
| Expressions | 7 | Peu de logique |
| Tables WRITE | 0 | Impact faible |
| Sous-programmes | 0 | Peu de dependances |
| Ecrans visibles | 3 | Quelques ecrans |
| Code desactive | 0% (0 / 337) | Code sain |
