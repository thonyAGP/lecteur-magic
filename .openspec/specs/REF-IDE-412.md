# REF IDE 412 - Browse - req_dispatch

> **Analyse**: Phases 1-4 2026-02-03 11:44 -> 11:44 (17s) | Assemblage 11:44
...
| Projet | REF |
| IDE Position | 412 |
| Nom Programme | Browse - req_dispatch |
...
**Browse - req_dispatch** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>412 - Browse - req_dispatch

**Role** : Traitement : Browse - req_dispatch.
...
|----------|-------|------|------------|------|
| **412.1** | [**Browse - req_dispatch** (412)](#t1) | - | - | Traitement |
