# REF IDE 372 - Browse - pv_day_modes
...
| Projet | REF |
| IDE Position | 372 |
| Nom Programme | Browse - pv_day_modes |
...
**Browse - pv_day_modes** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>372 - Browse - pv_day_modes

**Role** : Traitement : Browse - pv_day_modes.
...
|----------|-------|------|------------|------|
| **372.1** | [**Browse - pv_day_modes** (372)](#t1) | - | - | Traitement |
