# PBS IDE 52 - Alimentation Combos PARIS 2

> **Analyse**: Phases 1-4 2026-02-03 17:18 -> 17:18 (19s) | Assemblage 17:18
...
| Projet | PBS |
| IDE Position | 52 |
| Nom Programme | Alimentation Combos PARIS 2 |
...
**Alimentation Combos PARIS 2** assure la gestion complete de ce processus, accessible depuis [Initialisation (IDE 48)](PBS-IDE-48.md).
...
#### <a id="t1"></a>52 - Êcran [[ECRAN]](#ecran-t1)
...
|----------|-------|------|------------|------|
| **52.1** | [**Êcran** (52)](#t1) [mockup](#ecran-t1) | MDI | 573x251 | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 4 | `Trim (v.Combo [D])&','&Trim (Left (Trim (Str ([G],'##')),> Longueur Code [B])&'  '&Trim ([I]))` | - |
| CONCATENATION | 3 | `Trim (Left (Trim (Str ([G],'##')),> Longueur Code [B])&'  '&Trim ([I]))` | - |
...
Main -> ... -> [Initialisation (IDE 48)](PBS-IDE-48.md) -> **Alimentation Combos PARIS 2 (IDE 52)**

```mermaid
graph LR
    T52[52 Alimentation Combos...]
...
---
*Spec DETAILED generee par Pipeline V7.2 - 2026-02-03 17:18*
