# PBG IDE 153 - Alimentation Combos INSCRIPT

> **Analyse**: Phases 1-4 2026-02-03 09:46 -> 09:46 (23s) | Assemblage 09:46
...
| Projet | PBG |
| IDE Position | 153 |
| Nom Programme | Alimentation Combos INSCRIPT |
...
**Alimentation Combos INSCRIPT** assure la gestion complete de ce processus, accessible depuis [Execution des màj combo (IDE 141)](PBG-IDE-141.md).
...
#### <a id="t1"></a>153 - Êcran [[ECRAN]](#ecran-t1)

**Role** : Traitement : Êcran.
**Ecran** : 573 x 66 DLU (MDI) | [Voir mockup](#ecran-t1)
...
|----------|-------|------|------------|------|
| **153.1** | [**Êcran** (153)](#t1) [mockup](#ecran-t1) | MDI | 573x66 | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 7 | `Trim (v.Combo [B])&','&Left ([D],3)&' '&Trim ([E])` | - |
| CONCATENATION | 6 | `Left ([D],3)&' '&Trim ([E])` | - |
...
Main -> ... -> [Execution des màj combo (IDE 141)](PBG-IDE-141.md) -> **Alimentation Combos INSCRIPT (IDE 153)**

```mermaid
graph LR
    T153[153 Alimentation Combo...]
