# WEL IDE 68 - Selection Interruption
...
**Selection Interruption** assure la gestion complete de ce processus, accessible depuis [Clients (IDE 9)](WEL-IDE-9.md).
...
- **68** - Selection Interruption

#### Phase 2 : Traitement (2 taches)

- **68.1** - Determination Periode
- **68.2** - Demarquage Caisse
...
#### <a id="t1"></a>68 - Selection Interruption
...
#### <a id="t2"></a>68.1 - Determination Periode
...
#### <a id="t3"></a>68.2 - Demarquage Caisse
...
|----------|-------|------|------------|------|
| **68.1** | [**Selection Interruption** (68)](#t1) | MDI | - | Consultation |
| **68.2** | [**Determination Periode** (68.1)](#t2) | MDI | - | Traitement |
| 68.2.1 | [Demarquage Caisse (68.2)](#t3) | MDI | - | |
...
Main -> ... -> [Clients (IDE 9)](WEL-IDE-9.md) -> **Selection Interruption (IDE 68)**

```mermaid
graph LR
    T68[68 Selection Interruption]
