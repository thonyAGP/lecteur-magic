# PBG IDE 155 - Alimentation Combos LANGUE
...
| Projet | PBG |
| IDE Position | 155 |
| Nom Programme | Alimentation Combos LANGUE |
...
**Alimentation Combos LANGUE** assure la gestion complete de ce processus, accessible depuis [Execution des màj combo (IDE 141)](PBG-IDE-141.md).
...
#### <a id="t1"></a>155 - Êcran [[ECRAN]](#ecran-t1)

**Role** : Traitement : Êcran.
**Ecran** : 573 x 85 DLU (MDI) | [Voir mockup](#ecran-t1)
...
|----------|-------|------|------------|------|
| **155.1** | [**Êcran** (155)](#t1) [mockup](#ecran-t1) | MDI | 573x85 | Traitement |
...
|----|-----|-------------|------|---|---|---|--------|
| 130 | fichier_langue |  | DB | R |   |   | 1 |

### Colonnes par table (1 / 1 tables avec colonnes identifiees)

<details>
<summary>Table 130 - fichier_langue (R) - 1 usages</summary>
...
Main -> ... -> [Execution des màj combo (IDE 141)](PBG-IDE-141.md) -> **Alimentation Combos LANGUE (IDE 155)**

```mermaid
graph LR
    T155[155 Alimentation Combo...]
