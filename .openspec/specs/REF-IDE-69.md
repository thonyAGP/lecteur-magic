# REF IDE 69 - Browse - commande_autocom_cot
...
| Projet | REF |
| IDE Position | 69 |
| Nom Programme | Browse - commande_autocom_cot |
...
**Browse - commande_autocom_cot** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>69 - Browse - commande_autocom_cot

**Role** : Traitement : Browse - commande_autocom_cot.
...
|----------|-------|------|------------|------|
| **69.1** | [**Browse - commande_autocom_cot** (69)](#t1) | - | - | Traitement |
