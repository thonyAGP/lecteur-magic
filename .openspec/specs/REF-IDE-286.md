# REF IDE 286 - Browse - divers_excursion_die
...
| Projet | REF |
| IDE Position | 286 |
| Nom Programme | Browse - divers_excursion_die |
...
**Browse - divers_excursion_die** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>286 - Browse - divers_excursion_die

**Role** : Traitement : Browse - divers_excursion_die.
...
|----------|-------|------|------------|------|
| **286.1** | [**Browse - divers_excursion_die** (286)](#t1) | - | - | Traitement |
