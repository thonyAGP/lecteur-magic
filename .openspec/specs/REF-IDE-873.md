...
| Projet | REF |
| IDE Position | 873 |
| Nom Programme | Program_958 |
| Fichier source | `Prg_873.xml` |
| Dossier IDE | General |
...
**Program_958** assure la gestion complete de ce processus.
...
|----------|-------|------|------------|------|
| **873.1** | [**(sans nom)** (873)](#t1) | - | - | Traitement |
...
```mermaid
graph LR
    T873[873 Program_958]
    style T873 fill:#58a6ff
    NONE[Aucun caller]
    NONE -.-> T873
