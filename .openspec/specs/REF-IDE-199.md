# REF IDE 199 - Browse - comptes_produit_centr
...
| Projet | REF |
| IDE Position | 199 |
| Nom Programme | Browse - comptes_produit_centr |
...
**Browse - comptes_produit_centr** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>199 - Browse - comptes_produit_centr

**Role** : Traitement : Browse - comptes_produit_centr.
...
|----------|-------|------|------------|------|
| **199.1** | [**Browse - comptes_produit_centr** (199)](#t1) | - | - | Calcul |
