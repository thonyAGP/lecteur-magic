# LOG IDE 8 - Recuperation langue

> **Analyse**: Phases 1-4 2026-02-03 14:39 -> 14:39 (9s) | Assemblage 14:39
...
**Recuperation langue** assure la gestion complete de ce processus, accessible depuis [Main Program (IDE 1)](LOG-IDE-1.md), [Start (IDE 22)](LOG-IDE-22.md).
...
#### <a id="t1"></a>8 - Recuperation langue
...
- **Appele par**: [Main Program (IDE 1)](LOG-IDE-1.md), [Start (IDE 22)](LOG-IDE-22.md)
...
|----------|-------|------|------------|------|
| **8.1** | [**Recuperation langue** (8)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Main Program (IDE 1)](LOG-IDE-1.md) -> **Recuperation langue (IDE 8)**

Main -> ... -> [Start (IDE 22)](LOG-IDE-22.md) -> **Recuperation langue (IDE 8)**

```mermaid
graph LR
    T8[8 Recuperation langue]
