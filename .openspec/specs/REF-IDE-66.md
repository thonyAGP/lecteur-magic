# REF IDE 66 - Browse - generation_code_gen
...
| Projet | REF |
| IDE Position | 66 |
| Nom Programme | Browse - generation_code_gen |
...
**Browse - generation_code_gen** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>66 - Browse - generation_code_gen

**Role** : Traitement : Browse - generation_code_gen.
...
|----------|-------|------|------------|------|
| **66.1** | [**Browse - generation_code_gen** (66)](#t1) | - | - | Traitement |
