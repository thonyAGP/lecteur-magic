# PVE IDE 440 - Main Sale

> **Analyse**: Phases 1-4 2026-02-03 20:10 -> 20:10 (16s) | Assemblage 20:10
...
| Fichier source | `Prg_440.xml` |
| Dossier IDE | A |
| Taches | 46 (21 ecrans visibles) |
| Tables modifiees | 4 |
| Programmes appeles | 20 |

## 2. DESCRIPTION FONCTIONNELLE

**Main Sale** assure la gestion complete de ce processus, accessible depuis [Menu==V4___ (IDE 420)](PVE-IDE-420.md), [Menu (IDE 439)](PVE-IDE-439.md).

Le flux de traitement s'organise en **7 blocs fonctionnels** :

- **Traitement** (34 taches) : traitements metier divers
...
**Donnees modifiees** : 4 tables en ecriture (pv_customer, pv_sellers_by_week, Table_1501, Table_1548).
...
#### Phase 1 : Traitement (34 taches)

- **440** - Main Sale V4 **[[ECRAN]](#ecran-t1)**
- **440.1.1** - equipement **[[ECRAN]](#ecran-t3)**
- **440.1.1.1** - Equipment check out **[[ECRAN]](#ecran-t4)**
- **440.1.1.1.1** - clear
- **440.1.1.1.2** - Récupère Libellé Classif
- **440.1.1.2** - Equipment list **[[ECRAN]](#ecran-t7)**
- **440.1.1.2.1** - Equipment check out **[[ECRAN]](#ecran-t8)**
- **440.1.1.2.2** - Equipment list **[[ECRAN]](#ecran-t9)**
- **440.1.1.2.2.1** - Equipment check IN **[[ECRAN]](#ecran-t10)**
- **440.1.2** - Booking_ID **[[ECRAN]](#ecran-t11)**
- **440.1.3** - Onglet Booking **[[ECRAN]](#ecran-t15)**
- **440.1.3.1** - Booking **[[ECRAN]](#ecran-t16)**
- **440.1.3.2** - Screen **[[ECRAN]](#ecran-t17)**
- **440.1.3.3** - GetBookigsInfo
- **440.1.4** - Transac not PMS **[[ECRAN]](#ecran-t20)**
- **440.1.4.1** - Get prod id
- **440.1.4.2** - Get Cat & Subcat
- **440.1.5** - Sales and Payment **[[ECRAN]](#ecran-t23)**
- **440.1.5.1** - Payment **[[ECRAN]](#ecran-t24)**
- **440.1.5.1.2** - View
- **440.1.5.2** - Discount **[[ECRAN]](#ecran-t28)**
- **440.1.5.3** - Test Prepaid
- **440.1.5.4** - Special actions **[[ECRAN]](#ecran-t31)**
- **440.1.5.4.1** - Cancel other Packages **[[ECRAN]](#ecran-t32)**
- **440.1.5.4.1.1** - UpdateCustRentals
- **440.1.5.4.3** - End of rental **[[ECRAN]](#ecran-t35)**
- **440.1.5.4.4** - UpdateCustRentals
- **440.1.5.5** - Check Rentals
- **440.1.5.6** - Check Payments **[[ECRAN]](#ecran-t38)**
- **440.1.5.7** - Check Comment Refus. To Sell **[[ECRAN]](#ecran-t39)**
- **440.1.5.8** - Discount **[[ECRAN]](#ecran-t40)**
- **440.1.5.9** - Delete other Packages **[[ECRAN]](#ecran-t42)**
- **440.1.6** - Transac not PMS MBO **[[ECRAN]](#ecran-t44)**
- **440.1.6.1** - SQL Total payement **[[ECRAN]](#ecran-t45)**

Delegue a : [Update INV equipment status (IDE 93)](PVE-IDE-93.md), [Lancement clavier (IDE 317)](PVE-IDE-317.md), [      Package=> account (IDE 196)](PVE-IDE-196.md), [GetAppointment (IDE 161)](PVE-IDE-161.md), [FindAppointments (IDE 176)](PVE-IDE-176.md), [Delete Product (IDE 194)](PVE-IDE-194.md), [SynchronisationRecuPDF (IDE 320)](PVE-IDE-320.md), [Generate Preview Payments (IDE 441)](PVE-IDE-441.md), [Discounts (IDE 443)](PVE-IDE-443.md), [Browse - pv_cust_package (IDE 447)](PVE-IDE-447.md), [SearchBooking (IDE 153)](PVE-IDE-153.md), [FindRooms (IDE 157)](PVE-IDE-157.md), [FindEmployees (IDE 158)](PVE-IDE-158.md), [GetNbrProdBookerWithoutBooking (IDE 171)](PVE-IDE-171.md)

#### Phase 2 : Consultation (3 taches)

- **440.1** - Choix Onglet **[[ECRAN]](#ecran-t2)**
- **440.1.2.2** - Select Appointments **[[ECRAN]](#ecran-t13)**
- **440.1.2.2.1** - Select all
...
- **440.1.2.1** - CreateSales
- **440.1.3.4** - CreateMail
- **440.1.5.1.3** - create cardType

#### Phase 4 : Initialisation (1 tache)

- **440.1.5.1.1** - init payer

#### Phase 5 : Saisie (3 taches)

- **440.1.5.2.1** - Saisie comment annulation **[[ECRAN]](#ecran-t29)**
- **440.1.5.4.2** - Saisie comment annulation **[[ECRAN]](#ecran-t34)**
- **440.1.5.8.1** - Saisie comment annulation **[[ECRAN]](#ecran-t41)**

Delegue a : [Saisie commentaire (IDE 200)](PVE-IDE-200.md)

#### Phase 6 : Validation (1 tache)

- **440.1.5.10** - Verif Multi-Payeurs comptes <> **[[ECRAN]](#ecran-t43)**

Delegue a : [ControleBookingId (IDE 165)](PVE-IDE-165.md)

#### Phase 7 : Calcul (1 tache)

- **440.2** - calcul filiation
...
|-------|-----------|-------------|
| pv_sellers_by_week | **W**/L (8 usages) |  |
| Table_1548 | **W**/L (4 usages) |  |
...
### 3.1 Traitement (34 taches)

Traitements internes.

---

#### <a id="t1"></a>440 - Main Sale V4 [[ECRAN]](#ecran-t1)

**Role** : Tache d'orchestration : point d'entree du programme (34 sous-taches). Coordonne l'enchainement des traitements.
**Ecran** : 1990 x 392 DLU (Modal) | [Voir mockup](#ecran-t1)

<details>
<summary>33 sous-taches directes</summary>

| Tache | Nom | Bloc |
|-------|-----|------|
| [440.1.1](#t3) | equipement **[[ECRAN]](#ecran-t3)** | Traitement |
| [440.1.1.1](#t4) | Equipment check out **[[ECRAN]](#ecran-t4)** | Traitement |
| [440.1.1.1.1](#t5) | clear | Traitement |
| [440.1.1.1.2](#t6) | Récupère Libellé Classif | Traitement |
| [440.1.1.2](#t7) | Equipment list **[[ECRAN]](#ecran-t7)** | Traitement |
| [440.1.1.2.1](#t8) | Equipment check out **[[ECRAN]](#ecran-t8)** | Traitement |
| [440.1.1.2.2](#t9) | Equipment list **[[ECRAN]](#ecran-t9)** | Traitement |
| [440.1.1.2.2.1](#t10) | Equipment check IN **[[ECRAN]](#ecran-t10)** | Traitement |
| [440.1.2](#t11) | Booking_ID **[[ECRAN]](#ecran-t11)** | Traitement |
| [440.1.3](#t15) | Onglet Booking **[[ECRAN]](#ecran-t15)** | Traitement |
| [440.1.3.1](#t16) | Booking **[[ECRAN]](#ecran-t16)** | Traitement |
| [440.1.3.2](#t17) | Screen **[[ECRAN]](#ecran-t17)** | Traitement |
| [440.1.3.3](#t18) | GetBookigsInfo | Traitement |
| [440.1.4](#t20) | Transac not PMS **[[ECRAN]](#ecran-t20)** | Traitement |
| [440.1.4.1](#t21) | Get prod id | Traitement |
| [440.1.4.2](#t22) | Get Cat & Subcat | Traitement |
| [440.1.5](#t23) | Sales and Payment **[[ECRAN]](#ecran-t23)** | Traitement |
| [440.1.5.1](#t24) | Payment **[[ECRAN]](#ecran-t24)** | Traitement |
| [440.1.5.1.2](#t26) | View | Traitement |
| [440.1.5.2](#t28) | Discount **[[ECRAN]](#ecran-t28)** | Traitement |
| [440.1.5.3](#t30) | Test Prepaid | Traitement |
| [440.1.5.4](#t31) | Special actions **[[ECRAN]](#ecran-t31)** | Traitement |
| [440.1.5.4.1](#t32) | Cancel other Packages **[[ECRAN]](#ecran-t32)** | Traitement |
| [440.1.5.4.1.1](#t33) | UpdateCustRentals | Traitement |
| [440.1.5.4.3](#t35) | End of rental **[[ECRAN]](#ecran-t35)** | Traitement |
| [440.1.5.4.4](#t36) | UpdateCustRentals | Traitement |
| [440.1.5.5](#t37) | Check Rentals | Traitement |
| [440.1.5.6](#t38) | Check Payments **[[ECRAN]](#ecran-t38)** | Traitement |
| [440.1.5.7](#t39) | Check Comment Refus. To Sell **[[ECRAN]](#ecran-t39)** | Traitement |
| [440.1.5.8](#t40) | Discount **[[ECRAN]](#ecran-t40)** | Traitement |
| [440.1.5.9](#t42) | Delete other Packages **[[ECRAN]](#ecran-t42)** | Traitement |
| [440.1.6](#t44) | Transac not PMS MBO **[[ECRAN]](#ecran-t44)** | Traitement |
| [440.1.6.1](#t45) | SQL Total payement **[[ECRAN]](#ecran-t45)** | Traitement |

</details>

---

#### <a id="t3"></a>440.1.1 - equipement [[ECRAN]](#ecran-t3)

**Role** : Traitement : equipement.
**Ecran** : 971 x 229 DLU (Modal) | [Voir mockup](#ecran-t3)
**Variables liees** : T (v.LequipementID)

---

#### <a id="t4"></a>440.1.1.1 - Equipment check out [[ECRAN]](#ecran-t4)
...
#### <a id="t5"></a>440.1.1.1.1 - clear

**Role** : Traitement : clear.

---

#### <a id="t6"></a>440.1.1.1.2 - Récupère Libellé Classif

**Role** : Traitement : Récupère Libellé Classif.

---

#### <a id="t7"></a>440.1.1.2 - Equipment list [[ECRAN]](#ecran-t7)
...
#### <a id="t8"></a>440.1.1.2.1 - Equipment check out [[ECRAN]](#ecran-t8)
...
#### <a id="t9"></a>440.1.1.2.2 - Equipment list [[ECRAN]](#ecran-t9)
...
#### <a id="t10"></a>440.1.1.2.2.1 - Equipment check IN [[ECRAN]](#ecran-t10)
...
#### <a id="t11"></a>440.1.2 - Booking_ID [[ECRAN]](#ecran-t11)
...
#### <a id="t15"></a>440.1.3 - Onglet Booking [[ECRAN]](#ecran-t15)

**Role** : Traitement : Onglet Booking.
**Ecran** : 976 x 239 DLU (Modal) | [Voir mockup](#ecran-t15)
**Variables liees** : BN (v.FocusOngletBooking)

---

#### <a id="t16"></a>440.1.3.1 - Booking [[ECRAN]](#ecran-t16)

**Role** : Traitement : Booking.
**Ecran** : 440 x 136 DLU (Type6) | [Voir mockup](#ecran-t16)
**Variables liees** : BN (v.FocusOngletBooking)

---

#### <a id="t17"></a>440.1.3.2 - Screen [[ECRAN]](#ecran-t17)

**Role** : Traitement : Screen.
**Ecran** : 1716 x 248 DLU (Type6) | [Voir mockup](#ecran-t17)

---

#### <a id="t18"></a>440.1.3.3 - GetBookigsInfo

**Role** : Consultation/chargement : GetBookigsInfo.

---

#### <a id="t20"></a>440.1.4 - Transac not PMS [[ECRAN]](#ecran-t20)

**Role** : Traitement : Transac not PMS.
**Ecran** : 973 x 248 DLU (Modal) | [Voir mockup](#ecran-t20)

---

#### <a id="t21"></a>440.1.4.1 - Get prod id
...
#### <a id="t22"></a>440.1.4.2 - Get Cat & Subcat

**Role** : Consultation/chargement : Get Cat & Subcat.

---

#### <a id="t23"></a>440.1.5 - Sales and Payment [[ECRAN]](#ecran-t23)
...
#### <a id="t24"></a>440.1.5.1 - Payment [[ECRAN]](#ecran-t24)

**Role** : Traitement : Payment.
**Ecran** : 238 x 63 DLU (MDI) | [Voir mockup](#ecran-t24)
**Variables liees** : BA (v.All.Payment ?)

---

#### <a id="t26"></a>440.1.5.1.2 - View

**Role** : Traitement : View.

---

#### <a id="t28"></a>440.1.5.2 - Discount [[ECRAN]](#ecran-t28)

**Role** : Traitement : Discount.
**Ecran** : 220 x 94 DLU (MDI) | [Voir mockup](#ecran-t28)
**Variables liees** : BB (v.L.Test Discount ?)

---

#### <a id="t30"></a>440.1.5.3 - Test Prepaid
...
#### <a id="t31"></a>440.1.5.4 - Special actions [[ECRAN]](#ecran-t31)

**Role** : Traitement : Special actions.
**Ecran** : 312 x 259 DLU (Type6) | [Voir mockup](#ecran-t31)

---

#### <a id="t32"></a>440.1.5.4.1 - Cancel other Packages [[ECRAN]](#ecran-t32)

**Role** : Traitement : Cancel other Packages.
**Ecran** : 312 x 259 DLU (Type6) | [Voir mockup](#ecran-t32)

---

#### <a id="t33"></a>440.1.5.4.1.1 - UpdateCustRentals

**Role** : Traitement : UpdateCustRentals.

---

#### <a id="t35"></a>440.1.5.4.3 - End of rental [[ECRAN]](#ecran-t35)

**Role** : Traitement : End of rental.
**Ecran** : 384 x 305 DLU (Type6) | [Voir mockup](#ecran-t35)

---

#### <a id="t36"></a>440.1.5.4.4 - UpdateCustRentals

**Role** : Traitement : UpdateCustRentals.

---

#### <a id="t37"></a>440.1.5.5 - Check Rentals

**Role** : Traitement : Check Rentals.

---

#### <a id="t38"></a>440.1.5.6 - Check Payments [[ECRAN]](#ecran-t38)

**Role** : Traitement : Check Payments.
**Ecran** : 926 x 449 DLU (MDI) | [Voir mockup](#ecran-t38)

---

#### <a id="t39"></a>440.1.5.7 - Check Comment Refus. To Sell [[ECRAN]](#ecran-t39)

**Role** : Traitement : Check Comment Refus. To Sell.
**Ecran** : 522 x 498 DLU | [Voir mockup](#ecran-t39)

---

#### <a id="t40"></a>440.1.5.8 - Discount [[ECRAN]](#ecran-t40)

**Role** : Traitement : Discount.
**Ecran** : 854 x 202 DLU (MDI) | [Voir mockup](#ecran-t40)
**Variables liees** : BB (v.L.Test Discount ?)

---

#### <a id="t42"></a>440.1.5.9 - Delete other Packages [[ECRAN]](#ecran-t42)

**Role** : Traitement : Delete other Packages.
**Ecran** : 312 x 259 DLU (Type6) | [Voir mockup](#ecran-t42)

---

#### <a id="t44"></a>440.1.6 - Transac not PMS MBO [[ECRAN]](#ecran-t44)

**Role** : Traitement : Transac not PMS MBO.
**Ecran** : 695 x 143 DLU (MDI) | [Voir mockup](#ecran-t44)

---

#### <a id="t45"></a>440.1.6.1 - SQL Total payement [[ECRAN]](#ecran-t45)

**Role** : Traitement : SQL Total payement.
**Ecran** : 115 x 195 DLU | [Voir mockup](#ecran-t45)
...
#### <a id="t2"></a>440.1 - Choix Onglet [[ECRAN]](#ecran-t2)
...
#### <a id="t13"></a>440.1.2.2 - Select Appointments [[ECRAN]](#ecran-t13)
...
#### <a id="t14"></a>440.1.2.2.1 - Select all
...
#### <a id="t12"></a>440.1.2.1 - CreateSales

**Role** : Traitement : CreateSales.

---

#### <a id="t19"></a>440.1.3.4 - CreateMail

**Role** : Traitement : CreateMail.

---

#### <a id="t27"></a>440.1.5.1.3 - create cardType
...
#### <a id="t25"></a>440.1.5.1.1 - init payer
...
#### <a id="t29"></a>440.1.5.2.1 - Saisie comment annulation [[ECRAN]](#ecran-t29)

**Role** : Saisie des donnees : Saisie comment annulation.
**Ecran** : 318 x 135 DLU | [Voir mockup](#ecran-t29)
**Delegue a** : [Saisie commentaire (IDE 200)](PVE-IDE-200.md)

---

#### <a id="t34"></a>440.1.5.4.2 - Saisie comment annulation [[ECRAN]](#ecran-t34)

**Role** : Saisie des donnees : Saisie comment annulation.
**Ecran** : 322 x 136 DLU (Type6) | [Voir mockup](#ecran-t34)
**Delegue a** : [Saisie commentaire (IDE 200)](PVE-IDE-200.md)

---

#### <a id="t41"></a>440.1.5.8.1 - Saisie comment annulation [[ECRAN]](#ecran-t41)

**Role** : Saisie des donnees : Saisie comment annulation.
**Ecran** : 318 x 135 DLU | [Voir mockup](#ecran-t41)
**Delegue a** : [Saisie commentaire (IDE 200)](PVE-IDE-200.md)
...
#### <a id="t43"></a>440.1.5.10 - Verif Multi-Payeurs comptes <> [[ECRAN]](#ecran-t43)

**Role** : Verification : Verif Multi-Payeurs comptes <>.
**Ecran** : 123 x 195 DLU | [Voir mockup](#ecran-t43)
**Delegue a** : [ControleBookingId (IDE 165)](PVE-IDE-165.md)
...
#### <a id="t46"></a>440.2 - calcul filiation
...
| **Impact** | [440.1.1.1 - Equipment check out](#t4) |
...
| **Impact** | [440.1.1 - equipement](#t3) |

#### <a id="rm-RM-005"></a>[RM-005] Si [BW]='V' alors 'VIP' sinon IF([BW]='T','TOP VIP',''))

| Element | Detail |
|---------|--------|
| **Condition** | `[BW]='V'` |
| **Si vrai** | 'VIP' |
| **Si faux** | IF([BW]='T','TOP VIP','')) |
| **Expression source** | Expression 17 : `IF([BW]='V','VIP',IF([BW]='T','TOP VIP',''))` |
| **Exemple** | Si [BW]='V' â†’ 'VIP'. Sinon â†’ IF([BW]='T','TOP VIP','')) |
...
| **Exemple** | Si Trim(v.Libelle VIP [Z])<>'' â†’ Trim(v.Libelle VIP [Z]). Sinon â†’ Trim([CG])) |
...
#### <a id="rm-RM-010"></a>[RM-010] Si NOT(VG18) alors [BV] sinon V.GarantieO/N [BU])

| Element | Detail |
|---------|--------|
| **Condition** | `NOT(VG18)` |
| **Si vrai** | [BV] |
| **Si faux** | V.GarantieO/N [BU]) |
| **Variables** | U (v.Garantie), BU (V.GarantieO/N) |
| **Expression source** | Expression 40 : `IF(NOT(VG18),[BV],V.GarantieO/N [BU])` |
| **Exemple** | Si NOT(VG18) â†’ [BV]. Sinon â†’ V.GarantieO/N [BU]) |
...
#### <a id="rm-RM-013"></a>[RM-013] Traitement si [CL],'Booking',IF(Trim(VG59) est renseigne
...
| **Expression source** | Expression 76 : `IF([CL],'Booking',IF(Trim(VG59)<>'',VG59,'Sale'))` |
| **Exemple** | Si [CL] â†’ 'Booking'. Sinon â†’ IF(Trim(VG59)<>'',VG59,'Sale')) |
| **Impact** | [440.1.3.1 - Booking](#t16) |
...
#### <a id="rm-RM-015"></a>[RM-015] Traitement si [DB] est non nul

| Element | Detail |
|---------|--------|
| **Condition** | `[DB]<>0` |
| **Si vrai** | 'N11.'&Trim(Str([DB] |
| **Si faux** | '#'))&'CZ','N13CZ') |
| **Expression source** | Expression 98 : `IF([DB]<>0,'N11.'&Trim(Str([DB],'#'))&'CZ','N13CZ')` |
| **Exemple** | Si [DB]<>0 â†’ 'N11.'&Trim(Str([DB]. Sinon â†’ '#'))&'CZ','N13CZ') |

#### <a id="rm-RM-016"></a>[RM-016] Si Trim(V."Best of" Interdit M... [BO])='CLUB' AND V.CodeRerourExtraitCompte [BQ]='R' alors Translate('%club_images%garantie_club.bmp') sinon Translate('%club_images%garantie.bmp'))

| Element | Detail |
|---------|--------|
| **Condition** | `Trim(V."Best of" Interdit M... [BO])='CLUB' AND V.CodeRerourExtraitCompte [BQ]='R'` |
| **Si vrai** | Translate('%club_images%garantie_club.bmp') |
| **Si faux** | Translate('%club_images%garantie.bmp')) |
| **Variables** | BQ (V.CodeRerourExtraitCompte) |
| **Expression source** | Expression 100 : `IF(Trim(V."Best of" Interdit M... [BO])='CLUB' AND V.CodeRer` |
| **Exemple** | Si Trim(V."Best of" Interdit M... [BO])='CLUB' AND V.CodeRerourExtraitCompte [BQ]='R' â†’ Translate('%club_images%garantie_club.bmp'). Sinon â†’ Translate('%club_images%garantie.bmp')) |

## 6. CONTEXTE

- **Appele par**: [Menu==V4___ (IDE 420)](PVE-IDE-420.md), [Menu (IDE 439)](PVE-IDE-439.md)
- **Appelle**: 20 programmes | **Tables**: 32 (W:4 R:10 L:26) | **Taches**: 46 | **Expressions**: 100

<!-- TAB:Ecrans -->

## 8. ECRANS

### 8.1 Forms visibles (21 / 46)

| # | Position | Tache | Nom | Type | Largeur | Hauteur | Bloc |
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 440 | 440 | Main Sale V4 | Modal | 1990 | 392 | Traitement |
| 2 | 440.1 | 440.1 | Choix Onglet | MDI | 987 | 261 | Consultation |
| 3 | 440.1.1 | 440.1.1 | equipement | Modal | 971 | 229 | Traitement |
| 4 | 440.1.1.1 | 440.1.1.1 | Equipment check out | MDI | 320 | 254 | Traitement |
| 5 | 440.1.1.2 | 440.1.1.2 | Equipment list | MDI | 269 | 280 | Traitement |
| 6 | 440.1.1.2.1 | 440.1.1.2.1 | Equipment check out | MDI | 322 | 282 | Traitement |
| 7 | 440.1.1.2.2 | 440.1.1.2.2 | Equipment list | MDI | 190 | 280 | Traitement |
| 8 | 440.1.1.2.2.1 | 440.1.1.2.2.1 | Equipment check IN | Type6 | 642 | 281 | Traitement |
| 9 | 440.1.2 | 440.1.2 | Booking_ID | Modal | 973 | 248 | Traitement |
| 10 | 440.1.2.2 | 440.1.2.2 | Select Appointments | Type6 | 1464 | 266 | Consultation |
| 11 | 440.1.3 | 440.1.3 | Onglet Booking | Modal | 976 | 239 | Traitement |
| 12 | 440.1.3.1 | 440.1.3.1 | Booking | Type6 | 440 | 136 | Traitement |
| 13 | 440.1.3.2 | 440.1.3.2 | Screen | Type6 | 1716 | 248 | Traitement |
| 14 | 440.1.4 | 440.1.4 | Transac not PMS | Modal | 973 | 248 | Traitement |
| 15 | 440.1.5 | 440.1.5 | Sales and Payment | Modal | 976 | 239 | Traitement |
| 16 | 440.1.5.2.1 | 440.1.5.2.1 | Saisie comment annulation | Type0 | 318 | 135 | Saisie |
| 17 | 440.1.5.4 | 440.1.5.4 | Special actions | Type6 | 312 | 259 | Traitement |
| 18 | 440.1.5.4.2 | 440.1.5.4.2 | Saisie comment annulation | Type6 | 322 | 136 | Saisie |
| 19 | 440.1.5.4.3 | 440.1.5.4.3 | End of rental | Type6 | 384 | 305 | Traitement |
| 20 | 440.1.5.8.1 | 440.1.5.8.1 | Saisie comment annulation | Type0 | 318 | 135 | Saisie |
| 21 | 440.1.6 | 440.1.6 | Transac not PMS MBO | MDI | 695 | 143 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>440 - Main Sale V4
**Tache** : [440](#t1) | **Type** : Modal | **Dimensions** : 1990 x 392 DLU
...
| \Account Statement | 1012,76 | Bouton fonctionnel |
...
#### <a id="ecran-t2"></a>440.1 - Choix Onglet
**Tache** : [440.1](#t2) | **Type** : MDI | **Dimensions** : 987 x 261 DLU
...
#### <a id="ecran-t3"></a>440.1.1 - equipement
**Tache** : [440.1.1](#t3) | **Type** : Modal | **Dimensions** : 971 x 229 DLU
...
#### <a id="ecran-t4"></a>440.1.1.1 - Equipment check out
**Tache** : [440.1.1.1](#t4) | **Type** : MDI | **Dimensions** : 320 x 254 DLU
...
#### <a id="ecran-t7"></a>440.1.1.2 - Equipment list
**Tache** : [440.1.1.2](#t7) | **Type** : MDI | **Dimensions** : 269 x 280 DLU
...
#### <a id="ecran-t8"></a>440.1.1.2.1 - Equipment check out
**Tache** : [440.1.1.2.1](#t8) | **Type** : MDI | **Dimensions** : 322 x 282 DLU
**Bloc** : Traitement | **Titre IDE** : Equipment check out
...
#### <a id="ecran-t9"></a>440.1.1.2.2 - Equipment list
**Tache** : [440.1.1.2.2](#t9) | **Type** : MDI | **Dimensions** : 190 x 280 DLU
**Bloc** : Traitement | **Titre IDE** : Equipment list
...
#### <a id="ecran-t10"></a>440.1.1.2.2.1 - Equipment check IN
**Tache** : [440.1.1.2.2.1](#t10) | **Type** : Type6 | **Dimensions** : 642 x 281 DLU
...
#### <a id="ecran-t11"></a>440.1.2 - Booking_ID
**Tache** : [440.1.2](#t11) | **Type** : Modal | **Dimensions** : 973 x 248 DLU
...
| Appointment List | 286,201 | Appel [GetAppointment (IDE 161)](PVE-IDE-161.md) |

</details>

---

#### <a id="ecran-t13"></a>440.1.2.2 - Select Appointments
**Tache** : [440.1.2.2](#t13) | **Type** : Type6 | **Dimensions** : 1464 x 266 DLU
...
#### <a id="ecran-t15"></a>440.1.3 - Onglet Booking
**Tache** : [440.1.3](#t15) | **Type** : Modal | **Dimensions** : 976 x 239 DLU
...
#### <a id="ecran-t16"></a>440.1.3.1 - Booking
**Tache** : [440.1.3.1](#t16) | **Type** : Type6 | **Dimensions** : 440 x 136 DLU
...
#### <a id="ecran-t17"></a>440.1.3.2 - Screen
**Tache** : [440.1.3.2](#t17) | **Type** : Type6 | **Dimensions** : 1716 x 248 DLU
...
#### <a id="ecran-t20"></a>440.1.4 - Transac not PMS
**Tache** : [440.1.4](#t20) | **Type** : Modal | **Dimensions** : 973 x 248 DLU
...
#### <a id="ecran-t23"></a>440.1.5 - Sales and Payment
**Tache** : [440.1.5](#t23) | **Type** : Modal | **Dimensions** : 976 x 239 DLU
...
#### <a id="ecran-t29"></a>440.1.5.2.1 - Saisie comment annulation
**Tache** : [440.1.5.2.1](#t29) | **Type** : Type0 | **Dimensions** : 318 x 135 DLU
...
#### <a id="ecran-t31"></a>440.1.5.4 - Special actions
**Tache** : [440.1.5.4](#t31) | **Type** : Type6 | **Dimensions** : 312 x 259 DLU
...
#### <a id="ecran-t34"></a>440.1.5.4.2 - Saisie comment annulation
**Tache** : [440.1.5.4.2](#t34) | **Type** : Type6 | **Dimensions** : 322 x 136 DLU
**Bloc** : Saisie | **Titre IDE** : Saisie comment annulation
...
#### <a id="ecran-t35"></a>440.1.5.4.3 - End of rental
**Tache** : [440.1.5.4.3](#t35) | **Type** : Type6 | **Dimensions** : 384 x 305 DLU
...
#### <a id="ecran-t41"></a>440.1.5.8.1 - Saisie comment annulation
**Tache** : [440.1.5.8.1](#t41) | **Type** : Type0 | **Dimensions** : 318 x 135 DLU
**Bloc** : Saisie | **Titre IDE** : Saisie comment annulation
...
#### <a id="ecran-t44"></a>440.1.6 - Transac not PMS MBO
**Tache** : [440.1.6](#t44) | **Type** : MDI | **Dimensions** : 695 x 143 DLU
...
flowchart TD
    ...
    VF1[440 Main Sale V4]
    style VF1 fill:#58a6ff
    VF2[440.1 Choix Onglet]
    style VF2 fill:#58a6ff
    VF3[440.1.1 equipement]
    style VF3 fill:#58a6ff
    VF4[440.1.1.1 Equipment check out]
    style VF4 fill:#58a6ff
    VF7[440.1.1.2 Equipment list]
    style VF7 fill:#58a6ff
    VF8[440.1.1.2.1 Equipment check out]
    style VF8 fill:#58a6ff
    VF9[440.1.1.2.2 Equipment list]
    style VF9 fill:#58a6ff
    VF10[440.1.1.2.2.1 Equipment check IN]
    style VF10 fill:#58a6ff
    VF11[440.1.2 Booking_ID]
    style VF11 fill:#58a6ff
    VF13[440.1.2.2 Select Appointments]
    style VF13 fill:#58a6ff
    VF15[440.1.3 Onglet Booking]
    style VF15 fill:#58a6ff
    VF16[440.1.3.1 Booking]
    style VF16 fill:#58a6ff
    VF17[440.1.3.2 Screen]
    style VF17 fill:#58a6ff
    VF20[440.1.4 Transac not PMS]
    style VF20 fill:#58a6ff
    VF23[440.1.5 Sales and Payment]
    style VF23 fill:#58a6ff
    VF29[440.1.5.2.1 Saisie comment ann...]
    style VF29 fill:#58a6ff
    VF31[440.1.5.4 Special actions]
    style VF31 fill:#58a6ff
    VF34[440.1.5.4.2 Saisie comment ann...]
    style VF34 fill:#58a6ff
    VF35[440.1.5.4.3 End of rental]
    style VF35 fill:#58a6ff
    VF41[440.1.5.8.1 Saisie comment ann...]
    style VF41 fill:#58a6ff
    VF44[440.1.6 Transac not PMS MBO]
...
|----------|-------|------|------------|------|
| **440.1** | [**Main Sale V4** (440)](#t1) [mockup](#ecran-t1) | Modal | 1990x392 | Traitement |
| 440.1.1 | [equipement (440.1.1)](#t3) [mockup](#ecran-t3) | Modal | 971x229 | |
| 440.1.2 | [Equipment check out (440.1.1.1)](#t4) [mockup](#ecran-t4) | MDI | 320x254 | |
| 440.1.3 | [clear (440.1.1.1.1)](#t5) | MDI | - | |
| 440.1.4 | [Récupère Libellé Classif (440.1.1.1.2)](#t6) | - | - | |
| 440.1.5 | [Equipment list (440.1.1.2)](#t7) [mockup](#ecran-t7) | MDI | 269x280 | |
| 440.1.6 | [Equipment check out (440.1.1.2.1)](#t8) [mockup](#ecran-t8) | MDI | 322x282 | |
| 440.1.7 | [Equipment list (440.1.1.2.2)](#t9) [mockup](#ecran-t9) | MDI | 190x280 | |
| 440.1.8 | [Equipment check IN (440.1.1.2.2.1)](#t10) [mockup](#ecran-t10) | Type6 | 642x281 | |
| 440.1.9 | [Booking_ID (440.1.2)](#t11) [mockup](#ecran-t11) | Modal | 973x248 | |
| 440.1.10 | [Onglet Booking (440.1.3)](#t15) [mockup](#ecran-t15) | Modal | 976x239 | |
| 440.1.11 | [Booking (440.1.3.1)](#t16) [mockup](#ecran-t16) | Type6 | 440x136 | |
| 440.1.12 | [Screen (440.1.3.2)](#t17) [mockup](#ecran-t17) | Type6 | 1716x248 | |
| 440.1.13 | [GetBookigsInfo (440.1.3.3)](#t18) | - | - | |
| 440.1.14 | [Transac not PMS (440.1.4)](#t20) [mockup](#ecran-t20) | Modal | 973x248 | |
| 440.1.15 | [Get prod id (440.1.4.1)](#t21) | - | - | |
| 440.1.16 | [Get Cat & Subcat (440.1.4.2)](#t22) | - | - | |
| 440.1.17 | [Sales and Payment (440.1.5)](#t23) [mockup](#ecran-t23) | Modal | 976x239 | |
| 440.1.18 | [Payment (440.1.5.1)](#t24) [mockup](#ecran-t24) | MDI | 238x63 | |
| 440.1.19 | [View (440.1.5.1.2)](#t26) | - | - | |
| 440.1.20 | [Discount (440.1.5.2)](#t28) [mockup](#ecran-t28) | MDI | 220x94 | |
| 440.1.21 | [Test Prepaid (440.1.5.3)](#t30) | MDI | - | |
| 440.1.22 | [Special actions (440.1.5.4)](#t31) [mockup](#ecran-t31) | Type6 | 312x259 | |
| 440.1.23 | [Cancel other Packages (440.1.5.4.1)](#t32) [mockup](#ecran-t32) | Type6 | 312x259 | |
| 440.1.24 | [UpdateCustRentals (440.1.5.4.1.1)](#t33) | - | - | |
| 440.1.25 | [End of rental (440.1.5.4.3)](#t35) [mockup](#ecran-t35) | Type6 | 384x305 | |
| 440.1.26 | [UpdateCustRentals (440.1.5.4.4)](#t36) | - | - | |
| 440.1.27 | [Check Rentals (440.1.5.5)](#t37) | MDI | - | |
| 440.1.28 | [Check Payments (440.1.5.6)](#t38) [mockup](#ecran-t38) | MDI | 926x449 | |
| 440.1.29 | [Check Comment Refus. To Sell (440.1.5.7)](#t39) [mockup](#ecran-t39) | - | 522x498 | |
| 440.1.30 | [Discount (440.1.5.8)](#t40) [mockup](#ecran-t40) | MDI | 854x202 | |
| 440.1.31 | [Delete other Packages (440.1.5.9)](#t42) [mockup](#ecran-t42) | Type6 | 312x259 | |
| 440.1.32 | [Transac not PMS MBO (440.1.6)](#t44) [mockup](#ecran-t44) | MDI | 695x143 | |
| 440.1.33 | [SQL Total payement (440.1.6.1)](#t45) [mockup](#ecran-t45) | - | 115x195 | |
| **440.2** | [**Choix Onglet** (440.1)](#t2) [mockup](#ecran-t2) | MDI | 987x261 | Consultation |
| 440.2.1 | [Select Appointments (440.1.2.2)](#t13) [mockup](#ecran-t13) | Type6 | 1464x266 | |
| 440.2.2 | [Select all (440.1.2.2.1)](#t14) | - | - | |
| **440.3** | [**CreateSales** (440.1.2.1)](#t12) | - | - | Creation |
| 440.3.1 | [CreateMail (440.1.3.4)](#t19) | - | - | |
| 440.3.2 | [create cardType (440.1.5.1.3)](#t27) | MDI | - | |
| **440.4** | [**init payer** (440.1.5.1.1)](#t25) | MDI | - | Initialisation |
| **440.5** | [**Saisie comment annulation** (440.1.5.2.1)](#t29) [mockup](#ecran-t29) | - | 318x135 | Saisie |
| 440.5.1 | [Saisie comment annulation (440.1.5.4.2)](#t34) [mockup](#ecran-t34) | Type6 | 322x136 | |
| 440.5.2 | [Saisie comment annulation (440.1.5.8.1)](#t41) [mockup](#ecran-t41) | - | 318x135 | |
| **440.6** | [**Verif Multi-Payeurs comptes <>** (440.1.5.10)](#t43) [mockup](#ecran-t43) | - | 123x195 | Validation |
| **440.7** | [**calcul filiation** (440.2)](#t46) | MDI | - | Calcul |
...
| 1539 | Table_1539 |  | MEM | R |   | L | 8 |
| 1548 | Table_1548 |  | MEM |   | **W** | L | 4 |
| 1550 | Table_1550 |  | MEM |   |   | L | 3 |

### Colonnes par table (18 / 14 tables avec colonnes identifiees)
...
<details>
<summary>Table 380 - pv_day_modes (R/L) - 7 usages</summary>
...
<details>
<summary>Table 382 - pv_discount_reasons (R/L) - 14 usages</summary>
...
| E | v.color | R | Numeric |
| F | bt swap | R | Alpha |
| G | V.Exchange automatique | R | Logical |
...
<details>
<summary>Table 400 - pv_cust_rentals (R/L) - 17 usages</summary>

| Lettre | Variable | Acces | Type |
|--------|----------|-------|------|
| A | P.CustomerID | R | Numeric |
| B | V days difference | R | Numeric |
| C | V allow cancel | R | Logical |
| D | V Total | R | Numeric |
| E | V.Clause where | R | Alpha |
| F | V.Add jointure | R | Alpha |
| G | V.NumberDaysAFacturé | R | Numeric |
...
<details>
<summary>Table 403 - pv_sellers (R/L) - 12 usages</summary>
...
<details>
<summary>Table 404 - pv_sellers_by_week (**W**/L) - 8 usages</summary>
...
<details>
<summary>Table 1539 - Table_1539 (R/L) - 8 usages</summary>
...
| E | Exists? | R | Logical |
| F | v.AppointmentsSelected | R | Logical |

</details>

<details>
<summary>Table 1548 - Table_1548 (**W**/L) - 4 usages</summary>

| Lettre | Variable | Acces | Type |
|--------|----------|-------|------|
| A | P.Valider | W | Logical |
| B | v.DateDebut | W | Date |
| C | v.DateFin | W | Date |
| D | v.NbrSelected | W | Numeric |
| E | Btn.Refresh | W | Alpha |
| F | CHG_REASON_Select | W | Numeric |
| G | CHG_PRV_Select | W | Logical |
...
| C | v.Update Tab Filiation | Logical | [440.2](#t46) |
| D | v.Decimal | Numeric | - |
...
| P | V PoS payer id from card | Numeric | [440.1.5.1.1](#t25), [440.1.5.1.3](#t27) |
| Q | V pms account from card | Numeric | [440.1.5.1.3](#t27) |
| R | V pms filiation from card | Numeric | [440.1.5.1.3](#t27), [440.2](#t46) |
| S | V Club Med Pass | Alpha | 1x session |
| T | v.LequipementID | Alpha | 1x session |
| U | v.Garantie | Unicode | 3x session |
...
| BL | V Lien Compte Seminaire | Logical | [440.1.5.10](#t43) |
...
| BT | V.dateSolde | Date | - |
| BU | V.GarantieO/N | Alpha | 1x session |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONDITION | 47 | `IF([AY],'Yes','No')` | [RM-012](#rm-RM-012) |
| CONDITION | 40 | `IF(NOT(VG18),[BV],V.GarantieO/N [BU])` | [RM-010](#rm-RM-010) |
| CONDITION | 21 | `IF(VG17<>[AO] OR v.Update Tab Filiation [C],Trim (Str ([AN],'3')),v.Tab_Filation1 [A])` | [RM-009](#rm-RM-009) |
| CONDITION | 76 | `IF([CL],'Booking',IF(Trim(VG59)<>'',VG59,'Sale'))` | [RM-013](#rm-RM-013) |
| CONDITION | 100 | `IF(Trim(V."Best of" Interdit M... [BO])='CLUB' AND V.CodeRerourExtraitCompte [BQ]='R',Translate('%club_images%garantie_club.bmp'),Translate('%club_images%garantie.bmp'))` | [RM-016](#rm-RM-016) |
| ... | | *+24 autres* | |
...
| 17 | `IF([BW]='V','VIP',IF([BW]='T','TOP VIP',''))` |
| 18 | `IF(Trim(v.Libelle VIP [Z])<>'',Trim(v.Libelle VIP [Z]),Trim([CG]))` |
...
| 40 | `IF(NOT(VG18),[BV],V.GarantieO/N [BU])` |
| 47 | `IF([AY],'Yes','No')` |
| 76 | `IF([CL],'Booking',IF(Trim(VG59)<>'',VG59,'Sale'))` |
| 84 | `IF(VG89='',247.5,123.7)` |
| 87 | `IF(VG89='',200.625,100)` |
| 98 | `IF([DB]<>0,'N11.'&Trim(Str([DB],'#'))&'CZ','N13CZ')` |
| 100 | `IF(Trim(V."Best of" Interdit M... [BO])='CLUB' AND V.CodeRerourExtraitCompte [BQ]='R',Translate('%club_images%garantie_club.bmp'),Translate('%club_images%garantie.bmp'))` |
| 6 | `VG17<>0` |
| 7 | `[AF]=6` |
| 15 | `V Lien Compte Seminaire [BL]='R'` |
| 16 | `[BY]='O'` |
...
| 86 | `VG89<>''` |
| 94 | `VG92 AND VG89<>''` |
| 95 | `[AO]<>0 AND (NOT(VG92) OR (VG92 AND NOT([CS])))` |
| 99 | `VG93 AND [AM] <> 0` |
| 34 | `Trim(VG38)<>''` |
| 93 | `VG92 AND [CR] AND ([AU]<>0 AND [AU]<Val([CN],'2'))` |
...
Main -> ... -> [Menu==V4___ (IDE 420)](PVE-IDE-420.md) -> **Main Sale (IDE 440)**

Main -> ... -> [Menu (IDE 439)](PVE-IDE-439.md) -> **Main Sale (IDE 440)**

```mermaid
graph LR
    T440[440 Main Sale]
    style T440 fill:#58a6ff
    CC439[439 Menu]
...
|----------|--------|-----------------|
| Lignes de logique | 2117 | Programme volumineux |
| Expressions | 100 | Logique moderee |
| Tables WRITE | 4 | Impact modere |
| Sous-programmes | 20 | Forte dependance |
| Ecrans visibles | 21 | Interface complexe multi-ecrans |
| Code desactive | 0.8% (17 / 2117) | Code sain |
| Regles metier | 16 | Logique metier riche |

### 14.2 Plan de migration par bloc

#### Traitement (34 taches: 24 ecrans, 10 traitements)

- **Strategie** : Orchestrateur avec 24 ecrans (Razor/React) et 10 traitements backend (services).
...
- 2 ecrans : Choix Onglet, Select Appointments
...
| [Browse - pv_comptab (IDE 446)](PVE-IDE-446.md) | Sous-programme | 4x | **CRITIQUE** - Sous-programme |
...
| [Generate Preview Payments (IDE 441)](PVE-IDE-441.md) | Sous-programme | 2x | Haute - Sous-programme |
