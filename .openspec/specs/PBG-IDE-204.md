# PBG IDE 204 - Lco  -> Tempouserlist

> **Analyse**: Phases 1-4 2026-02-03 10:10 -> 10:11 (19s) | Assemblage 10:11
...
**Lco  -> Tempouserlist** assure la gestion complete de ce processus, accessible depuis [Recherche Logement (IDE 119)](PBG-IDE-119.md).
...
#### <a id="t1"></a>204 - Veuillez patienter ... [[ECRAN]](#ecran-t1)
...
|----------|-------|------|------------|------|
| **204.1** | [**Veuillez patienter ...** (204)](#t1) [mockup](#ecran-t1) | MDI | 427x57 | Traitement |
...
Main -> ... -> [Recherche Logement (IDE 119)](PBG-IDE-119.md) -> **Lco  -> Tempouserlist (IDE 204)**

```mermaid
graph LR
    T204[204 Lco - Tempouserlist]
