# REF IDE 63 - Browse - initialisation___ini
...
| Projet | REF |
| IDE Position | 63 |
| Nom Programme | Browse - initialisation___ini |
...
**Browse - initialisation___ini** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>63 - Browse - initialisation___ini

**Role** : Reinitialisation : Browse - initialisation___ini.
...
|----------|-------|------|------------|------|
| **63.1** | [**Browse - initialisation___ini** (63)](#t1) | - | - | Initialisation |
