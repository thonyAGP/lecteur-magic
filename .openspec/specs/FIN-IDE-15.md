# FIN IDE 15 - Count table SQL

> **Analyse**: Phases 1-4 2026-02-03 11:22 -> 11:22 (13s) | Assemblage 11:22
...
|----------|-------|------|------------|------|
| **15.1** | [**Count table SQL** (15)](#t1) | - | - | Traitement |
...
| Lettre | Nom | Type | Usage dans |
|--------|-----|------|-----------|
| B | V.Nb enreg SQL | Numeric | 1x session |
