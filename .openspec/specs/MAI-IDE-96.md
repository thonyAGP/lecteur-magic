...
**Zoom services** assure la gestion complete de ce processus, accessible depuis [Pointage Tables REF et Params (IDE 34)](MAI-IDE-34.md).
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 96 | 96 | Zoom service | MDI | 523 | 169 | Consultation |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>96 - Zoom service
**Tache** : [96](#t1) | **Type** : MDI | **Dimensions** : 523 x 169 DLU
...
|----------|-------|------|------------|------|
| **96.1** | [**Zoom service** (96)](#t1) [mockup](#ecran-t1) | MDI | 523x169 | Consultation |
...
Main -> ... -> [Pointage Tables REF et Params (IDE 34)](MAI-IDE-34.md) -> **Zoom services (IDE 96)**

```mermaid
graph LR
    T96[96 Zoom services]
