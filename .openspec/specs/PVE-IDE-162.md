...
**TakeDeposit** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>162 - TakeDeposit

**Role** : Traitement : TakeDeposit.
...
|----------|-------|------|------------|------|
| **162.1** | [**TakeDeposit** (162)](#t1) | - | - | Traitement |
...
| Lettre | Nom | Type | Usage dans |
|--------|-----|------|-----------|
| B | PaymentMethodeID | Numeric | 1x refs |
...
| FORMAT | 5 | `'{
    ...
    "PaymentItem": {
        "Method": {
            "ID": ' & Trim(Str(PaymentMethodeID [B],'10')) & ',
            "Name": ""
        }
    },
    "PaymentItemID": null,
    "IsClassAppointment": true,
    "ID": ' & Trim(Str(P.OrderID [A],'18')) & ',
    "ReturnPartialOrderObject": null,
    "access_token": "' & Trim(Token [C]) & '"
}'` | - |
| FORMAT | 4 | `Trim(VG66) & '/v4.1/merchant/order/' & Trim(Str(P.OrderID [A],'18')) & '/deposit'` | - |
| FORMAT | 3 | `Trim(VG66) & '/order/' & Trim(Str(P.OrderID [A],'18')) & '/deposit'` | - |

#### CONCATENATION (1 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 6 | `'<?xml version="1.0" encoding="UTF-8"?>' &ASCIIChr(13)& ASCIIChr(10)&DotNet.System.Xml.Linq.XElement.Load(  DotNet.System.Runtime.Serialization.Json.JsonReaderWriterFactory.CreateJsonReader( JsonResponse [L],DotNet.System.Xml.XmlDictionaryReaderQuotas()   )).ToString()` | - |
