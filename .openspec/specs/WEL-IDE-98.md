...
**Email workflow** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>98 - Email workflow

**Role** : Traitement : Email workflow.
...
|----------|-------|------|------------|------|
| **98.1** | [**Email workflow** (98)](#t1) | - | - | Traitement |
