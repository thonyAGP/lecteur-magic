...
- **Fonction**: RaZ 609 tempo bateau
- **Tables modifiees**: 0
- **Complexite**: **BASSE** (0/100)
- **Statut**: NON_ORPHELIN
- **Raison**: Appele par 17 programme(s): Liste CLients AVPBDR (IDE 174),   Liste personnels AVPBDR (IDE 234), Liste des arrivants (IDE 155),   Liste CLients arrivant (IDE 156), Liste des arrivees (IDE 160), Liste des presents (IDE 161),   Liste Clients present (IDE 162), Liste des departs (IDE 167),   Liste CLients depart (IDE 168), Liste des partants (IDE 172), Liste des Absents (IDE 173), Liste des arrivants personnel (IDE 224), Liste des arrivees personnel (IDE 225), Liste des presents personnel (IDE 226), Liste des Absents personnel (IDE 231), Liste des departs personnel (IDE 232), Liste des partants personnel (IDE 233)
