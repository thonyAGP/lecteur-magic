...
| Projet | PBG |
| IDE Position | 28 |
| Nom Programme | Browse - IMPORT Mod |
...
**Browse - IMPORT Mod** assure la gestion complete de ce processus, accessible depuis [Dispatch (IDE 96)](PBG-IDE-96.md).
...
#### <a id="t1"></a>28 - Browse - IMPORT Mod [[ECRAN]](#ecran-t1)

**Role** : Traitement : Browse - IMPORT Mod.
...
#### <a id="rm-RM-001"></a>[RM-001] Si GetParam ('CODE_DOSSIER')=[D] alors 144 sinon 110)

| Element | Detail |
|---------|--------|
| **Condition** | `GetParam ('CODE_DOSSIER')=[D]` |
| **Si vrai** | 144 |
| **Si faux** | 110) |
| **Expression source** | Expression 3 : `IF (GetParam ('CODE_DOSSIER')=[D],144,110)` |
| **Exemple** | Si GetParam ('CODE_DOSSIER')=[D] â†’ 144. Sinon â†’ 110) |
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 28 | 28 | Browse - IMPORT Mod | MDI | 780 | 208 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>28 - Browse - IMPORT Mod
**Tache** : [28](#t1) | **Type** : MDI | **Dimensions** : 780 x 208 DLU
**Bloc** : Traitement | **Titre IDE** : Browse - IMPORT Mod
    ...
    "controls":  [
                     {
                         ...
                         "cols":  [
                                      ...
                                      {
                                          "title":  "Date de la modif",
                                          "layer":  3,
                                          "w":  72
                                      },
                                      {
                                          "title":  "Modif effectuée",
                                          "layer":  4,
                                          "w":  63
                                      }
                                  ],
...
|-----------|-----|----------|------|
| 251,18 | (sans nom) | - | edit |
| 320,18 | (sans nom) | - | edit |
| 384,18 | (sans nom) | - | edit |
| 456,18 | (sans nom) | - | edit |
...
Ecran unique: **Browse - IMPORT Mod**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **28.1** | [**Browse - IMPORT Mod** (28)](#t1) [mockup](#ecran-t1) | MDI | 780x208 | Traitement |
...
|------|-----|------------|-------|
| CONDITION | 3 | `IF (GetParam ('CODE_DOSSIER')=[D],144,110)` | [RM-001](#rm-RM-001) |

#### OTHER (2 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 2 | `GetParam ('CODE_DOSSIER')` | - |
...
Main -> ... -> [Dispatch (IDE 96)](PBG-IDE-96.md) -> **Browse - IMPORT Mod (IDE 28)**

```mermaid
graph LR
    T28[28 Browse - IMPORT Mod]
