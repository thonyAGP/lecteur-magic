...
**Browse - new_asd** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>125 - Browse - new_asd

**Role** : Traitement : Browse - new_asd.
...
|----------|-------|------|------------|------|
| **125.1** | [**Browse - new_asd** (125)](#t1) | - | - | Traitement |
