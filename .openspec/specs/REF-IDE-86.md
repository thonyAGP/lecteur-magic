# REF IDE 86 - Browse - point_de_vente___pdv
...
| Projet | REF |
| IDE Position | 86 |
| Nom Programme | Browse - point_de_vente___pdv |
...
**Browse - point_de_vente___pdv** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>86 - Browse - point_de_vente___pdv

**Role** : Saisie des donnees : Browse - point_de_vente___pdv.
...
|----------|-------|------|------------|------|
| **86.1** | [**Browse - point_de_vente___pdv** (86)](#t1) | - | - | Saisie |
