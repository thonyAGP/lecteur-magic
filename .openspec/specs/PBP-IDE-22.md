# PBP IDE 22 - Edit securite GM Muster P2
...
| Projet | PBP |
| IDE Position | 22 |
| Nom Programme | Edit securite GM Muster P2 |
...
**Edit securite GM Muster P2** assure la gestion complete de ce processus, accessible depuis [Centralisation nbre edition (IDE 20)](PBP-IDE-20.md).
...
#### <a id="rm-RM-001"></a>[RM-001] Si [N] alors 'H' sinon '')
...
| **Si vrai** | 'H' |
| **Si faux** | '') |
| **Expression source** | Expression 14 : `IF ([N],'H','')` |
| **Exemple** | Si [N] â†’ 'H'. Sinon â†’ '') |
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 22 | 22 | Veuillez patienter... | MDI | 424 | 56 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>22 - Veuillez patienter...
**Tache** : [22](#t1) | **Type** : MDI | **Dimensions** : 424 x 56 DLU
...
|----------|-------|------|------------|------|
| **22.1** | [**Veuillez patienter...** (22)](#t1) [mockup](#ecran-t1) | MDI | 424x56 | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONDITION | 14 | `IF ([N],'H','')` | [RM-001](#rm-RM-001) |
| CONDITION | 13 | `Range (> date [A],[O],[P]-1)` | - |
...
Main -> ... -> [Centralisation nbre edition (IDE 20)](PBP-IDE-20.md) -> **Edit securite GM Muster P2 (IDE 22)**

```mermaid
graph LR
    T22[22 Edit securite GM Mu...]
