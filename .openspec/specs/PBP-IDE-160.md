# PBP IDE 160 - Liste des arrivees
...
| Projet | PBP |
| IDE Position | 160 |
| Nom Programme | Liste des arrivees |
...
**Liste des arrivees** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>160 - Liste des arrivees

**Role** : Traitement : Liste des arrivees.
...
|----------|-------|------|------------|------|
| **160.1** | [**Liste des arrivees** (160)](#t1) | MDI | - | Traitement |
