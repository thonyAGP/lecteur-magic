# PBP IDE 69 - Deficit GO sejour et repas V3
...
| Projet | PBP |
| IDE Position | 69 |
| Nom Programme | Deficit GO sejour et repas V3 |
...
**Deficit GO sejour et repas V3** assure la gestion complete de ce processus, accessible depuis [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md).
...
#### <a id="t1"></a>69 - Deficit GE V3 [[ECRAN]](#ecran-t1)

**Role** : Traitement : Deficit GE V3.
**Ecran** : 907 x 631 DLU | [Voir mockup](#ecran-t1)
...
| **Expression source** | Expression 31 : `IF([AQ]<P.Gestion crise ? [F],P.Gestion crise ? [F],[AQ])` |
...
| **Expression source** | Expression 32 : `IF([AS]>V.Nb JH du mois [G],V.Nb JH du mois [G],[AS])` |
...
- **Appelle**: 0 programmes | **Tables**: 3 (W:0 R:1 L:2) | **Taches**: 1 | **Expressions**: 47
...
|----------|-------|------|------------|------|
| **69.1** | [**Deficit GE V3** (69)](#t1) [mockup](#ecran-t1) | - | 907x631 | Traitement |
...
| S | V.nombre personnes | R | Numeric |
...
| V. | **S** | V.nombre personnes | Numeric |

</details>

## 12. EXPRESSIONS

**47 / 47 expressions decodees (100%)**
...
|------|-----|------------|-------|
| CALCULATION | 46 | `[EX]+(([EI]+[EM])/2)` | - |
| CALCULATION | 47 | `[ES]+([EI]+[EM])` | - |
| CALCULATION | 45 | `[AO]+(([EI]+[EM])/2)` | - |
| CALCULATION | 23 | `Fill('-',30)` | - |
| CALCULATION | 28 | `[AN]+[AO]` | - |

#### CONDITION (11 expressions)

| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONDITION | 32 | `IF([AS]>V.Nb JH du mois [G],V.Nb JH du mois [G],[AS])` | [RM-002](#rm-RM-002) |
| CONDITION | 31 | `IF([AQ]<P.Gestion crise ? [F],P.Gestion crise ? [F],[AQ])` | [RM-001](#rm-RM-001) |
| CONDITION | 38 | `[AQ]<[DH] OR [DH]=0` | - |
| CONDITION | 34 | `[BW]>[DE] OR [DE]=0` | - |
| CONDITION | 42 | `[AO]<>0 AND [EB]=''` | - |
| ... | | *+6 autres* | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| FORMAT | 5 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim([BU])&IF([CT]<>'','_'&Trim([CT])&'_','_')&'EFF_Deficit_GO_'&IF([DG],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` | - |
...
### 12.3 Toutes les expressions (47)

<details>
<summary>Voir les 47 expressions</summary>
...
| IDE | Expression Decodee |
|-----|-------------------|
| 31 | `IF([AQ]<P.Gestion crise ? [F],P.Gestion crise ? [F],[AQ])` |
| 32 | `IF([AS]>V.Nb JH du mois [G],V.Nb JH du mois [G],[AS])` |
| 3 | `[EB]<>'' AND [ES]<>0` |
| 4 | `[EA]='LOC' OR [EA]='VILL'` |
| 15 | `CndRange([CT]<>'',[CT])` |
| 20 | `[CT]<>''` |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 5 | `Trim(Translate('%club_exportdata%'))&'trsft\'&Trim([BU])&IF([CT]<>'','_'&Trim([CT])&'_','_')&'EFF_Deficit_GO_'&IF([DG],Trim(DStr(Date()-2,'YYYYMM')),Trim(DStr(Date(),'YYYYMM')))&'.htm'` |
...
| 8 | `P.Date fin [B]` |
| 9 | `P.Code village [C]` |
| 10 | `P.Gestion crise ? [F]` |
| 11 | `V.Nb JH du mois [G]` |
| 13 | `Day(EOM(P.Gestion crise ? [F]))` |
| 14 | `CMonth(P.Gestion crise ? [F])` |
| 16 | `[ED]` |
| 17 | `[DZ]` |
| 18 | `[EA]` |
| 19 | `[EE]` |
...
| 29 | `[BV]` |
| 30 | `[BW]` |
| 35 | `V.Nb JH du mois [G]` |
| 36 | `P.Gestion crise ? [F]` |
| 37 | `[AQ]` |
| 39 | `[AS]` |
| 43 | `[DL]` |
| 44 | `[DM]` |
...
Main -> ... -> [Edition effectif mensuel V3 (IDE 66)](PBP-IDE-66.md) -> **Deficit GO sejour et repas V3 (IDE 69)**

```mermaid
graph LR
    T69[69 Deficit GO sejour e...]
