...
| Projet | REF |
| IDE Position | 314 |
| Nom Programme | Browse - fra_trafic |
...
**Browse - fra_trafic** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>314 - Browse - fra_trafic

**Role** : Traitement : Browse - fra_trafic.
...
|----------|-------|------|------------|------|
| **314.1** | [**Browse - fra_trafic** (314)](#t1) | - | - | Traitement |
