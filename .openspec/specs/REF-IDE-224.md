# REF IDE 224 - Browse - gestion_devise_sessio
...
| Projet | REF |
| IDE Position | 224 |
| Nom Programme | Browse - gestion_devise_sessio |
...
**Browse - gestion_devise_sessio** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>224 - Browse - gestion_devise_sessio

**Role** : Gestion du moyen de paiement : Browse - gestion_devise_sessio.
...
|----------|-------|------|------------|------|
| **224.1** | [**Browse - gestion_devise_sessio** (224)](#t1) | - | - | Traitement |
