...
> **Analyse**: Phases 1-4 2026-02-03 14:55 -> 14:55 (9s) | Assemblage 14:55
...
**Abandon** assure la gestion complete de ce processus, accessible depuis [Main Program (IDE 1)](MAI-IDE-1.md).
...
|----------|-------|------|------------|------|
| **49.1** | [**Abandon** (49)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Main Program (IDE 1)](MAI-IDE-1.md) -> **Abandon (IDE 49)**
