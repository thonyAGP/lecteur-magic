# PBP IDE 155 - Liste des arrivants
...
| Projet | PBP |
| IDE Position | 155 |
| Nom Programme | Liste des arrivants |
...
**Liste des arrivants** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>155 - Liste des arrivants

**Role** : Traitement : Liste des arrivants.
**Variables liees** : B (CodeListe), C (TypeListe)
**Delegue a** : [  Liste CLients arrivant (IDE 156)](PBP-IDE-156.md), [Qua -> Tempo userlist (IDE 306)](PBP-IDE-306.md)
...
|----------|-------|------|------------|------|
| **155.1** | [**Liste des arrivants** (155)](#t1) | MDI | - | Traitement |
...
|-----|---------------|--------|----------|
| [156](PBP-IDE-156.md) |   Liste CLients arrivant | 1 | Configuration impression |
...
| [  Liste CLients arrivant (IDE 156)](PBP-IDE-156.md) | Sous-programme | 1x | Normale - Configuration impression |
