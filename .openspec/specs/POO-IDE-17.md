# POO IDE 17 - CB Transfert fichiers GM
...
**CB Transfert fichiers GM** assure la gestion complete de ce processus, accessible depuis [Batch sur PABX (IDE 24)](POO-IDE-24.md).
...
Delegue a : [Gestion FTP (IDE 22)](POO-IDE-22.md)
...
- **Appelle**: 1 programmes | **Tables**: 10 (W:1 R:1 L:8) | **Taches**: 4 | **Expressions**: 12
...
Variables recues du programme appelant ([Batch sur PABX (IDE 24)](POO-IDE-24.md)).
...
Main -> ... -> [Batch sur PABX (IDE 24)](POO-IDE-24.md) -> **CB Transfert fichiers GM (IDE 17)**
...
|-----|---------------|--------|----------|
| [22](POO-IDE-22.md) | Gestion FTP | 2 | Gestion moyens paiement |
...
| [Gestion FTP (IDE 22)](POO-IDE-22.md) | Sous-programme | 2x | Haute - Gestion moyens paiement |
