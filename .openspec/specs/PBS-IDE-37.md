# PBS IDE 37 - Existant Log Std (Perso)

> **Analyse**: Phases 1-4 2026-02-03 17:12 -> 17:12 (12s) | Assemblage 17:12
...
| Projet | PBS |
| IDE Position | 37 |
| Nom Programme | Existant Log Std (Perso) |
...
**Existant Log Std (Perso)** assure la gestion complete de ce processus, accessible depuis [Logement personnel (IDE 34)](PBS-IDE-34.md).
...
#### <a id="t1"></a>37 - Existant Log Std (Perso)

**Role** : Traitement : Existant Log Std (Perso).
...
|----------|-------|------|------------|------|
| **37.1** | [**Existant Log Std (Perso)** (37)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Logement personnel (IDE 34)](PBS-IDE-34.md) -> **Existant Log Std (Perso) (IDE 37)**

```mermaid
graph LR
    T37[37 Existant Log Std Perso]
