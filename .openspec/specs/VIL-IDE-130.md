...
**Reprise age** assure la gestion complete de ce processus, accessible depuis [Traitement integrite base (IDE 124)](VIL-IDE-124.md).
...
|----------|-------|------|------------|------|
| **130.1** | [**Reprise age** (130)](#t1) | - | - | Traitement |
...
Main -> ... -> [Traitement integrite base (IDE 124)](VIL-IDE-124.md) -> **Reprise age (IDE 130)**

```mermaid
graph LR
    T130[130 Reprise age]
