# POO IDE 20 - Log OD Eurocave

> **Analyse**: Phases 1-4 2026-02-03 17:42 -> 17:42 (15s) | Assemblage 17:42
...
**Log OD Eurocave** assure la gestion complete de ce processus, accessible depuis [Transfert ODS Boutique (IDE 16)](POO-IDE-16.md).
...
- **Appele par**: [Transfert ODS Boutique (IDE 16)](POO-IDE-16.md)
...
|----------|-------|------|------------|------|
| **20.1** | [**Log OD Eurocave** (20)](#t1) | MDI | - | Traitement |
...
|------|-----|------------|-------|
| OTHER | 3 | `Time ()` | - |
| OTHER | 1 | `Translate('%env%')&'Log_Eurocave.txt'` | - |
...
Main -> ... -> [Transfert ODS Boutique (IDE 16)](POO-IDE-16.md) -> **Log OD Eurocave (IDE 20)**

```mermaid
graph LR
    T20[20 Log OD Eurocave]
