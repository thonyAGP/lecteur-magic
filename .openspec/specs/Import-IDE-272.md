# Import IDE 272 - Import - participants_____par
...
| Projet | Import |
| IDE Position | 272 |
| Nom Programme | Import - participants_____par |
...
**Import - participants_____par** assure la gestion complete de ce processus, accessible depuis [Lanceur (IDE 2)](Import-IDE-2.md).
...
#### <a id="t1"></a>272 - Import - participants_____par

**Role** : Traitement : Import - participants_____par.
...
|----------|-------|------|------------|------|
| **272.1** | [**Import - participants_____par** (272)](#t1) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 2 | `Trim(INIGet('[MAGIC_LOGICAL_NAMES]import'))&'excupar.txt'` | - |
...
Main -> ... -> [Lanceur (IDE 2)](Import-IDE-2.md) -> **Import - participants_____par (IDE 272)**

```mermaid
graph LR
    T272[272 Import - participa...]
