# MAI IDE 9 - Imp gratuites à modifier
...
| Projet | MAI |
| IDE Position | 9 |
| Nom Programme | Imp gratuites à modifier |
...
**Imp gratuites à modifier** assure la gestion complete de ce processus, accessible depuis [MAJ plan comptable (IDE 35)](MAI-IDE-35.md).
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 9 | 9 | Veuillez patienter ..... | MDI | 422 | 56 | Traitement |
...
**Tache** : [9](#t1) | **Type** : MDI | **Dimensions** : 422 x 56 DLU
...
|----------|-------|------|------------|------|
| **9.1** | [**Veuillez patienter .....** (9)](#t1) [mockup](#ecran-t1) | MDI | 422x56 | Traitement |
...
| Lettre | Nom | Type | Usage dans |
|--------|-----|------|-----------|
| D | EXISTE IMPUTATION | Logical | 1x refs |
...
| CONCATENATION | 12 | `Trim ([M])&'-'&Trim ([N])` | - |
...
Main -> ... -> [MAJ plan comptable (IDE 35)](MAI-IDE-35.md) -> **Imp gratuites à modifier (IDE 9)**

```mermaid
graph LR
    T9[9 Imp gratuites à modi...]
