# PBG IDE 371 - -- Sauvegarde avant Modif --
...
| Projet | PBG |
| IDE Position | 371 |
| Nom Programme | -- Sauvegarde avant Modif -- |
...
**-- Sauvegarde avant Modif --** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>371 - -- Sauvegarde avant Modif --

**Role** : Traitement : -- Sauvegarde avant Modif --.
...
|----------|-------|------|------------|------|
| **371.1** | [**-- Sauvegarde avant Modif --** (371)](#t1) | - | - | Traitement |
