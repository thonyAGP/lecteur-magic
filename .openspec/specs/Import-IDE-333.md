# Import IDE 333 - Import - pv_height

> **Analyse**: Phases 1-4 2026-02-03 14:01 -> 14:02 (15s) | Assemblage 14:02
...
| Projet | Import |
| IDE Position | 333 |
| Nom Programme | Import - pv_height |
...
**Import - pv_height** assure la gestion complete de ce processus, accessible depuis [Lanceur (IDE 2)](Import-IDE-2.md).
...
#### <a id="t1"></a>333 - Import - pv_height

**Role** : Traitement : Import - pv_height.
...
|----------|-------|------|------------|------|
| **333.1** | [**Import - pv_height** (333)](#t1) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 2 | `Trim(INIGet('[MAGIC_LOGICAL_NAMES]import'))&'pv_height.txt'` | - |
...
Main -> ... -> [Lanceur (IDE 2)](Import-IDE-2.md) -> **Import - pv_height (IDE 333)**

```mermaid
graph LR
    T333[333 Import - pv_height]
