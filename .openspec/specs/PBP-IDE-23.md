# PBP IDE 23 - Edit securite GM Alpha P3
...
| Projet | PBP |
| IDE Position | 23 |
| Nom Programme | Edit securite GM Alpha P3 |
...
**Edit securite GM Alpha P3** assure la gestion complete de ce processus, accessible depuis [Centralisation nbre edition (IDE 20)](PBP-IDE-20.md).
...
#### <a id="rm-RM-001"></a>[RM-001] Si [O] alors 'H' sinon '')
...
| **Si vrai** | 'H' |
| **Si faux** | '') |
| **Expression source** | Expression 15 : `IF ([O],'H','')` |
| **Exemple** | Si [O] â†’ 'H'. Sinon â†’ '') |
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 23 | 23 | Veuillez patienter... | MDI | 429 | 60 | Traitement |
...
**Tache** : [23](#t1) | **Type** : MDI | **Dimensions** : 429 x 60 DLU
...
|----------|-------|------|------------|------|
| **23.1** | [**Veuillez patienter...** (23)](#t1) [mockup](#ecran-t1) | MDI | 429x60 | Traitement |
...
| CONCATENATION | 8 | `'Zone '&Trim (Str ([J],'10'))&'          Pont '&[K]` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONDITION | 15 | `IF ([O],'H','')` | [RM-001](#rm-RM-001) |
| CONDITION | 14 | `Range (> date [A],[P],[Q]-1)` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 12 | `v. rupture [C]` | - |
| OTHER | 13 | `v. passage [D]` | - |
...
Main -> ... -> [Centralisation nbre edition (IDE 20)](PBP-IDE-20.md) -> **Edit securite GM Alpha P3 (IDE 23)**

```mermaid
graph LR
    T23[23 Edit securite GM Al...]
