# EXB IDE 33 - Recuperation langue
...
**Recuperation langue** assure la gestion complete de ce processus, accessible depuis [Start (IDE 32)](EXB-IDE-32.md).
...
#### <a id="t1"></a>33 - Recuperation langue
...
|----------|-------|------|------------|------|
| **33.1** | [**Recuperation langue** (33)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Start (IDE 32)](EXB-IDE-32.md) -> **Recuperation langue (IDE 33)**

```mermaid
graph LR
    T33[33 Recuperation langue]
