# Import IDE 171 - Import - parametres_pme___pap
...
| Projet | Import |
| IDE Position | 171 |
| Nom Programme | Import - parametres_pme___pap |
...
**Import - parametres_pme___pap** assure la gestion complete de ce processus, accessible depuis [Lanceur (IDE 2)](Import-IDE-2.md).
...
#### <a id="t1"></a>171 - Import - parametres_pme___pap

**Role** : Traitement : Import - parametres_pme___pap.
...
|----------|-------|------|------------|------|
| **171.1** | [**Import - parametres_pme___pap** (171)](#t1) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 2 | `Trim(INIGet('[MAGIC_LOGICAL_NAMES]import'))&'cafil196.txt'` | - |
...
Main -> ... -> [Lanceur (IDE 2)](Import-IDE-2.md) -> **Import - parametres_pme___pap (IDE 171)**

```mermaid
graph LR
    T171[171 Import - parametre...]
