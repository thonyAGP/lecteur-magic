# PBP IDE 386 - Creation tempo aniversaire GO

> **Analyse**: Phases 1-4 2026-02-03 16:43 -> 16:44 (13s) | Assemblage 16:44
...
| Projet | PBP |
| IDE Position | 386 |
| Nom Programme | Creation tempo aniversaire GO |
...
**Creation tempo aniversaire GO** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>386 - Veuillez patienter ... [[ECRAN]](#ecran-t1)
...
#### <a id="t2"></a>386.1 - Enregistrement Personne
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 386 | 386 | Veuillez patienter ... | MDI | 424 | 56 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>386 - Veuillez patienter ...
**Tache** : [386](#t1) | **Type** : MDI | **Dimensions** : 424 x 56 DLU
...
|----------|-------|------|------------|------|
| **386.1** | [**Veuillez patienter ...** (386)](#t1) [mockup](#ecran-t1) | MDI | 424x56 | Traitement |
| 386.1.1 | [Enregistrement Personne (386.1)](#t2) | MDI | - | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CALCULATION | 10 | `Val (MID (Str (Year ([S]),'4'),1,1),'1')*10000+Month ([S])*100+Day ([S])` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 12 | `DVal (Str (Day ([S]),'2P0')&Str (Month ([S]),'2P0')&IF (w0_BorneDebut [E]<=w0_DateNaissance [K] AND w0_BorneFin [F]>=w0_DateNaissance [K],Str (Year (>DateDebut [A]),'4P0'),Str (Year (>DateFin [B]),'4P0')),'DDMMYYYY')` | - |
