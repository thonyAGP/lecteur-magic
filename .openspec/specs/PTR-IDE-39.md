# PTR IDE 39 - Suppression Carac interdit

> **Analyse**: Phases 1-4 2026-02-03 18:22 -> 18:22 (14s) | Assemblage 18:22
...
**Suppression Carac interdit** assure la gestion complete de ce processus, accessible depuis [Alimentation Combos TRANSPORT (IDE 40)](PTR-IDE-40.md).
...
#### <a id="t1"></a>39 - Suppression Carac interdit
...
- **Appele par**: [Alimentation Combos TRANSPORT (IDE 40)](PTR-IDE-40.md)
...
|----------|-------|------|------------|------|
| **39.1** | [**Suppression Carac interdit** (39)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Alimentation Combos TRANSPORT (IDE 40)](PTR-IDE-40.md) -> **Suppression Carac interdit (IDE 39)**

```mermaid
graph LR
    T39[39 Suppression Carac i...]
...
|-----|---------------|-----------|
| [40](PTR-IDE-40.md) | Alimentation Combos TRANSPORT | 1 |
