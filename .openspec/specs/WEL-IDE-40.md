# WEL IDE 40 - Alimentation Combos PARIS 2

> **Analyse**: Phases 1-4 2026-02-03 21:25 -> 21:25 (17s) | Assemblage 21:25
...
**Alimentation Combos PARIS 2** assure la gestion complete de ce processus, accessible depuis [Lancement (IDE 34)](WEL-IDE-34.md).
...
#### <a id="t1"></a>40 - Êcran [[ECRAN]](#ecran-t1)
...
|----------|-------|------|------------|------|
| **40.1** | [**Êcran** (40)](#t1) [mockup](#ecran-t1) | MDI | 573x251 | Traitement |
...
Main -> ... -> [Lancement (IDE 34)](WEL-IDE-34.md) -> **Alimentation Combos PARIS 2 (IDE 40)**
