...
| Projet | PVE |
| IDE Position | 127 |
| Nom Programme | lancement report |
...
**lancement report** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>127 - lancement report

**Role** : Traitement : lancement report.
...
|----------|-------|------|------------|------|
| **127.1** | [**lancement report** (127)](#t1) | - | - | Traitement |
