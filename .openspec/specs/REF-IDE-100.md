# REF IDE 100 - Browse - logement_exterieurs
...
| Projet | REF |
| IDE Position | 100 |
| Nom Programme | Browse - logement_exterieurs |
...
**Browse - logement_exterieurs** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>100 - Browse - logement_exterieurs

**Role** : Traitement : Browse - logement_exterieurs.
...
|----------|-------|------|------------|------|
| **100.1** | [**Browse - logement_exterieurs** (100)](#t1) | - | - | Traitement |
