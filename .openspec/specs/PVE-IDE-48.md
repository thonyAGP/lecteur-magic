# PVE IDE 48 - Create TempDbRentals PMS

> **Analyse**: Phases 1-4 2026-02-03 08:56 -> 08:56 (21s) | Assemblage 08:56
...
| Projet | PVE |
| IDE Position | 48 |
| Nom Programme | Create TempDbRentals PMS |
...
**Create TempDbRentals PMS** assure la gestion complete de ce processus, accessible depuis [Get Temp Files (IDE 46)](PVE-IDE-46.md).
...
- **48** - Create TempDbRentals PMS **[[ECRAN]](#ecran-t1)**
...
#### <a id="t1"></a>48 - Create TempDbRentals PMS [[ECRAN]](#ecran-t1)

**Role** : Traitement : Create TempDbRentals PMS.
...
|----------|-------|------|------------|------|
| **48.1** | [**Create TempDbRentals PMS** (48)](#t1) [mockup](#ecran-t1) | - | 625x0 | Creation |
| **48.2** | [**Rentals** (48.1)](#t2) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 1 | `' where  pv_service in ('&Trim(P.Liste Service [B])&')'` | - |
...
Main -> ... -> [Get Temp Files (IDE 46)](PVE-IDE-46.md) -> **Create TempDbRentals PMS (IDE 48)**

```mermaid
graph LR
    T48[48 Create TempDbRental...]
