# PBP IDE 285 - RaZ 604 tempo depart

> **Analyse**: Phases 1-4 2026-02-03 16:11 -> 16:11 (16s) | Assemblage 16:11
...
| Projet | PBP |
| IDE Position | 285 |
| Nom Programme | RaZ 604 tempo depart |
...
**RaZ 604 tempo depart** assure la gestion complete de ce processus, accessible depuis [  Liste Clients present (IDE 162)](PBP-IDE-162.md), [Liste CLients AVPBDR (IDE 174)](PBP-IDE-174.md), [  Liste CLients arrivant (IDE 156)](PBP-IDE-156.md), [  Liste CLients depart (IDE 168)](PBP-IDE-168.md).
...
#### <a id="t1"></a>285 - RaZ 166 tempo depart [[ECRAN]](#ecran-t1)

**Role** : Reinitialisation : RaZ 166 tempo depart.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 285 | 285 | RaZ 166 tempo depart | MDI | 424 | 56 | Initialisation |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>285 - RaZ 166 tempo depart
**Tache** : [285](#t1) | **Type** : MDI | **Dimensions** : 424 x 56 DLU
**Bloc** : Initialisation | **Titre IDE** : RaZ 166 tempo depart
...
Ecran unique: **RaZ 166 tempo depart**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **285.1** | [**RaZ 166 tempo depart** (285)](#t1) [mockup](#ecran-t1) | MDI | 424x56 | Initialisation |
...
Main -> ... -> [  Liste Clients present (IDE 162)](PBP-IDE-162.md) -> **RaZ 604 tempo depart (IDE 285)**

Main -> ... -> [Liste CLients AVPBDR (IDE 174)](PBP-IDE-174.md) -> **RaZ 604 tempo depart (IDE 285)**

Main -> ... -> [  Liste CLients arrivant (IDE 156)](PBP-IDE-156.md) -> **RaZ 604 tempo depart (IDE 285)**

Main -> ... -> [  Liste CLients depart (IDE 168)](PBP-IDE-168.md) -> **RaZ 604 tempo depart (IDE 285)**

```mermaid
graph LR
    T285[285 RaZ 604 tempo depart]
