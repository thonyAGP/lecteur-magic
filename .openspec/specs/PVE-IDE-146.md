...
| Projet | PVE |
| IDE Position | 146 |
| Nom Programme | Combo type matos |
...
**Combo type matos** assure la gestion complete de ce processus, accessible depuis [Initialization (IDE 145)](PVE-IDE-145.md).
...
#### <a id="t1"></a>146 - Combo type matos

**Role** : Traitement : Combo type matos.
...
|----------|-------|------|------------|------|
| **146.1** | [**Combo type matos** (146)](#t1) | MDI | - | Traitement |
...
|----|-----|-------------|------|---|---|---|--------|
| 419 | realise_articles_caution | Articles et stock | DB | R |   |   | 1 |

### Colonnes par table (0 / 1 tables avec colonnes identifiees)

<details>
<summary>Table 419 - realise_articles_caution (R) - 1 usages</summary>
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 4 | `SetParam ('COMBOMATOS',v.list [A])` | - |
...
Main -> ... -> [Initialization (IDE 145)](PVE-IDE-145.md) -> **Combo type matos (IDE 146)**

```mermaid
graph LR
    T146[146 Combo type matos]
