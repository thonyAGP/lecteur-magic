...
| Ref | Nom | Type | Role |
|-----|-----|------|------|
| `{0,-93}` | W0 imprimante | NUMERIC | - |
| `{0,-92}` | W0 titre | ALPHA | - |
| `{0,-91}` | W0 nom adhérent | ALPHA | - |
| `{0,-90}` | W0 prénom adhérent | ALPHA | - |
| `{0,-89}` | W0 n° adhérent | NUMERIC | - |
| `{0,-88}` | W0 lettre contrôle | ALPHA | - |
| `{0,-87}` | W0 filiation | NUMERIC | - |
| `{0,-86}` | W0 masque extrait | ALPHA | - |
| `{0,-85}` | W0 langue parlée | ALPHA | - |
| `{0,-84}` | W0 devise locale | ALPHA | - |
