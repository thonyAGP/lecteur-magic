# REF IDE 681 - Extrait de compte GP

> **Analyse**: Phases 1-4 2026-02-03 13:37 -> 13:37 (16s) | Assemblage 13:37
...
**Extrait de compte GP** assure la gestion complete de ce processus, accessible depuis [Consultation Gift Pass (IDE 678)](REF-IDE-678.md).
...
#### <a id="t1"></a>681 - Extrait de compte GP >> ADH [[ECRAN]](#ecran-t1)
...
#### <a id="rm-RM-002"></a>[RM-002] Si cd [O]='C' alors 114 sinon 110)
...
| **Si faux** | 110) |
| **Variables** | O (cd) |
| **Expression source** | Expression 8 : `IF(cd [O]='C',114,110)` |
| **Exemple** | Si cd [O]='C' â†’ 114. Sinon â†’ 110) |
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 681 | 681 | Extrait de compte GP >> ADH | Type0 | 1448 | 242 | Calcul |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>681 - Extrait de compte GP >> ADH
**Tache** : [681](#t1) | **Type** : Type0 | **Dimensions** : 1448 x 242 DLU
...
|----------|-------|------|------------|------|
| **681.1** | [**Extrait de compte GP >> ADH** (681)](#t1) [mockup](#ecran-t1) | - | 1448x242 | Calcul |
...
|------|-----|------------|-------|
| CONDITION | 8 | `IF(cd [O]='C',114,110)` | [RM-002](#rm-RM-002) |
...
Main -> ... -> [Consultation Gift Pass (IDE 678)](REF-IDE-678.md) -> **Extrait de compte GP (IDE 681)**

```mermaid
graph LR
    T681[681 Extrait de compte GP]
    style T681 fill:#58a6ff
