# EXB IDE 39 - Card scan read

> **Analyse**: Phases 1-4 2026-02-03 10:45 -> 10:45 (15s) | Assemblage 10:45
...
**Card scan read** assure la gestion complete de ce processus, accessible depuis [Ventes_Excursions (IDE 40)](EXB-IDE-40.md).
...
#### <a id="t1"></a>39 - EZCard Identification [[ECRAN]](#ecran-t1)
...
| **Si vrai** | 'TRUE'LOG |
| **Si faux** | 'FALSE'LOG) |
| **Expression source** | Expression 20 : `IF (Date ()<[W] OR Date ()>[X],'TRUE'LOG,'FALSE'LOG)` |
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 39 | 39 | EZCard Identification | MDI | 366 | 68 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>39 - EZCard Identification
**Tache** : [39](#t1) | **Type** : MDI | **Dimensions** : 366 x 68 DLU
...
|----------|-------|------|------------|------|
| **39.1** | [**EZCard Identification** (39)](#t1) [mockup](#ecran-t1) | MDI | 366x68 | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CAST_LOGIQUE | 20 | `IF (Date ()<[W] OR Date ()>[X],'TRUE'LOG,'FALSE'LOG)` | [RM-001](#rm-RM-001) |
...
| IDE | Expression Decodee |
|-----|-------------------|
| 20 | `IF (Date ()<[W] OR Date ()>[X],'TRUE'LOG,'FALSE'LOG)` |
| 6 | `'TRUE'LOG` |
| 16 | `'FALSE'LOG` |
| 19 | `'FALSE'LOG` |
| 21 | `'TRUE'LOG` |
...
Main -> ... -> [Ventes_Excursions (IDE 40)](EXB-IDE-40.md) -> **Card scan read (IDE 39)**

```mermaid
graph LR
    T39[39 Card scan read]
...
|-----|---------------|-----------|
| [40](EXB-IDE-40.md) | Ventes_Excursions | 6 |
