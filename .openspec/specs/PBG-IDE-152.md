# PBG IDE 152 - Alimentation Combos NATIONAL

> **Analyse**: Phases 1-4 2026-02-03 09:45 -> 09:46 (26s) | Assemblage 09:46
...
| Projet | PBG |
| IDE Position | 152 |
| Nom Programme | Alimentation Combos NATIONAL |
...
**Alimentation Combos NATIONAL** assure la gestion complete de ce processus, accessible depuis [Execution des màj combo (IDE 141)](PBG-IDE-141.md).
...
#### <a id="t1"></a>152 - Selection Nationalite [[ECRAN]](#ecran-t1)
...
|----------|-------|------|------------|------|
| **152.1** | [**Selection Nationalite** (152)](#t1) [mockup](#ecran-t1) | MDI | 310x152 | Consultation |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| OTHER | 4 | `SetParam ('NATIONALITE',v.Chaine [A])` | - |
...
Main -> ... -> [Execution des màj combo (IDE 141)](PBG-IDE-141.md) -> **Alimentation Combos NATIONAL (IDE 152)**

```mermaid
graph LR
    T152[152 Alimentation Combo...]
