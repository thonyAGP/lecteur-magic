# REF IDE 262 - Browse - cc_reprise_ticket_bar
...
| Projet | REF |
| IDE Position | 262 |
| Nom Programme | Browse - cc_reprise_ticket_bar |
...
**Browse - cc_reprise_ticket_bar** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>262 - Browse - cc_reprise_ticket_bar

**Role** : Generation du document : Browse - cc_reprise_ticket_bar.
...
|----------|-------|------|------------|------|
| **262.1** | [**Browse - cc_reprise_ticket_bar** (262)](#t1) | - | - | Impression |
