# PVE IDE 189 - Generate Preview Payments

> **Analyse**: Phases 1-4 2026-02-03 18:47 -> 18:47 (21s) | Assemblage 18:47
...
| Projet | PVE |
| IDE Position | 189 |
| Nom Programme | Generate Preview Payments |
| Fichier source | `Prg_189.xml` |
| Dossier IDE | Mobile |
| Taches | 68 (2 ecrans visibles) |
| Tables modifiees | 10 |
| Programmes appeles | 14 |

## 2. DESCRIPTION FONCTIONNELLE

**Generate Preview Payments** assure la gestion complete de ce processus, accessible depuis [Main Sale (IDE 186)](PVE-IDE-186.md), [Main Sale-664 (IDE 187)](PVE-IDE-187.md), [Main Sale Sale Bar Code (IDE 214)](PVE-IDE-214.md), [Main Sale (IDE 363)](PVE-IDE-363.md), [Main Sale-664 (IDE 364)](PVE-IDE-364.md).

Le flux de traitement s'organise en **4 blocs fonctionnels** :

- **Traitement** (53 taches) : traitements metier divers
...
#### Phase 1 : Traitement (53 taches)

- **189** - Generate Preview OD==LEX BooEC **[[ECRAN]](#ecran-t1)**
- **189.1** - Annulation Garantie **[[ECRAN]](#ecran-t57)**
- **189.2** - check 0 soucis **[[ECRAN]](#ecran-t68)**
- **189.3** - Payment preview Signature **[[ECRAN]](#ecran-t87)**
- **189.3.3** - Insurance paper card **[[ECRAN]](#ecran-t90)**
- **189.4** - Check service managé
- **189.5** - Get Solde ResortCredit
- **189.6** - Get Solde Gift Pass
- **189.6.1** - Get List Articles GP
- **189.8** - Suppression Gift Pass
- **189.9** - Batch 2 **[[ECRAN]](#ecran-t204)**
- **189.9.1** - Création d'un O.D **[[ECRAN]](#ecran-t205)**
- **189.9.1.1** - Upd Customer
- **189.9.1.2** - Cas: Credit Card ou VAD
- **189.9.1.2.1** - Debit 18 **[[ECRAN]](#ecran-t208)**
- **189.9.1.2.2** - credit 18 **[[ECRAN]](#ecran-t209)**
- **189.9.1.3** - Cas: Credit Card ou VAD
- **189.9.1.3.1** - credit 18 **[[ECRAN]](#ecran-t212)**
- **189.9.1.4** - Cas de cloture en cours
- **189.9.1.4.1** - debit 181 **[[ECRAN]](#ecran-t214)**
- **189.9.1.4.2** - credit 181 **[[ECRAN]](#ecran-t215)**
- **189.9.1.4.3** - OD cancel 181
- **189.9.1.4.3.1** - credit xtrack **[[ECRAN]](#ecran-t217)**
- **189.9.1.5** - OD cancel 18 **[[ECRAN]](#ecran-t224)**
- **189.9.1.5.1** - credit xtrack **[[ECRAN]](#ecran-t225)**
- **189.9.1.5.2** - Update Id Annulation
- **189.9.1.5.3** - credit xtrack **[[ECRAN]](#ecran-t227)**
- **189.9.1.5.4** - Update Id Annulation
- **189.9.1.6** - update cust rentals **[[ECRAN]](#ecran-t234)**
- **189.9.2** - Search for Gift Pass **[[ECRAN]](#ecran-t240)**
- **189.9.3** - Read for Gift Pass **[[ECRAN]](#ecran-t241)**
- **189.9.4** - Read for Gift Pass **[[ECRAN]](#ecran-t242)**
- **189.9.5** - Read for Gift Pass **[[ECRAN]](#ecran-t244)**
- **189.9.6** - Read for Resort Credit **[[ECRAN]](#ecran-t245)**
- **189.9.1.3.2** - OD Debit 18 **[[ECRAN]](#ecran-t264)**
- **189.9.1.7** - Cas: Credit Card ou VAD
- **189.9.1.7.1** - credit xtrack **[[ECRAN]](#ecran-t285)**
- **189.9.1.7.2** - credit xtrack **[[ECRAN]](#ecran-t286)**
- **189.9.1.7.3** - OD cancel xtrack
- **189.9.1.7.3.1** - credit xtrack **[[ECRAN]](#ecran-t288)**
- **189.9.1.8** - Lecture IN PO **[[ECRAN]](#ecran-t290)**
- **189.9.1.8.1** - credit xtrack **[[ECRAN]](#ecran-t291)**
- **189.9.1.8.2** - credit 18 **[[ECRAN]](#ecran-t292)**
- **189.9.1.8.3** - credit 18 **[[ECRAN]](#ecran-t293)**
- **189.9.1.8.4** - credit 181 **[[ECRAN]](#ecran-t294)**
- **189.9.1.9** - Enregistrement et édition
- **189.9.1.9.2** - Payment preview **[[ECRAN]](#ecran-t305)**
- **189.9.1.7.4** - debit xtrack **[[ECRAN]](#ecran-t320)**
- **189.9.1.7.5** - Suppression Ligne GP inutile
- **189.10** - Supp lignes orphelines
- **189.9.2.1** - Search for Gift Pass **[[ECRAN]](#ecran-t345)**
- **189.9.1.7.6** - Suppression Ligne GP inutile
- **189.11** - check 0 soucis **[[ECRAN]](#ecran-t375)**

Delegue a : [Crédit Conso/Gratuité (BAR) (IDE 228)](PVE-IDE-228.md), [Browse - pv_cust_package (IDE 447)](PVE-IDE-447.md), [Regénération Email Liste Temp (IDE 198)](PVE-IDE-198.md), [  Test imputation OK ? (IDE 211)](PVE-IDE-211.md), [Get Bank accounting date (IDE 297)](PVE-IDE-297.md), [Get default email address (IDE 314)](PVE-IDE-314.md), [Is HP Sale (IDE 315)](PVE-IDE-315.md)

#### Phase 2 : Calcul (6 taches)

- **189.3.1** - Vérifie param comptabilité **[[ECRAN]](#ecran-t88)**
- **189.3.2** - calcul total
- **189.9.1.6.1** - Calcul days
- **189.9.1.6.1.1** - Lect PoS Compta
- **189.9.1.9.3** - Stockage fact. Presta
- **189.9.1.10** - Compte NB Lignes

Delegue a : [Browse - pv_comptab_temp (IDE 448)](PVE-IDE-448.md), [Stock - Sale/Cancel (IDE 233)](PVE-IDE-233.md)

#### Phase 3 : Validation (7 taches)

- **189.7** - Devalidation annulations GP
- **189.9.1.9.1** - Validation ecriture od **[[ECRAN]](#ecran-t237)**
- **189.9.1.7.4.1** - Verif montant payé si PREPAID
- **189.9.1.7.4.2** - Verif montant payé si PREPAID
- **189.9.1.7.1.1** - Verif montant payé si PREPAID
- **189.9.1.7.1.2** - Verif montant payé si PREPAID
- **189.3.4** - Si message en cours de validit **[[ECRAN]](#ecran-t372)**

Delegue a : [Verif cloture (IDE 126)](PVE-IDE-126.md)

#### Phase 4 : Creation (2 taches)

- **189.9.4.1** - Creation Ligne **[[ECRAN]](#ecran-t243)**
- **189.9.6.1** - Creation Ligne **[[ECRAN]](#ecran-t246)**

#### Tables impactees

| Table | Operations | Role metier |
|-------|-----------|-------------|
| pv_cust_rentals | R/**W**/L (26 usages) |  |
...
### 3.1 Traitement (53 taches)

Traitements internes.

---

#### <a id="t1"></a>189 - Generate Preview OD==LEX BooEC [[ECRAN]](#ecran-t1)

**Role** : Tache d'orchestration : point d'entree du programme (53 sous-taches). Coordonne l'enchainement des traitements.
**Ecran** : 126 x 71 DLU (MDI) | [Voir mockup](#ecran-t1)

<details>
<summary>52 sous-taches directes</summary>

| Tache | Nom | Bloc |
|-------|-----|------|
| [189.1](#t57) | Annulation Garantie **[[ECRAN]](#ecran-t57)** | Traitement |
| [189.2](#t68) | check 0 soucis **[[ECRAN]](#ecran-t68)** | Traitement |
| [189.3](#t87) | Payment preview Signature **[[ECRAN]](#ecran-t87)** | Traitement |
| [189.3.3](#t90) | Insurance paper card **[[ECRAN]](#ecran-t90)** | Traitement |
| [189.4](#t95) | Check service managé | Traitement |
| [189.5](#t97) | Get Solde ResortCredit | Traitement |
| [189.6](#t103) | Get Solde Gift Pass | Traitement |
| [189.6.1](#t111) | Get List Articles GP | Traitement |
| [189.8](#t115) | Suppression Gift Pass | Traitement |
| [189.9](#t204) | Batch 2 **[[ECRAN]](#ecran-t204)** | Traitement |
| [189.9.1](#t205) | Création d'un O.D **[[ECRAN]](#ecran-t205)** | Traitement |
| [189.9.1.1](#t206) | Upd Customer | Traitement |
| [189.9.1.2](#t207) | Cas: Credit Card ou VAD | Traitement |
| [189.9.1.2.1](#t208) | Debit 18 **[[ECRAN]](#ecran-t208)** | Traitement |
| [189.9.1.2.2](#t209) | credit 18 **[[ECRAN]](#ecran-t209)** | Traitement |
| [189.9.1.3](#t210) | Cas: Credit Card ou VAD | Traitement |
| [189.9.1.3.1](#t212) | credit 18 **[[ECRAN]](#ecran-t212)** | Traitement |
| [189.9.1.4](#t213) | Cas de cloture en cours | Traitement |
| [189.9.1.4.1](#t214) | debit 181 **[[ECRAN]](#ecran-t214)** | Traitement |
| [189.9.1.4.2](#t215) | credit 181 **[[ECRAN]](#ecran-t215)** | Traitement |
| [189.9.1.4.3](#t216) | OD cancel 181 | Traitement |
| [189.9.1.4.3.1](#t217) | credit xtrack **[[ECRAN]](#ecran-t217)** | Traitement |
| [189.9.1.5](#t224) | OD cancel 18 **[[ECRAN]](#ecran-t224)** | Traitement |
| [189.9.1.5.1](#t225) | credit xtrack **[[ECRAN]](#ecran-t225)** | Traitement |
| [189.9.1.5.2](#t226) | Update Id Annulation | Traitement |
| [189.9.1.5.3](#t227) | credit xtrack **[[ECRAN]](#ecran-t227)** | Traitement |
| [189.9.1.5.4](#t228) | Update Id Annulation | Traitement |
| [189.9.1.6](#t234) | update cust rentals **[[ECRAN]](#ecran-t234)** | Traitement |
| [189.9.2](#t240) | Search for Gift Pass **[[ECRAN]](#ecran-t240)** | Traitement |
| [189.9.3](#t241) | Read for Gift Pass **[[ECRAN]](#ecran-t241)** | Traitement |
| [189.9.4](#t242) | Read for Gift Pass **[[ECRAN]](#ecran-t242)** | Traitement |
| [189.9.5](#t244) | Read for Gift Pass **[[ECRAN]](#ecran-t244)** | Traitement |
| [189.9.6](#t245) | Read for Resort Credit **[[ECRAN]](#ecran-t245)** | Traitement |
| [189.9.1.3.2](#t264) | OD Debit 18 **[[ECRAN]](#ecran-t264)** | Traitement |
| [189.9.1.7](#t283) | Cas: Credit Card ou VAD | Traitement |
| [189.9.1.7.1](#t285) | credit xtrack **[[ECRAN]](#ecran-t285)** | Traitement |
| [189.9.1.7.2](#t286) | credit xtrack **[[ECRAN]](#ecran-t286)** | Traitement |
| [189.9.1.7.3](#t287) | OD cancel xtrack | Traitement |
| [189.9.1.7.3.1](#t288) | credit xtrack **[[ECRAN]](#ecran-t288)** | Traitement |
| [189.9.1.8](#t290) | Lecture IN PO **[[ECRAN]](#ecran-t290)** | Traitement |
| [189.9.1.8.1](#t291) | credit xtrack **[[ECRAN]](#ecran-t291)** | Traitement |
| [189.9.1.8.2](#t292) | credit 18 **[[ECRAN]](#ecran-t292)** | Traitement |
| [189.9.1.8.3](#t293) | credit 18 **[[ECRAN]](#ecran-t293)** | Traitement |
| [189.9.1.8.4](#t294) | credit 181 **[[ECRAN]](#ecran-t294)** | Traitement |
| [189.9.1.9](#t301) | Enregistrement et édition | Traitement |
| [189.9.1.9.2](#t305) | Payment preview **[[ECRAN]](#ecran-t305)** | Traitement |
| [189.9.1.7.4](#t320) | debit xtrack **[[ECRAN]](#ecran-t320)** | Traitement |
| [189.9.1.7.5](#t326) | Suppression Ligne GP inutile | Traitement |
| [189.10](#t335) | Supp lignes orphelines | Traitement |
| [189.9.2.1](#t345) | Search for Gift Pass **[[ECRAN]](#ecran-t345)** | Traitement |
| [189.9.1.7.6](#t348) | Suppression Ligne GP inutile | Traitement |
| [189.11](#t375) | check 0 soucis **[[ECRAN]](#ecran-t375)** | Traitement |

</details>

---

#### <a id="t57"></a>189.1 - Annulation Garantie [[ECRAN]](#ecran-t57)
...
#### <a id="t68"></a>189.2 - check 0 soucis [[ECRAN]](#ecran-t68)

**Role** : Traitement : check 0 soucis.
**Ecran** : 715 x 439 DLU (MDI) | [Voir mockup](#ecran-t68)
**Variables liees** : BM (p.Check_CM_Pass), CU (v.vente ass-0-soucis ?), DF (v.ALL-Nb Ass-0-soucis dejavendu), DG (v.ALL-Ass-0-soucis plus que 1?), DH (v.GM-Nb Ass-0-soucis dejavendue)

---

#### <a id="t87"></a>189.3 - Payment preview Signature [[ECRAN]](#ecran-t87)
...
#### <a id="t90"></a>189.3.3 - Insurance paper card [[ECRAN]](#ecran-t90)
...
#### <a id="t95"></a>189.4 - Check service managé
...
#### <a id="t97"></a>189.5 - Get Solde ResortCredit
...
#### <a id="t103"></a>189.6 - Get Solde Gift Pass
...
#### <a id="t111"></a>189.6.1 - Get List Articles GP
...
#### <a id="t115"></a>189.8 - Suppression Gift Pass
...
#### <a id="t204"></a>189.9 - Batch 2 [[ECRAN]](#ecran-t204)
...
#### <a id="t205"></a>189.9.1 - Création d'un O.D [[ECRAN]](#ecran-t205)
...
#### <a id="t206"></a>189.9.1.1 - Upd Customer

**Role** : Traitement : Upd Customer.

---

#### <a id="t207"></a>189.9.1.2 - Cas: Credit Card ou VAD
...
#### <a id="t208"></a>189.9.1.2.1 - Debit 18 [[ECRAN]](#ecran-t208)
...
#### <a id="t209"></a>189.9.1.2.2 - credit 18 [[ECRAN]](#ecran-t209)
...
#### <a id="t210"></a>189.9.1.3 - Cas: Credit Card ou VAD
...
#### <a id="t212"></a>189.9.1.3.1 - credit 18 [[ECRAN]](#ecran-t212)
...
#### <a id="t213"></a>189.9.1.4 - Cas de cloture en cours
...
#### <a id="t214"></a>189.9.1.4.1 - debit 181 [[ECRAN]](#ecran-t214)
...
#### <a id="t215"></a>189.9.1.4.2 - credit 181 [[ECRAN]](#ecran-t215)
...
#### <a id="t216"></a>189.9.1.4.3 - OD cancel 181
...
#### <a id="t217"></a>189.9.1.4.3.1 - credit xtrack [[ECRAN]](#ecran-t217)
...
#### <a id="t224"></a>189.9.1.5 - OD cancel 18 [[ECRAN]](#ecran-t224)
...
#### <a id="t225"></a>189.9.1.5.1 - credit xtrack [[ECRAN]](#ecran-t225)
...
#### <a id="t226"></a>189.9.1.5.2 - Update Id Annulation
...
#### <a id="t227"></a>189.9.1.5.3 - credit xtrack [[ECRAN]](#ecran-t227)
...
#### <a id="t228"></a>189.9.1.5.4 - Update Id Annulation
...
#### <a id="t234"></a>189.9.1.6 - update cust rentals [[ECRAN]](#ecran-t234)
...
#### <a id="t240"></a>189.9.2 - Search for Gift Pass [[ECRAN]](#ecran-t240)
...
#### <a id="t241"></a>189.9.3 - Read for Gift Pass [[ECRAN]](#ecran-t241)
...
#### <a id="t242"></a>189.9.4 - Read for Gift Pass [[ECRAN]](#ecran-t242)
...
#### <a id="t244"></a>189.9.5 - Read for Gift Pass [[ECRAN]](#ecran-t244)
...
#### <a id="t245"></a>189.9.6 - Read for Resort Credit [[ECRAN]](#ecran-t245)
...
#### <a id="t264"></a>189.9.1.3.2 - OD Debit 18 [[ECRAN]](#ecran-t264)
...
#### <a id="t283"></a>189.9.1.7 - Cas: Credit Card ou VAD
...
#### <a id="t285"></a>189.9.1.7.1 - credit xtrack [[ECRAN]](#ecran-t285)
...
#### <a id="t286"></a>189.9.1.7.2 - credit xtrack [[ECRAN]](#ecran-t286)
...
#### <a id="t287"></a>189.9.1.7.3 - OD cancel xtrack
...
#### <a id="t288"></a>189.9.1.7.3.1 - credit xtrack [[ECRAN]](#ecran-t288)
...
#### <a id="t290"></a>189.9.1.8 - Lecture IN PO [[ECRAN]](#ecran-t290)
...
#### <a id="t291"></a>189.9.1.8.1 - credit xtrack [[ECRAN]](#ecran-t291)
...
#### <a id="t292"></a>189.9.1.8.2 - credit 18 [[ECRAN]](#ecran-t292)
...
#### <a id="t293"></a>189.9.1.8.3 - credit 18 [[ECRAN]](#ecran-t293)
...
#### <a id="t294"></a>189.9.1.8.4 - credit 181 [[ECRAN]](#ecran-t294)
...
#### <a id="t301"></a>189.9.1.9 - Enregistrement et édition

**Role** : Traitement : Enregistrement et édition.

---

#### <a id="t305"></a>189.9.1.9.2 - Payment preview [[ECRAN]](#ecran-t305)
...
#### <a id="t320"></a>189.9.1.7.4 - debit xtrack [[ECRAN]](#ecran-t320)
...
#### <a id="t326"></a>189.9.1.7.5 - Suppression Ligne GP inutile

**Role** : Traitement : Suppression Ligne GP inutile.
**Variables liees** : N (p.Price_Ligne), O (p.Pakage_ID_Out_Ligne), P (p.Discount_Ligne), BC (p.date_update_ligne), BD (p.Time_update_ligne)

---

#### <a id="t335"></a>189.10 - Supp lignes orphelines

**Role** : Traitement : Supp lignes orphelines.
**Variables liees** : DB (v.Suppression ligne GP?)

---

#### <a id="t345"></a>189.9.2.1 - Search for Gift Pass [[ECRAN]](#ecran-t345)

**Role** : Calcul fidelite/avantage : Search for Gift Pass.
**Ecran** : 175 x 66 DLU | [Voir mockup](#ecran-t345)
**Variables liees** : E (p.V.recherche_ClubmedPass), K (p.Montant_Eligible_Gift_Pass), L (p.V.solde_Gift Pass), BM (p.Check_CM_Pass), BX (v.Club Med Pass)

---

#### <a id="t348"></a>189.9.1.7.6 - Suppression Ligne GP inutile
...
#### <a id="t375"></a>189.11 - check 0 soucis [[ECRAN]](#ecran-t375)

**Role** : Traitement : check 0 soucis.
**Ecran** : 715 x 439 DLU (MDI) | [Voir mockup](#ecran-t375)
**Variables liees** : BM (p.Check_CM_Pass), CU (v.vente ass-0-soucis ?), DF (v.ALL-Nb Ass-0-soucis dejavendu), DG (v.ALL-Ass-0-soucis plus que 1?), DH (v.GM-Nb Ass-0-soucis dejavendue)
...
#### <a id="t88"></a>189.3.1 - Vérifie param comptabilité [[ECRAN]](#ecran-t88)
...
#### <a id="t89"></a>189.3.2 - calcul total
...
#### <a id="t235"></a>189.9.1.6.1 - Calcul days
...
#### <a id="t236"></a>189.9.1.6.1.1 - Lect PoS Compta
...
#### <a id="t310"></a>189.9.1.9.3 - Stockage fact. Presta

**Role** : Calcul : Stockage fact. Presta.
**Variables liees** : DM (v. flag chargement fact. presta), DN (v. Répertoire fact. detaillee)
**Delegue a** : [Browse - pv_comptab_temp (IDE 448)](PVE-IDE-448.md), [Stock - Sale/Cancel (IDE 233)](PVE-IDE-233.md)

---

#### <a id="t321"></a>189.9.1.10 - Compte NB Lignes

**Role** : Traitement : Compte NB Lignes.
**Variables liees** : F (p.V.NumCompteSauvegarde), G (p.gm_Compte), H (p.V.solde_Compte), W (p.L.Compte Speciaux)
**Delegue a** : [Browse - pv_comptab_temp (IDE 448)](PVE-IDE-448.md), [Stock - Sale/Cancel (IDE 233)](PVE-IDE-233.md)


### 3.3 Validation (7 taches)

Controles de coherence : 7 taches verifient les donnees et conditions.

---

#### <a id="t113"></a>189.7 - Devalidation annulations GP
...
#### <a id="t237"></a>189.9.1.9.1 - Validation ecriture od [[ECRAN]](#ecran-t237)
...
#### <a id="t354"></a>189.9.1.7.4.1 - Verif montant payé si PREPAID

**Role** : Verification : Verif montant payé si PREPAID.
**Variables liees** : K (p.Montant_Eligible_Gift_Pass), BG (p.Montant_Free_Extra), CO (v.Montant Eligible Gift Pass), CR (v.MontantEligibleResortCredit), DE (v.rbsmnt prepaid plafonne)
**Delegue a** : [Verif cloture (IDE 126)](PVE-IDE-126.md)

---

#### <a id="t357"></a>189.9.1.7.4.2 - Verif montant payé si PREPAID
...
#### <a id="t366"></a>189.9.1.7.1.1 - Verif montant payé si PREPAID
...
#### <a id="t369"></a>189.9.1.7.1.2 - Verif montant payé si PREPAID
...
#### <a id="t372"></a>189.3.4 - Si message en cours de validit [[ECRAN]](#ecran-t372)

**Role** : Verification : Si message en cours de validit.
**Ecran** : 536 x 0 DLU | [Voir mockup](#ecran-t372)
**Delegue a** : [Verif cloture (IDE 126)](PVE-IDE-126.md)
...
#### <a id="t243"></a>189.9.4.1 - Creation Ligne [[ECRAN]](#ecran-t243)
...
#### <a id="t246"></a>189.9.6.1 - Creation Ligne [[ECRAN]](#ecran-t246)
...
- **Appelle**: 14 programmes | **Tables**: 32 (W:10 R:13 L:26) | **Taches**: 68 | **Expressions**: 38

<!-- TAB:Ecrans -->

## 8. ECRANS

### 8.1 Forms visibles (2 / 68)

| # | Position | Tache | Nom | Type | Largeur | Hauteur | Bloc |
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 189.7 | 189.3 | Payment preview Signature | Type6 | 1984 | 438 | Traitement |
| 2 | 189.7.4 | 189.3.3 | Insurance paper card | Type0 | 333 | 99 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t87"></a>189.7 - Payment preview Signature
**Tache** : [189.3](#t87) | **Type** : Type6 | **Dimensions** : 1984 x 438 DLU
...
| 1504,180 | v.Total à payer | - | edit |
| 1504,167 | v.Total GP | - | edit |
| 1504,154 | v.Valeur ticket | - | edit |
| 441,157 | V. Checkbox message INS | - | checkbox |
...
#### <a id="ecran-t90"></a>189.7.4 - Insurance paper card
**Tache** : [189.3.3](#t90) | **Type** : Type0 | **Dimensions** : 333 x 99 DLU
...
flowchart TD
    ...
    VF87[189.3 Payment preview Si...]
    style VF87 fill:#58a6ff
    VF90[189.3.3 Insurance paper card]
...
|----------|-------|------|------------|------|
| **189.1** | [**Generate Preview OD==LEX BooEC** (189)](#t1) [mockup](#ecran-t1) | MDI | 126x71 | Traitement |
| 189.1.1 | [Annulation Garantie (189.1)](#t57) [mockup](#ecran-t57) | - | 723x460 | |
| 189.1.2 | [check 0 soucis (189.2)](#t68) [mockup](#ecran-t68) | MDI | 715x439 | |
| 189.1.3 | [Payment preview Signature (189.3)](#t87) [mockup](#ecran-t87) | Type6 | 1984x438 | |
| 189.1.4 | [Insurance paper card (189.3.3)](#t90) [mockup](#ecran-t90) | - | 333x99 | |
| 189.1.5 | [Check service managé (189.4)](#t95) | - | - | |
| 189.1.6 | [Get Solde ResortCredit (189.5)](#t97) | - | - | |
| 189.1.7 | [Get Solde Gift Pass (189.6)](#t103) | - | - | |
| 189.1.8 | [Get List Articles GP (189.6.1)](#t111) | - | - | |
| 189.1.9 | [Suppression Gift Pass (189.8)](#t115) | - | - | |
| 189.1.10 | [Batch 2 (189.9)](#t204) [mockup](#ecran-t204) | - | 519x342 | |
| 189.1.11 | [Création d'un O.D (189.9.1)](#t205) [mockup](#ecran-t205) | MDI | 1170x229 | |
| 189.1.12 | [Upd Customer (189.9.1.1)](#t206) | - | - | |
| 189.1.13 | [Cas: Credit Card ou VAD (189.9.1.2)](#t207) | - | - | |
| 189.1.14 | [Debit 18 (189.9.1.2.1)](#t208) [mockup](#ecran-t208) | MDI | 164x63 | |
| 189.1.15 | [credit 18 (189.9.1.2.2)](#t209) [mockup](#ecran-t209) | MDI | 223x119 | |
| 189.1.16 | [Cas: Credit Card ou VAD (189.9.1.3)](#t210) | - | - | |
| 189.1.17 | [credit 18 (189.9.1.3.1)](#t212) [mockup](#ecran-t212) | MDI | 377x144 | |
| 189.1.18 | [Cas de cloture en cours (189.9.1.4)](#t213) | - | - | |
| 189.1.19 | [debit 181 (189.9.1.4.1)](#t214) [mockup](#ecran-t214) | MDI | 153x63 | |
| 189.1.20 | [credit 181 (189.9.1.4.2)](#t215) [mockup](#ecran-t215) | MDI | 134x63 | |
| 189.1.21 | [OD cancel 181 (189.9.1.4.3)](#t216) | MDI | - | |
| 189.1.22 | [credit xtrack (189.9.1.4.3.1)](#t217) [mockup](#ecran-t217) | MDI | 104x63 | |
| 189.1.23 | [OD cancel 18 (189.9.1.5)](#t224) [mockup](#ecran-t224) | MDI | 677x270 | |
| 189.1.24 | [credit xtrack (189.9.1.5.1)](#t225) [mockup](#ecran-t225) | MDI | 104x63 | |
| 189.1.25 | [Update Id Annulation (189.9.1.5.2)](#t226) | - | - | |
| 189.1.26 | [credit xtrack (189.9.1.5.3)](#t227) [mockup](#ecran-t227) | MDI | 104x63 | |
| 189.1.27 | [Update Id Annulation (189.9.1.5.4)](#t228) | - | - | |
| 189.1.28 | [update cust rentals (189.9.1.6)](#t234) [mockup](#ecran-t234) | MDI | 266x102 | |
| 189.1.29 | [Search for Gift Pass (189.9.2)](#t240) [mockup](#ecran-t240) | - | 175x195 | |
| 189.1.30 | [Read for Gift Pass (189.9.3)](#t241) [mockup](#ecran-t241) | - | 1293x430 | |
| 189.1.31 | [Read for Gift Pass (189.9.4)](#t242) [mockup](#ecran-t242) | - | 795x346 | |
| 189.1.32 | [Read for Gift Pass (189.9.5)](#t244) [mockup](#ecran-t244) | - | 1293x430 | |
| 189.1.33 | [Read for Resort Credit (189.9.6)](#t245) [mockup](#ecran-t245) | - | 795x346 | |
| 189.1.34 | [OD Debit 18 (189.9.1.3.2)](#t264) [mockup](#ecran-t264) | MDI | 1010x398 | |
| 189.1.35 | [Cas: Credit Card ou VAD (189.9.1.7)](#t283) | - | - | |
| 189.1.36 | [credit xtrack (189.9.1.7.1)](#t285) [mockup](#ecran-t285) | MDI | 104x63 | |
| 189.1.37 | [credit xtrack (189.9.1.7.2)](#t286) [mockup](#ecran-t286) | MDI | 104x63 | |
| 189.1.38 | [OD cancel xtrack (189.9.1.7.3)](#t287) | MDI | - | |
| 189.1.39 | [credit xtrack (189.9.1.7.3.1)](#t288) [mockup](#ecran-t288) | MDI | 104x63 | |
| 189.1.40 | [Lecture IN PO (189.9.1.8)](#t290) [mockup](#ecran-t290) | MDI | 104x63 | |
| 189.1.41 | [credit xtrack (189.9.1.8.1)](#t291) [mockup](#ecran-t291) | MDI | 104x63 | |
| 189.1.42 | [credit 18 (189.9.1.8.2)](#t292) [mockup](#ecran-t292) | MDI | 223x119 | |
| 189.1.43 | [credit 18 (189.9.1.8.3)](#t293) [mockup](#ecran-t293) | MDI | 223x119 | |
| 189.1.44 | [credit 181 (189.9.1.8.4)](#t294) [mockup](#ecran-t294) | MDI | 134x63 | |
| 189.1.45 | [Enregistrement et édition (189.9.1.9)](#t301) | - | - | |
| 189.1.46 | [Payment preview (189.9.1.9.2)](#t305) [mockup](#ecran-t305) | MDI | 635x292 | |
| 189.1.47 | [debit xtrack (189.9.1.7.4)](#t320) [mockup](#ecran-t320) | MDI | 835x253 | |
| 189.1.48 | [Suppression Ligne GP inutile (189.9.1.7.5)](#t326) | - | - | |
| 189.1.49 | [Supp lignes orphelines (189.10)](#t335) | - | - | |
| 189.1.50 | [Search for Gift Pass (189.9.2.1)](#t345) [mockup](#ecran-t345) | - | 175x66 | |
| 189.1.51 | [Suppression Ligne GP inutile (189.9.1.7.6)](#t348) | - | - | |
| 189.1.52 | [check 0 soucis (189.11)](#t375) [mockup](#ecran-t375) | MDI | 715x439 | |
| **189.2** | [**Vérifie param comptabilité** (189.3.1)](#t88) [mockup](#ecran-t88) | Type6 | 606x157 | Calcul |
| 189.2.1 | [calcul total (189.3.2)](#t89) | MDI | - | |
| 189.2.2 | [Calcul days (189.9.1.6.1)](#t235) | MDI | - | |
| 189.2.3 | [Lect PoS Compta (189.9.1.6.1.1)](#t236) | MDI | - | |
| 189.2.4 | [Stockage fact. Presta (189.9.1.9.3)](#t310) | - | - | |
| 189.2.5 | [Compte NB Lignes (189.9.1.10)](#t321) | - | - | |
| **189.3** | [**Devalidation annulations GP** (189.7)](#t113) | - | - | Validation |
| 189.3.1 | [Validation ecriture od (189.9.1.9.1)](#t237) [mockup](#ecran-t237) | - | 1052x448 | |
| 189.3.2 | [Verif montant payé si PREPAID (189.9.1.7.4.1)](#t354) | - | - | |
| 189.3.3 | [Verif montant payé si PREPAID (189.9.1.7.4.2)](#t357) | - | - | |
| 189.3.4 | [Verif montant payé si PREPAID (189.9.1.7.1.1)](#t366) | - | - | |
| 189.3.5 | [Verif montant payé si PREPAID (189.9.1.7.1.2)](#t369) | - | - | |
| 189.3.6 | [Si message en cours de validit (189.3.4)](#t372) [mockup](#ecran-t372) | - | 536x0 | |
| **189.4** | [**Creation Ligne** (189.9.4.1)](#t243) [mockup](#ecran-t243) | - | 604x85 | Creation |
| 189.4.1 | [Creation Ligne (189.9.6.1)](#t246) [mockup](#ecran-t246) | - | 422x85 | |
...
### Colonnes par table (19 / 18 tables avec colonnes identifiees)
...
| C | v.condition30 | W | Logical |
| D | V.Montant_free_Extra Comptable | W | Numeric |
| E | V.Vendeur choisi | W | Alpha |
| F | V.Montant payé pour cet article | W | Numeric |
| G | V.Article ayant eu PREPAID? | W | Logical |
| H | CHG_REASON_pv_montant_free_ext | W | Numeric |
| I | CHG_PRV_pv_montant_free_extra | W | Numeric |
...
| S | v.Montant ligne vente | W | Numeric |
...
| BF | p.V.Type | R | Alpha |
| BJ | v.Total GP | R | Unicode |
| BK | v.Total à payer | R | Unicode |
| BO | P.TypeMessage (Error\Warning) | R | Unicode |
...
<details>
<summary>Table 377 - pv_contracts (R/L) - 8 usages</summary>
...
| D | v.Package existe & chgt duree? | R | Logical |
| E | L.Retour Equip non affect | R | Logical |
| F | v.Lien Club Med Pass | R | Logical |
| G | v.packageIdOrigine | R | Numeric |
| H | v.Retour Booking | R | Logical |
| I | L Pas de débit | R | Logical |
| J | V Montant Ligne | R | Numeric |
...
| O | v.Libellé v2  ¤ | R | Unicode |
| P | v.Libellé supplément v2 ¤ | R | Unicode |
| Q | v.Ligne assurance? | R | Logical |
| R | v.cas particulier lign initial? | R | Logical |
| S | v.Montant ligne vente | R | Numeric |
| T | v.Montant ligne origine | R | Numeric |
| U | v.LU GP 1? | R | Logical |
| V | v.LU GP 2? | R | Logical |
| W | v.LU GP 3? | R | Logical |
| X | v.Ligne unique GP? | R | Logical |
| Y | v.Montant Calculé | R | Numeric |
| Z | v.Exchange Upgrade? | R | Logical |
| BA | v.Exchange Downgrade? | R | Logical |
| BB | v.Exchange Downgrade PREPAID? | R | Logical |
| BC | v.Mntt Down PREPAID durée = | R | Numeric |
| BD | v.Mntt Down PREPAID durée <> | R | Numeric |
| BE | v.Mntt Upgrade PREPAID durée = | R | Numeric |
| BF | v.Mntt Upgrade PREPAID durée <> | R | Numeric |
| BG | v.Mntt GP UPGD PREPAID durée = | R | Numeric |
| BH | v.Montant écart Upgrade | R | Numeric |
| BI | v.Montant utilisable GP upgrade | R | Numeric |
| BJ | v.Suppression ligne GP erreur? | R | Logical |
| BK | v.package_id_in GP à supprimer | R | Numeric |
| BL | v.Ligne normale à traiter? | R | Logical |
| BM | v.Ligne à traiter? | R | Logical |
...
| G | v.Ligne normale à traiter? | W | Logical |
...
<details>
<summary>Table 400 - pv_cust_rentals (R/**W**/L) - 26 usages</summary>

| Lettre | Variable | Acces | Type |
|--------|----------|-------|------|
| A | P.Validation | W | Logical |
| B | P.package_id_in | W | Numeric |
| C | V Total CreditCard | W | Numeric |
| D | V.Total GIFT PASS | W | Numeric |
| E | V Total | W | Numeric |
...
| BI | v.Valeur ticket | W | Unicode |
| BJ | v.Total GP | W | Unicode |
| BK | v.Total à payer | W | Unicode |
| BL | v.Erreur empechant validation? | W | Logical |
| BM | V.Message INS | W | Alpha |
| BN | V. Checkbox message INS | W | Logical |
| BO | P.TypeMessage (Error\Warning) | W | Unicode |
| BP | P.Message erreur | W | Unicode |
...
| CE | v.MOP PMS | Alpha | - |
| CF | v.Cancel pour Gift Pass | Logical | [189.6](#t103), [189.8](#t115), [189.9.2](#t240) |
| CG | v Annulation Vente Garantie | Logical | - |
| CH | v.Service RENTAL? | Logical | 1x session |
...
| CN | v.Clause Where Gift Pass | Alpha | [189.6](#t103), [189.8](#t115), [189.9.2](#t240) |
| CO | v.Montant Eligible Gift Pass | Numeric | - |
| CP | v.SoldeResortCredit | Numeric | - |
| CQ | v.ConfirmeResortCredit | Numeric | 1x session |
...
| DB | v.Suppression ligne GP? | Logical | - |
| DC | v.Traitement dégradé ss GP? | Logical | - |
| DD | v.Ligne normale traitée? | Logical | - |
| DE | v.rbsmnt prepaid plafonne | Logical | - |
| DF | v.ALL-Nb Ass-0-soucis dejavendu | Numeric | - |
| DG | v.ALL-Ass-0-soucis plus que 1? | Logical | - |
| DH | v.GM-Nb Ass-0-soucis dejavendue | Numeric | - |
| DI | v.GN-Nb Ass0-soucis pending | Numeric | - |
| DJ | v.GM-Ass-0-soucis plus que 1? | Logical | - |
| DK | v. location sans assurance? | Logical | - |
| DL | v.Action validée? | Logical | - |
| DM | v. flag chargement fact. presta | Numeric | - |
| DN | v. Répertoire fact. detaillee | Alpha | - |
...
<details>
<summary>Toutes les 92 variables (liste complete)</summary>
...
| V. | **DB** | v.Suppression ligne GP? | Logical |
| V. | **DC** | v.Traitement dégradé ss GP? | Logical |
| V. | **DD** | v.Ligne normale traitée? | Logical |
| V. | **DE** | v.rbsmnt prepaid plafonne | Logical |
| V. | **DF** | v.ALL-Nb Ass-0-soucis dejavendu | Numeric |
| V. | **DG** | v.ALL-Ass-0-soucis plus que 1? | Logical |
| V. | **DH** | v.GM-Nb Ass-0-soucis dejavendue | Numeric |
| V. | **DI** | v.GN-Nb Ass0-soucis pending | Numeric |
| V. | **DJ** | v.GM-Ass-0-soucis plus que 1? | Logical |
| V. | **DK** | v. location sans assurance? | Logical |
| V. | **DL** | v.Action validée? | Logical |
| V. | **DM** | v. flag chargement fact. presta | Numeric |
| V. | **DN** | v. Répertoire fact. detaillee | Alpha |
...
| OTHER | 38 | `NOT(v.GN-Nb Ass0-soucis pe... [DI])` | - |
| OTHER | 36 | `NOT(v.Service RENTAL? [CH] OR v.Cancel pour Gift Pass [CF]) OR v.ConfirmeResortCredit [CQ]` | - |
| ... | | *+7 autres* | |
...
| CAST_LOGIQUE | 35 | `Rollback('FALSE'LOG,1)` | - |
| CAST_LOGIQUE | 37 | `Rollback('FALSE'LOG,1)` | - |
...
| 28 | `v.MOP TPE [CD]` |
| 33 | `v.Adresse Mail [CJ] AND VG114` |
| 36 | `NOT(v.Service RENTAL? [CH] OR v.Cancel pour Gift Pass [CF]) OR v.ConfirmeResortCredit [CQ]` |
| 38 | `NOT(v.GN-Nb Ass0-soucis pe... [DI])` |
...
| 35 | `Rollback('FALSE'LOG,1)` |
| 37 | `Rollback('FALSE'LOG,1)` |
...
Main -> ... -> [Main Sale (IDE 186)](PVE-IDE-186.md) -> **Generate Preview Payments (IDE 189)**

Main -> ... -> [Main Sale-664 (IDE 187)](PVE-IDE-187.md) -> **Generate Preview Payments (IDE 189)**

Main -> ... -> [Main Sale Sale Bar Code (IDE 214)](PVE-IDE-214.md) -> **Generate Preview Payments (IDE 189)**

Main -> ... -> [Main Sale (IDE 363)](PVE-IDE-363.md) -> **Generate Preview Payments (IDE 189)**

Main -> ... -> [Main Sale-664 (IDE 364)](PVE-IDE-364.md) -> **Generate Preview Payments (IDE 189)**

```mermaid
graph LR
    T189[189 Generate Preview P...]
...
|-----|---------------|--------|----------|
| [228](PVE-IDE-228.md) | Crédit Conso/Gratuité (BAR) | 7 | Sous-programme |
| [448](PVE-IDE-448.md) | Browse - pv_comptab_temp | 5 | Sous-programme |
| [447](PVE-IDE-447.md) | Browse - pv_cust_package | 3 | Sous-programme |
...
|----------|--------|-----------------|
| Lignes de logique | 4490 | Programme volumineux |
| Expressions | 38 | Peu de logique |
| Tables WRITE | 10 | Fort impact donnees |
| Sous-programmes | 14 | Forte dependance |
| Ecrans visibles | 2 | Quelques ecrans |
| Code desactive | 2.1% (94 / 4490) | Code sain |
| Regles metier | 0 | Pas de regle identifiee |

### 14.2 Plan de migration par bloc

#### Traitement (53 taches: 35 ecrans, 18 traitements)

- **Strategie** : Orchestrateur avec 35 ecrans (Razor/React) et 18 traitements backend (services).
- Les ecrans deviennent des composants UI, les traitements invisibles deviennent des services injectables.
- 14 sous-programme(s) a migrer ou a reutiliser depuis les services existants.
- Decomposer les taches en services unitaires testables.

#### Calcul (6 taches: 1 ecran, 5 traitements)

- **Strategie** : Services de calcul purs (Domain Services).
- Migrer la logique de calcul (stock, compteurs, montants)

#### Validation (7 taches: 2 ecrans, 5 traitements)
...
| [Crédit Conso/Gratuité (BAR) (IDE 228)](PVE-IDE-228.md) | Sous-programme | 7x | **CRITIQUE** - Sous-programme |
| [Browse - pv_comptab_temp (IDE 448)](PVE-IDE-448.md) | Sous-programme | 5x | **CRITIQUE** - Sous-programme |
| [Browse - pv_cust_package (IDE 447)](PVE-IDE-447.md) | Sous-programme | 3x | **CRITIQUE** - Sous-programme |
