...
#### <a id="t1"></a>1 - PMS Import [[ECRAN]](#ecran-t1)

**Role** : Traitement : PMS Import.
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 1 | 1 | PMS Import | Type11 | 320 | 200 | Traitement |

### 8.2 Mockups Ecrans

## 9. NAVIGATION

Ecran unique: **PMS Import**

### 9.3 Structure hierarchique (1 tache)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **1.1** | [**PMS Import** (1)](#t1) [mockup](#ecran-t1) | Type11 | 320x200 | Traitement |
