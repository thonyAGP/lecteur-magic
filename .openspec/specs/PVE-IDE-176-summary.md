...
> **Analyse**: 2026-02-03 18:41
> **Pipeline**: V7.2 Enrichi

## RESUME EXECUTIF

- **Fonction**: FindAppointments
- **Tables modifiees**: 1
- **Complexite**: **BASSE** (12/100)
- **Statut**: NON_ORPHELIN
- **Raison**: Appele par 6 programme(s): Main Sale (IDE 186), Main Sale-664 (IDE 187), Main Sale Sale Bar Code (IDE 214), Main Sale (IDE 363), Main Sale-664 (IDE 364), Main Sale (IDE 440)
