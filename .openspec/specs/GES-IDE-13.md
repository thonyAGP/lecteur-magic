# GES IDE 13 - Compte les seminaires

> **Analyse**: Phases 1-4 2026-02-03 11:27 -> 11:28 (14s) | Assemblage 11:28
...
**Compte les seminaires** assure la gestion complete de ce processus, accessible depuis [Gratuites GM (IDE 7)](GES-IDE-7.md).
...
- **13** - Compte les seminaires **[[ECRAN]](#ecran-t1)**

#### Phase 2 : Traitement (1 tache)

- **13.1** - generation des seminaires **[[ECRAN]](#ecran-t2)**

Delegue a : [Recuperation du titre (IDE 30)](GES-IDE-30.md)

#### Phase 3 : Creation (1 tache)

- **13.1.1** - Creation temp

#### Phase 4 : Consultation (1 tache)

- **13.2** - Choix seminaire **[[ECRAN]](#ecran-t4)**
...
#### <a id="t1"></a>13 - Compte les seminaires [[ECRAN]](#ecran-t1)
...
#### <a id="t2"></a>13.1 - generation des seminaires [[ECRAN]](#ecran-t2)
...
#### <a id="t3"></a>13.1.1 - Creation temp
...
#### <a id="t4"></a>13.2 - Choix seminaire [[ECRAN]](#ecran-t4)

**Role** : Selection par l'operateur : Choix seminaire.
**Ecran** : 447 x 214 DLU (MDI) | [Voir mockup](#ecran-t4)
...
- **Appele par**: [Gratuites GM (IDE 7)](GES-IDE-7.md)
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 13.1 | 13.1 | generation des seminaires | MDI | 422 | 26 | Traitement |
| 2 | 13.2 | 13.2 | Choix seminaire | MDI | 447 | 214 | Consultation |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t2"></a>13.1 - generation des seminaires
**Tache** : [13.1](#t2) | **Type** : MDI | **Dimensions** : 422 x 26 DLU
...
#### <a id="ecran-t4"></a>13.2 - Choix seminaire
**Tache** : [13.2](#t4) | **Type** : MDI | **Dimensions** : 447 x 214 DLU
...
|--------|-----------|--------|
| Sélectionner | 344,189 | Bouton fonctionnel |
...
flowchart TD
    ...
    VF2[13.1 generation des semi...]
    style VF2 fill:#58a6ff
    VF4[13.2 Choix seminaire]
...
|--------|--------|------|--------|
| generation des seminaires | Recuperation donnees | [Recuperation du titre (IDE 30)](GES-IDE-30.md) | Retour ecran |

### 9.3 Structure hierarchique (4 taches)

| Position | Tache | Type | Dimensions | Bloc |
|----------|-------|------|------------|------|
| **13.1** | [**Compte les seminaires** (13)](#t1) [mockup](#ecran-t1) | MDI | 424x55 | Calcul |
| **13.2** | [**generation des seminaires** (13.1)](#t2) [mockup](#ecran-t2) | MDI | 422x26 | Traitement |
| **13.3** | [**Creation temp** (13.1.1)](#t3) | MDI | - | Creation |
| **13.4** | [**Choix seminaire** (13.2)](#t4) [mockup](#ecran-t4) | MDI | 447x214 | Consultation |
...
Variables recues du programme appelant ([Gratuites GM (IDE 7)](GES-IDE-7.md)).
...
Main -> ... -> [Gratuites GM (IDE 7)](GES-IDE-7.md) -> **Compte les seminaires (IDE 13)**

```mermaid
graph LR
    T13[13 Compte les seminaires]
