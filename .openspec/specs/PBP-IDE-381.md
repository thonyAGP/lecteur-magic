# PBP IDE 381 - Liste liberation

> **Analyse**: Phases 1-4 2026-02-03 16:41 -> 16:42 (18s) | Assemblage 16:42
...
| Projet | PBP |
| IDE Position | 381 |
| Nom Programme | Liste liberation |
...
**Liste liberation** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>381 - Liste liberation

**Role** : Traitement : Liste liberation.
...
|----------|-------|------|------------|------|
| **381.1** | [**Liste liberation** (381)](#t1) | MDI | - | Traitement |
...
| CONSTANTE | 5 | `'01'` | - |
| CONSTANTE | 6 | `0` | - |
| CONSTANTE | 8 | `'156 : List of freed rooms'` | - |
| CONSTANTE | 4 | `'ELOGE'` | - |
| CONSTANTE | 1 | `156` | - |
| ... | | *+2 autres* | |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 7 | `MlsTrans ('Liste des liberations par')&' '&IF (CodeZoneSecteur [E]='Z','Zone',MlsTrans ('Secteur'))` | - |
