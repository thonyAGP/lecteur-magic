...
**Browse - crew** assure la gestion complete de ce processus.

Le flux de traitement s'organise en **1 blocs fonctionnels** :

- **Traitement** (1 tache) : traitements metier divers

**Donnees modifiees** : 1 tables en ecriture (crew).
...
#### <a id="t1"></a>273 - Browse - crew

**Role** : Traitement : Browse - crew.
...
|----------|-------|------|------------|------|
| **273.1** | [**Browse - crew** (273)](#t1) | - | - | Traitement |
