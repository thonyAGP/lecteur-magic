...
- **Statut**: NON_ORPHELIN
- **Raison**: Appele par 13 programme(s): Main Sale (IDE 186), Main Sale Sale Bar Code (IDE 214), Main Sale-664 (IDE 187), Main Sale ===V4 (IDE 0), Main Sale ===V4 bck (IDE 352), Main Sale ===V4 (IDE 354), Main Sale ===V4 (IDE 359), Main Sale (IDE 363), Main Sale-664 (IDE 364), Main Sale ===V4 (IDE 409), Main Sale ===V4 (IDE 415), Main Sale ===V4 Booking ACTUEL (IDE 417), Main Sale (IDE 440)
...
| **Appelle** | [Lancement clavier (IDE 317)](PVE-IDE-317.md) |
