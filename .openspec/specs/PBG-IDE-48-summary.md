...
> **Analyse**: 2026-02-03 08:56
> **Pipeline**: V7.2 Enrichi

## RESUME EXECUTIF

- **Fonction**: Browse - Groupe Arr/Dep.  VOL
- **Tables modifiees**: 1
- **Complexite**: **BASSE** (7/100)
- **Statut**: NON_ORPHELIN
- **Raison**: Appele par 15 programme(s): Browse - IMPORT Historique Cha (IDE 27), Browse - IMPORT Mod (IDE 28), Browse - IMPORT Recup N°Chambr (IDE 29), Browse - IMPORT Historique Cha (IDE 30), Browse - IMPORT MOD GM (IDE 31), Browse - IMPORT Avertiss. MOD (IDE 32), Browse - IMPORT Avertiss. AN/V (IDE 33), Browse - IMPORT Commentai IMO (IDE 34), Browse - IMPORT Troncon   IMT (IDE 35), Browse - IMPORT Reprise   IMR (IDE 36), Browse - IMPORT Avertiss. IMA (IDE 37), Browse - IMPORT PrestationIMP (IDE 38), Browse - IMPORT Circuit   IMC (IDE 39), Browse - IMPORT Logement  IML (IDE 40), Browse - IMPORT Identite  IMI (IDE 41)
