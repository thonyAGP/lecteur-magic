# REF IDE 335 - Browse - histo_fusionseparatio
...
| Projet | REF |
| IDE Position | 335 |
| Nom Programme | Browse - histo_fusionseparatio |
...
**Browse - histo_fusionseparatio** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>335 - Browse - histo_fusionseparatio

**Role** : Traitement : Browse - histo_fusionseparatio.
...
|----------|-------|------|------------|------|
| **335.1** | [**Browse - histo_fusionseparatio** (335)](#t1) | - | - | Traitement |
