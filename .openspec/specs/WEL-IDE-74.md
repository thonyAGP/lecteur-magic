# WEL IDE 74 - Selection Interruption
...
- **74** - Selection Interruption

#### Phase 2 : Traitement (2 taches)

- **74.1** - Determination Periode
- **74.2** - Demarquage Caisse
...
#### <a id="t1"></a>74 - Selection Interruption
...
#### <a id="t2"></a>74.1 - Determination Periode
...
#### <a id="t3"></a>74.2 - Demarquage Caisse
...
|----------|-------|------|------------|------|
| **74.1** | [**Selection Interruption** (74)](#t1) | MDI | - | Consultation |
| **74.2** | [**Determination Periode** (74.1)](#t2) | MDI | - | Traitement |
| 74.2.1 | [Demarquage Caisse (74.2)](#t3) | MDI | - | |
...
Main -> ... -> [Clients (IDE 9)](WEL-IDE-9.md) -> **Selection Interruption (IDE 74)**

```mermaid
graph LR
    T74[74 Selection Interruption]
