# REF IDE 309 - Browse - fra_circuit
...
| Projet | REF |
| IDE Position | 309 |
| Nom Programme | Browse - fra_circuit |
...
**Browse - fra_circuit** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>309 - Browse - fra_circuit

**Role** : Traitement : Browse - fra_circuit.
...
|----------|-------|------|------------|------|
| **309.1** | [**Browse - fra_circuit** (309)](#t1) | - | - | Traitement |
