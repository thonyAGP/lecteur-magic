# EXF IDE 34 - Recuperation langue

> **Analyse**: Phases 1-4 2026-02-03 11:05 -> 11:05 (15s) | Assemblage 11:05
...
**Recuperation langue** assure la gestion complete de ce processus, accessible depuis [Start (IDE 15)](EXF-IDE-15.md).
...
#### <a id="t1"></a>34 - Recuperation langue
...
|----------|-------|------|------------|------|
| **34.1** | [**Recuperation langue** (34)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Start (IDE 15)](EXF-IDE-15.md) -> **Recuperation langue (IDE 34)**

```mermaid
graph LR
    T34[34 Recuperation langue]
