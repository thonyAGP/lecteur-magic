# REF IDE 782 - Zoom code TAI

> **Analyse**: Phases 1-4 2026-02-03 14:20 -> 14:20 (14s) | Assemblage 14:20
...
**Zoom code TAI** assure la gestion complete de ce processus, accessible depuis [Create TAI Comptes speciaux (IDE 648)](REF-IDE-648.md).
...
#### <a id="t1"></a>782 - Zoom TAI [[ECRAN]](#ecran-t1)
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 782 | 782 | Zoom TAI | MDI | 458 | 154 | Consultation |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>782 - Zoom TAI
**Tache** : [782](#t1) | **Type** : MDI | **Dimensions** : 458 x 154 DLU
...
|----------|-------|------|------------|------|
| **782.1** | [**Zoom TAI** (782)](#t1) [mockup](#ecran-t1) | MDI | 458x154 | Consultation |
...
Main -> ... -> [Create TAI Comptes speciaux (IDE 648)](REF-IDE-648.md) -> **Zoom code TAI (IDE 782)**

```mermaid
graph LR
    T782[782 Zoom code TAI]
    style T782 fill:#58a6ff
