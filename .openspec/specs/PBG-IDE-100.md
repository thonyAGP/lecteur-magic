...
**Demarquage Caisse** assure la gestion complete de ce processus, accessible depuis [Affectation logement (IDE 98)](PBG-IDE-98.md).
...
#### <a id="t1"></a>100 - Demarquage Caisse
...
|----------|-------|------|------------|------|
| **100.1** | [**Demarquage Caisse** (100)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Affectation logement (IDE 98)](PBG-IDE-98.md) -> **Demarquage Caisse (IDE 100)**

```mermaid
graph LR
    T100[100 Demarquage Caisse]
