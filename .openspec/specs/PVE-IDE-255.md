...
**Choix - Types (sb)** assure la gestion complete de ce processus, accessible depuis [Menu Administration (IDE 178)](PVE-IDE-178.md).

Le flux de traitement s'organise en **1 blocs fonctionnels** :

- **Traitement** (1 tache) : traitements metier divers

**Donnees modifiees** : 1 tables en ecriture (pv_sole_code_table).
...
#### <a id="t1"></a>255 - Level [[ECRAN]](#ecran-t1)
...
|---|----------|-------|-----|------|---------|---------|------|
| 1 | 255 | 255 | Level | MDI | 542 | 270 | Traitement |

### 8.2 Mockups Ecrans

---

#### <a id="ecran-t1"></a>255 - Level
**Tache** : [255](#t1) | **Type** : MDI | **Dimensions** : 542 x 270 DLU
...
|-----------|-----|----------|------|
| 32,76 | (sans nom) | - | edit |
| 104,76 | (sans nom) | - | edit |
| 312,72 | (sans nom) | - | edit |
...
|--------|-----------|--------|
| ñ | 254,73 | Bouton fonctionnel |
| ò | 254,144 | Bouton fonctionnel |
...
| Select | 386,240 | Ouvre la selection |
| Exit | 462,240 | Quitte le programme |
...
|----------|-------|------|------------|------|
| **255.1** | [**Level** (255)](#t1) [mockup](#ecran-t1) | MDI | 542x270 | Traitement |
...
|----|-----|-------------|------|---|---|---|--------|
| 406 | pv_sole_code_table |  | DB |   | **W** |   | 1 |

### Colonnes par table (0 / 1 tables avec colonnes identifiees)

<details>
<summary>Table 406 - pv_sole_code_table (**W**) - 1 usages</summary>
...
Main -> ... -> [Menu Administration (IDE 178)](PVE-IDE-178.md) -> **Choix - Types (sb) (IDE 255)**

```mermaid
graph LR
    T255[255 Choix - Types sb]
...
|------------|------|--------|--------|
| pv_sole_code_table | Table WRITE (Database) | 1x | Schema + repository |
