# REF IDE 305 - Browse - CMP_imputation
...
| Projet | REF |
| IDE Position | 305 |
| Nom Programme | Browse - CMP_imputation |
...
**Browse - CMP_imputation** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>305 - Browse - CMP_imputation

**Role** : Traitement : Browse - CMP_imputation.
...
|----------|-------|------|------------|------|
| **305.1** | [**Browse - CMP_imputation** (305)](#t1) | - | - | Traitement |
