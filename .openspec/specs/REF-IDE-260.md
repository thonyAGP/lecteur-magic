# REF IDE 260 - Browse - cc_total_par_type
...
| Projet | REF |
| IDE Position | 260 |
| Nom Programme | Browse - cc_total_par_type |
...
**Browse - cc_total_par_type** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>260 - Browse - cc_total_par_type

**Role** : Traitement : Browse - cc_total_par_type.
...
|----------|-------|------|------------|------|
| **260.1** | [**Browse - cc_total_par_type** (260)](#t1) | - | - | Traitement |
