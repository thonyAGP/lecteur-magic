...
- **158** - FindEmployees
- **158.1** - ExtractDataFromXML
- **158.1.1** - DataToTables
- **158.1.2** - DeletePraticiens
...
#### <a id="t1"></a>158 - FindEmployees

**Role** : Traitement : FindEmployees.
...
| Tache | Nom | Bloc |
|-------|-----|------|
| [158.1](#t2) | ExtractDataFromXML | Traitement |
| [158.1.1](#t3) | DataToTables | Traitement |
| [158.1.2](#t4) | DeletePraticiens | Traitement |
...
#### <a id="t2"></a>158.1 - ExtractDataFromXML
...
#### <a id="t3"></a>158.1.1 - DataToTables
...
#### <a id="t4"></a>158.1.2 - DeletePraticiens

**Role** : Traitement : DeletePraticiens.
**Delegue a** : [GetToken (IDE 151)](PVE-IDE-151.md), [TraceLogBooker (IDE 175)](PVE-IDE-175.md)
...
|----------|-------|------|------------|------|
| **158.1** | [**FindEmployees** (158)](#t1) | - | - | Traitement |
| 158.1.1 | [ExtractDataFromXML (158.1)](#t2) | - | - | |
| 158.1.2 | [DataToTables (158.1.1)](#t3) | - | - | |
| 158.1.3 | [DeletePraticiens (158.1.2)](#t4) | - | - | |
...
|----|-----|-------------|------|---|---|---|--------|
| 1545 | Table_1545 |  | MEM |   | **W** |   | 2 |

### Colonnes par table (0 / 1 tables avec colonnes identifiees)

<details>
<summary>Table 1545 - Table_1545 (**W**) - 2 usages</summary>
...
|------|-----|------------|-------|
| CALCULATION | 4 | `Trim(VG66) & '/v4.1/merchant/employees'` | - |
| CALCULATION | 3 | `Trim(VG66) & '/employees'` | - |
...
Main -> ... -> [SearchBooking (IDE 153)](PVE-IDE-153.md) -> **FindEmployees (IDE 158)**

Main -> ... -> [Main Sale (IDE 186)](PVE-IDE-186.md) -> **FindEmployees (IDE 158)**

Main -> ... -> [Main Sale-664 (IDE 187)](PVE-IDE-187.md) -> **FindEmployees (IDE 158)**

Main -> ... -> [Select Product (IDE 192)](PVE-IDE-192.md) -> **FindEmployees (IDE 158)**

Main -> ... -> [Main Sale Sale Bar Code (IDE 214)](PVE-IDE-214.md) -> **FindEmployees (IDE 158)**

Main -> ... -> [Main Sale (IDE 363)](PVE-IDE-363.md) -> **FindEmployees (IDE 158)**

Main -> ... -> [Main Sale-664 (IDE 364)](PVE-IDE-364.md) -> **FindEmployees (IDE 158)**

Main -> ... -> [Main Sale ===V4 Booking ACTUEL (IDE 417)](PVE-IDE-417.md) -> **FindEmployees (IDE 158)**

Main -> ... -> [Main Sale (IDE 440)](PVE-IDE-440.md) -> **FindEmployees (IDE 158)**

```mermaid
graph LR
    T158[158 FindEmployees]
...
|------------|------|--------|--------|
| Table_1545 | Table WRITE (Memory) | 2x | Schema + repository |
