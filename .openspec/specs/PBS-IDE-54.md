# PBS IDE 54 - Alimentation Combos MENAGE

> **Analyse**: Phases 1-4 2026-02-03 17:19 -> 17:19 (12s) | Assemblage 17:19
...
| Projet | PBS |
| IDE Position | 54 |
| Nom Programme | Alimentation Combos MENAGE |
...
**Alimentation Combos MENAGE** assure la gestion complete de ce processus, accessible depuis [Initialisation (IDE 48)](PBS-IDE-48.md).
...
#### <a id="t1"></a>54 - Êcran [[ECRAN]](#ecran-t1)
...
|----------|-------|------|------------|------|
| **54.1** | [**Êcran** (54)](#t1) [mockup](#ecran-t1) | MDI | 573x251 | Traitement |
...
|------|-----|------------|-------|
| CONDITION | 7 | `> Zone/Secteur [A]` | - |
| CONDITION | 8 | `SetParam (Trim (> Nom Combo [C]),v.Combo [D])` | - |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 4 | `Trim (v.Combo [D])&','&Trim (Left ([H],> Longueur Code [B])&'  '&Trim ([J]))` | - |
| CONCATENATION | 3 | `Trim (Left ([H],> Longueur Code [B])&'  '&Trim ([J]))` | - |
...
Main -> ... -> [Initialisation (IDE 48)](PBS-IDE-48.md) -> **Alimentation Combos MENAGE (IDE 54)**

```mermaid
graph LR
    T54[54 Alimentation Combos...]
