# EXF IDE 5 - Alimentation Combos SERVICE

> **Analyse**: Phases 1-4 2026-02-03 10:51 -> 10:51 (16s) | Assemblage 10:51
...
**Alimentation Combos SERVICE** assure la gestion complete de ce processus, accessible depuis [Menu ventes (IDE 13)](EXF-IDE-13.md).
...
#### <a id="t1"></a>5 - Alimentation Combos SERVICE

**Role** : Traitement : Alimentation Combos SERVICE.
**Delegue a** : [  Suppression Carac interdit (IDE 6)](EXF-IDE-6.md)
...
|----------|-------|------|------------|------|
| **5.1** | [**Alimentation Combos SERVICE** (5)](#t1) | MDI | - | Traitement |
...
Main -> ... -> [Menu ventes (IDE 13)](EXF-IDE-13.md) -> **Alimentation Combos SERVICE (IDE 5)**
...
|-----|---------------|--------|----------|
| [6](EXF-IDE-6.md) |   Suppression Carac interdit | 1 | Validation saisie |
...
| [  Suppression Carac interdit (IDE 6)](EXF-IDE-6.md) | Sous-programme | 1x | Normale - Validation saisie |
