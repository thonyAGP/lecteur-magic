# PBP IDE 253 - Liste des previsions

> **Analyse**: Phases 1-4 2026-02-03 16:00 -> 16:00 (11s) | Assemblage 16:00
...
| Projet | PBP |
| IDE Position | 253 |
| Nom Programme | Liste des previsions |
...
**Liste des previsions** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>253 - Liste des previsions

**Role** : Traitement : Liste des previsions.
...
|----------|-------|------|------------|------|
| **253.1** | [**Liste des previsions** (253)](#t1) | MDI | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 8 | `MlsTrans ('Liste des previsions par')&' '&IF (CodeZoneSecteur [E]='Z',MlsTrans ('Zone'),MlsTrans ('Secteur'))` | - |
