# PBP IDE 173 - Liste des Absents

> **Analyse**: Phases 1-4 2026-02-03 15:37 -> 15:38 (19s) | Assemblage 15:38
...
| Projet | PBP |
| IDE Position | 173 |
| Nom Programme | Liste des Absents |
...
**Liste des Absents** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>173 - Liste des Absents

**Role** : Traitement : Liste des Absents.
**Variables liees** : B (CodeListe), C (TypeListe)
**Delegue a** : [Liste CLients AVPBDR (IDE 174)](PBP-IDE-174.md), [Qua -> Tempo userlist (IDE 306)](PBP-IDE-306.md)
...
|----------|-------|------|------------|------|
| **173.1** | [**Liste des Absents** (173)](#t1) | MDI | - | Traitement |
...
|-----|---------------|--------|----------|
| [174](PBP-IDE-174.md) | Liste CLients AVPBDR | 1 | Configuration impression |
...
| [Liste CLients AVPBDR (IDE 174)](PBP-IDE-174.md) | Sous-programme | 1x | Normale - Configuration impression |
