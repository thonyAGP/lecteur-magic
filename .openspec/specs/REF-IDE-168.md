# REF IDE 168 - Browse - groupes_pme______gpm
...
| Projet | REF |
| IDE Position | 168 |
| Nom Programme | Browse - groupes_pme______gpm |
...
**Browse - groupes_pme______gpm** assure la gestion complete de ce processus.
...
#### <a id="t1"></a>168 - Browse - groupes_pme______gpm

**Role** : Traitement : Browse - groupes_pme______gpm.
...
|----------|-------|------|------------|------|
| **168.1** | [**Browse - groupes_pme______gpm** (168)](#t1) | - | - | Traitement |
