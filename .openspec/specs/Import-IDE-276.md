# Import IDE 276 - Import - parametre_voutchers
...
| Projet | Import |
| IDE Position | 276 |
| Nom Programme | Import - parametre_voutchers |
...
**Import - parametre_voutchers** assure la gestion complete de ce processus, accessible depuis [Lanceur (IDE 2)](Import-IDE-2.md).
...
#### <a id="t1"></a>276 - Import - parametre_voutchers

**Role** : Traitement : Import - parametre_voutchers.
...
|----------|-------|------|------------|------|
| **276.1** | [**Import - parametre_voutchers** (276)](#t1) | - | - | Traitement |
...
| Type | IDE | Expression | Regle |
|------|-----|------------|-------|
| CONCATENATION | 2 | `Trim(INIGet('[MAGIC_LOGICAL_NAMES]import'))&'excupvt.txt'` | - |
...
Main -> ... -> [Lanceur (IDE 2)](Import-IDE-2.md) -> **Import - parametre_voutchers (IDE 276)**

```mermaid
graph LR
    T276[276 Import - parametre...]
