...
> **Source** : `D:\Data\Migration\XPA\PMS\ADH\Source\Prg_242.xml`
...
| Attribut | Valeur |
|----------|--------|
| **Format IDE** | ADH IDE 246 |
| **Fichier XML** | Prg_242.xml |
| **Description** |  |
...
> **Note**: Ce programme est Prg_242.xml. L'ID XML (242) peut differer de la position IDE (246).
...
### 1.1 Objectif Metier
> A completer dans `.openspec/annotations/ADH-IDE-246.yaml`
