...
> **Note**: Ce programme est Prg_26.xml. L'ID XML (26) peut differer de la position IDE (26).
...
### 1.1 Objectif Metier
> A completer dans `.openspec/annotations/ADH-IDE-26.yaml`
