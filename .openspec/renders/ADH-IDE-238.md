...
- **Quoi**: Enregistrer vente de Gift Pass
- **Pourquoi**: Permettre achat de cartes cadeaux a valeur predeterminee
### 1.2 Flux Utilisateur
1. Selection "Vente Gift Pass" depuis menu caisse
2. Saisie du montant ou selection valeur predeterminee
3. Saisie quantite si multiple
4. Validation paiement (especes, CB, autre)
5. Impression ticket cadeau
...
Utilise potentiellement des fonctions partagees de ADH.ecf
...
| #596 | `%club_user%tmp_ecrpolice_dat` | tempo_ecran_police | **W** | 11x |
...
| #50 | `cafil028_dat` | moyens_reglement_mor | R | 4x |
...
| #89 | `cafil067_dat` | moyen_paiement___mop | R | 10x |
