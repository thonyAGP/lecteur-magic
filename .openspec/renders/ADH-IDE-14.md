...
> **Source** : `D:\Data\Migration\XPA\PMS\ADH\Source\Prg_14.xml`
...
| Attribut | Valeur |
|----------|--------|
| **Format IDE** | ADH IDE 14 |
| **Fichier XML** | Prg_14.xml |
| **Description** | e-mail list |
| **Type** | O (O=Online, B=Batch) |
| **Parametres** | 0 |
| **Module** | ADH |
| **Dossier IDE** | Brazil DataCatching |

> **Note**: Ce programme est Prg_14.xml. L'ID XML (14) peut differer de la position IDE (14).
...
### 1.1 Objectif Metier
> A completer dans `.openspec/annotations/ADH-IDE-14.yaml`
...
## 5. EXPRESSIONS (0 total, 0 decodees)
