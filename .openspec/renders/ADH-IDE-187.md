...
> **Note**: Ce programme est Prg_186.xml. L'ID XML (186) peut differer de la position IDE (187).
...
### 1.1 Objectif Metier
> A completer dans `.openspec/annotations/ADH-IDE-187.yaml`
