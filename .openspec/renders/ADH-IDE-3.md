...
| Attribut | Valeur |
|----------|--------|
| **Format IDE** | ADH IDE 3 |
| **Fichier XML** | Prg_3.xml |
| **Description** | 323 Progs - 08/01/2026 |
| **Type** | O (O=Online, B=Batch) |
| **Parametres** | 0 |
| **Module** | ADH |
| **Dossier IDE** | Unknown |

> **Note**: Ce programme est Prg_3.xml. L'ID XML (3) peut differer de la position IDE (3).
...
### 1.1 Objectif Metier
> A completer dans `.openspec/annotations/ADH-IDE-3.yaml`
