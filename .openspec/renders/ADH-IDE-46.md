...
> **Note**: Ce programme est Prg_46.xml. L'ID XML (46) peut differer de la position IDE (46).
...
### 1.1 Objectif Metier
> A completer dans `.openspec/annotations/ADH-IDE-46.yaml`
...
|---|------------------|--------|
| 1 | `'&Oui'` | `'&Oui'` |
| 2 | `'Version '&Trim({32768,14})` | `'Version '&Trim(VG.N° version)` |
| 3 | `'du '&Trim({32768,15})` | `'du '&Trim(VG.Date version)` |
