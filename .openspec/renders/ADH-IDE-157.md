...
| Attribut | Valeur |
|----------|--------|
| **Format IDE** | ADH IDE 157 |
| **Fichier XML** | Prg_156.xml |
| **Description** |  |
| **Type** | O (O=Online, B=Batch) |
| **Parametres** | 0 |
| **Module** | ADH |
| **Dossier IDE** | Great Members |

> **Note**: Ce programme est Prg_156.xml. L'ID XML (156) peut differer de la position IDE (157).
...
### 1.1 Objectif Metier
> A completer dans `.openspec/annotations/ADH-IDE-157.yaml`
