...
const renderPipelineSection = (pipeline, live) => {
    const total = live;
    const pBar = (count, color, label) => {
...
const renderDonut = (segments, total) => {
    let offset = 0;
    const strokes = [];
    const radius = 40;
...
const gradeBadge = (grade) => {
    const colorMap = { S: 'var(--red)', A: 'var(--orange)', B: 'var(--yellow)', C: 'var(--blue)', D: 'var(--green)' };
    const color = colorMap[grade] ?? 'var(--gray)';
    return `<span class="grade-badge" style="background:${color}">${grade}</span>`;
};
const renderEstimationSection = (r) => {
...
const renderMigrationSequence = (r) => {
...
const renderDecommissionSection = (d, live) => `
<section class="card">
...
// ═══════════════════════════════════════════════════════════════════
export const generateMultiProjectHtmlReport = (report) => {
