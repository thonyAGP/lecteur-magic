...
exports.functionRegistry = exports.FunctionCategory = exports.ParamType = void 0;
...
(function (FunctionCategory) {
    ...
    FunctionCategory["Numeric"] = "Numeric";
    FunctionCategory["Date"] = "Date";
    FunctionCategory["Time"] = "Time";
    FunctionCategory["Logical"] = "Logical";
    FunctionCategory["Flow"] = "Flow";
    FunctionCategory["Database"] = "Database";
    FunctionCategory["System"] = "System";
    FunctionCategory["IO"] = "IO";
    FunctionCategory["UI"] = "UI";
    FunctionCategory["Blob"] = "Blob";
    FunctionCategory["Conversion"] = "Conversion";
    FunctionCategory["Variable"] = "Variable";
    FunctionCategory["Environment"] = "Environment";
    FunctionCategory["Error"] = "Error";
    FunctionCategory["XML"] = "XML";
    FunctionCategory["Vector"] = "Vector";
    FunctionCategory["Buffer"] = "Buffer";
    FunctionCategory["DLL"] = "DLL";
    FunctionCategory["HTTP"] = "HTTP";
    FunctionCategory["COM"] = "COM";
    FunctionCategory["Mail"] = "Mail";
    FunctionCategory["Security"] = "Security";
    FunctionCategory["Clipboard"] = "Clipboard";
    FunctionCategory["Context"] = "Context";
    FunctionCategory["Window"] = "Window";
    FunctionCategory["Menu"] = "Menu";
    FunctionCategory["Control"] = "Control";
    FunctionCategory["MultiMark"] = "MultiMark";
    FunctionCategory["Locking"] = "Locking";
    FunctionCategory["I18N"] = "I18N";
})(FunctionCategory || (exports.FunctionCategory = FunctionCategory = {}));
/**
 ...
 */
exports.functionRegistry = new FunctionRegistry();
/**
 * Get function info by name
 */
function getFunction(name) {
    return exports.functionRegistry.get(name);
}
/**
 * Check if function exists
 */
function functionExists(name) {
    return exports.functionRegistry.has(name);
}
/**
 * Get all registered functions
 */
function getAllFunctions() {
    return exports.functionRegistry.getAll();
}
