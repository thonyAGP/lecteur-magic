...
exports.getPythonImports = getPythonImports;
...
class PythonGenerator {
    ...
    visitBinaryExpression(node) {
        ...
        const operatorMap = {
            ...
            [ast_1.BinaryOperator.And]: 'and',
            [ast_1.BinaryOperator.Or]: 'or',
        };
 ...
 */
function generatePython(ast, options) {
